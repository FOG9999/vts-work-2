...
SELECT iID_DeNghiThanhToanID from VDT_TT_DeNghiThanhToan WHERE iNamKeHoach = @iNamThongTri AND iID_MaDonViQuanLy = @sMaDonVi AND dNgayDeNghi <= @dNgayTaoThongTri AND iID_NguonVonID = @iNguonVon
)
 ) end) as iID_Parent,
 ct1.iID_HopDongID, 
 ct1.iID_NhaThauID, 
