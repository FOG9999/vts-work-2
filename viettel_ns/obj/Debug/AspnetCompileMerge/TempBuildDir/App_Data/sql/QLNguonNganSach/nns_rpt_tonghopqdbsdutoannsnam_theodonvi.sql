...
SELECT dt.iID_DuToan, dt.sSoQuyetDinh, dt.iID_MaDonVi, concat(dt.iID_MaDonVi,' - ',dt.sTenDonVi) as sTenDonVi, SUM(dt.SoTien)/@dvt as iTongTien
FROM 
(
	...
	sMaNoiDungChi, dtct.iID_MaDonVi, dv.sten as sTenDonVi, sMaPhongBan, sTenPhongBan, dtct.iID_NhiemVu, dtct.SoTien
	FROM NNS_DuToanChiTiet as dtct
	inner join NS_DonVi dv on dv.iID_MaDonVi = dtct.iID_MaDonVi
...
GROUP BY dt.iID_DuToan, dt.iID_MaDonVi, dt.sTenDonVi, dt.dNgayQuyetDinh, dt.sSoQuyetDinh
ORDER BY dt.iID_MaDonVi
