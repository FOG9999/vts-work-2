...
{
    public class rptKeToanTongHop_TongHopPhanHoTheoTaiKhoanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
...
WHERE      (CT.iTrangThai = 1) AND (KT.iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet) AND ((CT.iID_MaTaiKhoan_No NOT IN
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaTaiKhoan = "", String Thang = "", String LoaiBieu = "")
        {
            HamChung.Language();
            String sFilePath = "";
            if (LoaiBieu == "rAll")
