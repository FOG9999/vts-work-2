...
{
    public class rptKT_BaoCaoTongHop9Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptKT_BaoCaoTongHop9C/

        public string sViewPath = "~/Report_Views/";
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String LoaiBaoCao="")
        {
            String sFilePath = "";
            if (LoaiBaoCao == "0")
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamLamViec,String LoaiBaoCao, String iID_MaLoaiTaiSan, String TuNgay, String DenNgay, String TuThang, String DenThang, String iID_MaPhongBan)
        {
            HamChung.Language();
            String sFilePath = "";
            if (LoaiBaoCao == "0")
