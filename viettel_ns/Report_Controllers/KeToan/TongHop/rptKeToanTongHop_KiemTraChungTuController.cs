...
{
    public class rptKeToanTongHop_KiemTraChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
...
iID_MaDonVi_Co, sNoiDung, rSoTien, iID_MaTaiKhoan_Co, iID_MaTaiKhoan_No FROM KT_ChungTuChiTiet WHERE 1=1";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec = "", String TuNgay = "", String DenNgay = "", String TuThang = "", String DenThang = "", String Loai = "0", String iTrangThai = "0")
        {
            HamChung.Language();
            string PathFile = "";
            if (Loai == "0") PathFile = sFilePath;
