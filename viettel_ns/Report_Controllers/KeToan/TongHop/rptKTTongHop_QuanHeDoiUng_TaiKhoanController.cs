...
{
    public class rptKTTongHop_QuanHeDoiUng_TaiKhoanController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="iNgay2">Đến ngày</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec, String iID_MaTaiKhoan, String iThang1, String iThang2, String iNgay1, String iNgay2)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iNamLamViec, iID_MaTaiKhoan, iThang1, iThang2, iNgay1, iNgay2);
