...
{
    public class rptKeToanTongHop_CanDoiTaiKhoanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iNam, String iThang)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iNam, String iThang, String OK)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNam, String iThang,String KhoGiay)
        {
            string lang = "vi-VN";
            System.Threading.Thread.CurrentThread.CurrentCulture = System.Globalization.CultureInfo.CreateSpecificCulture(lang);
            System.Threading.Thread.CurrentThread.CurrentUICulture = System.Globalization.CultureInfo.CreateSpecificCulture(lang);
