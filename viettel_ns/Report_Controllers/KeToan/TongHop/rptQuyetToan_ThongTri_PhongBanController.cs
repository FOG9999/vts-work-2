...
{
    public class rptQuyetToan_ThongTri_PhongBanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String SoCT, String iID_MaPhongBan, String LoaiTK, String TKNo, String TKCo)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), SoCT, iID_MaPhongBan,LoaiTK,TKNo,TKCo);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
