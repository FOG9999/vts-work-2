...
{
    public class rptKTTH_ChiTietPhaiThuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec, String iThang, String iNgay, String DVT, String iID_MaTrangThaiDuyet, String Mucin)
        {
            HamChung.Language();
            String DuongDan = "";
            if (Mucin == "0")
