...
{
    public class rptKTTongHop_ChiTiet_TongHopTaiKhoan_CucController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptKTTongHop_ChiTiet_TongHopTaiKhoan/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/KeToan/TongHop/rptKTTongHop_ChiTiet_TongHopTaiKhoan_Cuc.xls";
        public static String NameFile = "";

        public Microsoft.AspNetCore.Mvc.ActionResult Loc()
        {

            ViewData["path"] = "~/Report_Views/KeToan/TongHop/rptKTTongHop_ChiTiet_TongHopTaiKhoan_Loc_Cuc.aspx";
            return View("~/Report_Views/KeToan/TongHop/rptKTTongHop_ChiTiet_TongHopTaiKhoan_Loc_Cuc.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Loc_Submit(String ParentID, String iNamLamViec)
        {
            ...
            ViewData["path"] = "~/Report_Views/KeToan/TongHop/rptKTTongHop_ChiTiet_TongHopTaiKhoan_Cuc.aspx";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iNamLamViec, String iNgay1, String iNgay2, String iThang1, String iThang2, int ChiSo, String LoaiBaoCao)
        {
        ...
        public ExcelFile CreateReport(String path, String iNamLamViec, String iNgay1, String iNgay2, String iThang1, String iThang2, String LoaiBaoCao, String iID_MaTaiKhoan, String UserName)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptKTTongHop_ChiTiet_TongHopTaiKhoan_Cuc");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec, String iNgay1, String iNgay2, String iThang1, String iThang2, String LoaiBaoCao, String iID_MaTaiKhoan, String UserName)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iNamLamViec, iNgay1, iNgay2, iThang1, iThang2, LoaiBaoCao, iID_MaTaiKhoan, UserName);
        ...
        public DataTable dtChiTiet(String iNamLamViec, String iNgay1, String iNgay2, String iThang1, String iThang2, String iID_MaTaiKhoan, String CapTaiKhoan)
        {
            ...
            String SQL = " SELECT * FROM( SELECT CT.iNgayCT,Convert(varchar,CT.iNgayCT) + ' - ' + Convert(varchar,CT.iThang) as NgayGS";
            ...
            SQL += " {1} ";
            SQL += " AND CT.iID_MaTrangThaiDuyet='{2}'";
            SQL += " ) as a INNER JOIN (SELECT iID_MaDonVi,sTenTomTat FROM NS_DonVi WHERE iTrangThai=1 AND iNamLamViec_DonVi=@iNamLamViec) as b ON a.iID_MaDonVi_Co=b.iID_MaDonVi      ORDER BY iID_MaTaiKhoan,iNgayCT, Convert(int,sSoChungTu)";
        ...
        public static DataTable Insert_TaiKhoanCha(String[] arrDSTaiKhoan, String iNamLamViec, DataTable dtChiTiet, DataTable dtDuDauKy, DataTable dtCuoiKy, DataTable dtCPS,DataTable dtLuyKe)
        {
            ...
            for (i = 0; i < dtTaiKhoan.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (Rdk.Length > 0)
                    {
                        objPS_No = Rdk[0]["rLK_No"];
                        objPS_Co = Rdk[0]["rLK_Co"];
                        dtCuoiKy.Rows.Remove(Rdk[0]);
                    }
                    if (Co_PhatSinh || Co_DuDauKy)
                    {
                        R = dtKQ.NewRow();
