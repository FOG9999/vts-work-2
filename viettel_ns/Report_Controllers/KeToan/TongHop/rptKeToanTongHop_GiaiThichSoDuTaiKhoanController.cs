...
{
    public class rptKeToanTongHop_GiaiThichSoDuTaiKhoanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
...
SELECT iiD_MaDonVi_Co,sTenDonVi_Co,
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaTaiKhoan = "", String Thang = "", String Nam = "", String LoaiBieu = "", String KieuGiay = "", String iID_MaTrangThaiDuyet = "")
        {
            HamChung.Language();
            String sFilePath = "";
            if (KieuGiay == "rdoc")
