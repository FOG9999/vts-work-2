...
{
    public class rptKeToanTongHop_PhanHoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptPhanHo/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_Loc(String ParentID)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iThang, int? ChiSo)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iThang, String iID_MaDonVi, String UserName, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            string lang = "vi-VN";
        ...
        {
            String MaND = User.Identity.Name;
            String TenDonVi = DonViModels.Get_TenDonVi(iID_MaDonVi,MaND);
