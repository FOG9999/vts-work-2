...
{
    public class rptBangTongHopChungTuGocController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec, String sSoChungTu)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iNamLamViec, sSoChungTu);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
