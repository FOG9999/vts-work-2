...
{
    public class rptKTTM_TongHopNgayController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNgay1, String iNgay2, String iThang1, String iThang2, String LoaiBaoCao, String iNamLamViec)
        {
            HamChung.Language();
            String sFilePathName = "";
            if (LoaiBaoCao == "PC1") sFilePathName = sFilePath;
