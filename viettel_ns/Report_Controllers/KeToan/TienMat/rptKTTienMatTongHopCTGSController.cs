...
{
    public class rptKTTienMatTongHopCTGSController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptKTTGTongHopCTGS/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/KeToan/TienMat/rptKTTienMatTongHopCTGS.xls";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/KeToan/TienMat/rptKTTienMatTongHopCTGS.aspx";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID)
        {
            ...
            ViewData["path"] = "~/Report_Views/KeToan/TienGui/rptKTTienMatTongHopCTGS.aspx";
            return View(sViewPath + "ReportView.aspx");
        }
         ...
         public clsExcelResult ExportToExcel(String iID_MaChungTu)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "BaoCaoTongHopCTGS.xls";
                clsResult.type = "xls";
                return clsResult;
            }
        }
