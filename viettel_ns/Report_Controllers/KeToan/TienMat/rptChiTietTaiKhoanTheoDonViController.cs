...
{
    public class rptChiTietTaiKhoanTheoDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaDonVi, String iNamLamViec, String iID_MaTaiKhoan, String iThang1, String iThang2)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaDonVi, iNamLamViec, iID_MaTaiKhoan, iThang1, iThang2);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
