...
{
    public class rptKTTM_ThongTriController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptQuyetToanThongTri_PhongBan/     

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/KeToan/TienMat/rptKTTienMat_ThongTri.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/KeToan/TienMat/rptKTTM_ThongTri_View.aspx";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iThang, String iNam)
        {
            String iID_MaChungTu = Convert.ToString(Request.Form[ParentID + "_iID_MaChungTu"]);
            String iID_MaDonVi = Convert.ToString(Request.Form[ParentID + "_iID_MaDonVi"]);
            String LoaiTK = "0";
            if ( iID_MaDonVi==null||iID_MaDonVi.Length < 2)
                return RedirectToAction("Index", "KeToanChiTietTienMat");
            else
            {
                if (iID_MaDonVi.Substring(0, 2) == "N-") LoaiTK = "0";
                else LoaiTK = "1";
                return RedirectToAction("Index", new { iID_MaChungTu = iID_MaChungTu, iID_MaDonVi = iID_MaDonVi.Substring(2, iID_MaDonVi.Length - 2), LoaiTK = LoaiTK, iThang, iNam });
            }
        }
        //Lấy dữ liệu
        public  DataTable rptQuyetToan_ThongTri_PhongBan(String iID_MaChungTu, String iID_MaDonVi, String LoaiTK)
        {
            ...
            String SQL = String.Format(@"SELECT KT.sNoiDung
                                        ...
                                        FROM KTTM_ChungTuChiTiet AS KT
                                        INNER JOIN KTTM_ChungTu AS CT 
        ...
        public ExcelFile CreateReport(String path, String iID_MaChungTu, String iID_MaDonVi, String LoaiTK, String iThang, String iNam)
        {
            ...
            fr.SetValue("TenDV", DonViModels.Get_TenDonVi(iID_MaDonVi,MaND));
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaChungTu, String iID_MaDonVi, String LoaiTK, String iThang , String iNam)
        {
            HamChung.Language();
