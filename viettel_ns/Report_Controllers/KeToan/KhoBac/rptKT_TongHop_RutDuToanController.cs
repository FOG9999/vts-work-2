...
{
    public class rptKT_TongHop_RutDuToanController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Create: Thương
        ...
        public ExcelFile CreateReport(String path, String iTuNgay, String iDenNgay, String iTuThang, String iDenThang, String iNam, String iDVTinh, String iSoTo, String iReport, String UserID, String iID_MaTrangThaiDuyet)
        {
            ...
            fr.SetValue("cap1", ReportModels.CauHinhTenDonViSuDung(1,MaND).ToUpper());
            fr.SetValue("cap2", ReportModels.CauHinhTenDonViSuDung(2,MaND).ToUpper());
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iTuNgay, String iDenNgay, String iTuThang, String iDenThang, String iNam, String iDVTinh, String iSoTo, String iReport, String UserID, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
