...
{
    public class rptKTCS_MauC52Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptKTCS_MauC52/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String KhoGiay = "")
        {
            String sFilePath = "";
            if (KhoGiay == "1")
            {
                sFilePath = "/Report_ExcelFrom/CongSan/rptKTCS_MauC52_A3.xls";
            }
            else 
            {
                sFilePath = "/Report_ExcelFrom/CongSan/rptKTCS_MauC52.xls";
            }
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/CongSan/rptKTCS_MauC52.aspx";
        ...
        public ExcelFile CreateReport(String path, String NamChungTu, String iID_MaDonVi,String TongHopDonVi, String KhoGiay)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptKTCS_MauC52");
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable rptKTCS_MauC52(String NamChungTu, String iID_MaDonVi, String TongHopDonVi, String KhoGiay)
        {
...
", DKDonVi);
        ...
        private void LoadData(FlexCelReport fr, String NamChungTu, String iID_MaDonVi, String TongHopDonVi, String KhoGiay)
        {
            ...
            DataTable data = rptKTCS_MauC52(NamChungTu, iID_MaDonVi, TongHopDonVi,KhoGiay);
        ...
        public clsExcelResult ExportToExcel(String NamChungTu, String iID_MaDonVi, String TongHopDonVi, String KhoGiay)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                if (KhoGiay == "1")
                {
                    clsResult.FileName = "MauDanhGiaLaiTaiSan_A3";
                }
                else
                {
                    clsResult.FileName = "MauDanhGiaLaiTaiSan";
                }
                clsResult.type = "xls";
                return clsResult;
            }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamChungTu, String iID_MaDonVi, String TongHopDonVi, String KhoGiay)
        {
            String sFilePath = "";
            if (KhoGiay == "1")
            {
