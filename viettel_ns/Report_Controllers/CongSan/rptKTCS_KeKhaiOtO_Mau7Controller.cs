...
{
    public class rptKTCS_KeKhaiOtO_Mau7Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String LoaiBieu = "",String KhoGiay="")
        {
            String sFilePath = "";
            if (KhoGiay == "1")
            {
 ...
 INNER JOIN (SELECT * FROM KTCS_KhauHaoHangNam WHERE iTrangThai=1 AND iNamLamViec=@NamLamViec)  AS E ON A.iID_MaTaiSan=E.iID_MaTaiSan
        ...
        /// </summary>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamChungTu, String iID_MaLoaiTaiSan, String iID_MaDonVi, String LoaiBieu, String TongHopDonVi, String TongHopLTS, String KhoGiay)
        {
            String sFilePath = "";
            if (KhoGiay == "1")
            {
