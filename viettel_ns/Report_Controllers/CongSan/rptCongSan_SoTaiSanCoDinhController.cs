...
{
    public class rptCongSan_SoTaiSanCoDinhController : Microsoft.AspNetCore.Mvc.Controller
    {
...
", DKDonVi, DKNhomTaiSan);
        ...
        /// </summary>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamChungTu,String ThangChungTu, String iID_MaLoaiTaiSan, String iID_MaDonVi, String TongHopDonVi, String TongHopLTS, String KhoGiay)
        {
            HamChung.Language();
            String sFilePath = "";
            if (KhoGiay == "1")
