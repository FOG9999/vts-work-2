...
{
    public class rptKTCS_HoachToanTSCDController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String LoaiBieu = "")
        {
            String sFilePath = "";
            if (LoaiBieu == "rDonVi")
            {
...
", DKDonVi,DKNhomTaiSan);
        ...
        /// </summary>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamChungTu, String iID_MaLoaiTaiSan, String iID_MaDonVi, String LoaiBieu, String TongHopDonVi, String TongHopLTS)
        {
            String sFilePath = "";
            if (LoaiBieu == "rDonVi")
            {
