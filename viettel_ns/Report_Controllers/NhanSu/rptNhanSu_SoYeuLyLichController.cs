...
{
    public class rptNhanSu_SoYeuLyLichController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="iID_MaCanBo"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaCanBo)
        {
            String DuongDanFile = sFilePath;
            ExcelFile xls = CreateReport(Server.MapPath(DuongDanFile), iID_MaCanBo);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
