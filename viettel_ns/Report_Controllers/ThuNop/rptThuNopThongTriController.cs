...
namespace VIETTEL.Report_Controllers.ThuNop {
    public class rptThuNopThongTriController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaChungTu, String iID_MaDonVi, String iID_MaThongTri, String sSoCT, String iLoai, String noiDung)
        {
            HamChung.Language();
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaThongTri, String iID_MaChungTu, String iLoai)
        {
            Bang bang = new Bang("KT_LoaiThongTri");
            bang.MaNguoiDungSua = User.Identity.Name;
            bang.IPSua = Request.UserHostAddress;
