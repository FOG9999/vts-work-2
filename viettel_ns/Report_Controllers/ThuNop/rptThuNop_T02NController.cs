...
{
    public class rptThuNop_T02NViewModel
    {
...
{
    public class rptThuNop_T02NController : FlexcelReportController
    {
        // GET: /rptThuNop_T02N/
        #region var def
        public string _viewPath = "~/Views/Report_Views/ThuNop/";
        private const String sFilePath = "~/Report_ExcelFrom/ThuNop/rptThuNop_T02N";
        private const String sFilePath_To2 = "~/Report_ExcelFrom/ThuNop/rptThuNop_T02N_To2";
        private const String sFilePath_B = "~/Report_ExcelFrom/ThuNop/rptThuNop_T02N_B";
        private const String sFilePath_B_To2 = "~/Report_ExcelFrom/ThuNop/rptThuNop_T02N_B_To2";
        private const String sFilePathTH = "~/Report_ExcelFrom/ThuNop/rptThuNop_T02NTH";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            var vm = new rptThuNop_T02NViewModel
            {
            ...
            else
            {
                if (iID_MaPhongBan == "-1")
                {
                    ...
                    else if (tSo == "2")
                    {
                        if (rSo == "1")
                        {
                            this._filePath = sFilePath_To2 + ".xls";
                        }
                        else if (rSo == "1000")
                        {
                            this._filePath = sFilePath_To2 + "_k.xls";
                        }
                        else if (rSo == "1000000")
                        {
                            this._filePath = sFilePath_To2 + "_m.xls";
                        }
                    }
                ...
                else
                {
                    ...
                    else if (tSo == "2")
                    {
                        if (rSo == "1")
                        {
                            this._filePath = sFilePath_B_To2 + ".xls";
                        }
                        else if (rSo == "1000")
                        {
                            this._filePath = sFilePath_B_To2 + "_k.xls";
                        }
                        else if (rSo == "1000000")
                        {
                            this._filePath = sFilePath_B_To2 + "_m.xls";
                        }
                    }
                }
            }
            ...
            foreach (DataRow dtr in dvt.Rows)
            {
                if (Convert.ToString(dtr["rSo"]) == rSo)
                {
                    if (tSo == "1")
                        ...
                        fr.SetValue("DVT", "Mẫu số: T02/N - " + dtr["sTen"]);
                }
            }
        ...
        {
            DataTable dataDN = rptThuNop_T02N("DN");
            ...
            DataTable dataDT = rptThuNop_T02N("DT");
        ...
        /// <returns></returns>
        public DataTable rptThuNop_T02N(String loaiDvi)
        {
            #region definition input

            var sql = FileHelpers.GetSqlQuery("rptThuNop_T02N.sql");
            ...
            if (PhienLamViec.iNamLamViec == "2017")
            {
                sql = sql.Replace("@@rTienLuong", "rTienLuong");
            }
            else
            {
                sql = sql.Replace("@@rTienLuong", "0");
            }
            #endregion
