...
{
    public class rptQuyetToan_ThongTri_7Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QuyetToan_ThongTri_Report/
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QuyetToan/rptQuyetToanThongTri_7.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if(HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath,User.Identity.Name)){
                ViewData["PageLoad"] = "0";
            ViewData["path"] = "~/Report_Views/QuyetToan/rptQuyetToan_ThongTri_7.aspx";
        ...
        public DataTable rptQT_ThongTri( String iThang_Quy, String iID_MaTrangThaiDuyet, String iID_MaDonVi,String MaND)
        {
            ...
            SQL += " WHERE sLNS='1010000' AND sNG<>'' AND bLoaiThang_Quy=0 AND iThang_Quy=@iThang_Quy {1} AND {0} AND iTrangThai=1";
        ...
        public ExcelFile CreateReport(String path, String iThang_Quy, String iID_MaTrangThaiDuyet, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptQuyetToan_ThongTri_7");
        ...
        /// <summary>
        /// Định dạng báo cáo theo PDF
        /// </summary>
        /// <param name="iNamLamViec"></param>
        /// <param name="iThang_Quy"></param>
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF( String iThang_Quy, String iID_MaTrangThaiDuyet, String iID_MaDonVi)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iThang_Quy,iID_MaTrangThaiDuyet, iID_MaDonVi);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
        ...
        public static DataTable DanhSachDonVi(String iThang_Quy, String iID_MaTrangThaiDuyet,String MaND)
        {
            ...
            String SQL = String.Format(@"SELECT a.iID_MaDonVi,sTen
                                        FROM ( SELECT DISTINCT iID_MaDonVi FROM QTA_ChungTuChiTiet WHERE iTrangThai=1 AND (sLNS='1010000')                                              
                                               {1} AND iThang_Quy=@iThang_Quy AND bLoaiThang_Quy=0 AND {0}) a
