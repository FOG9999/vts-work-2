...
{
    public class rptQuyetToanNam_ThongBaoSoChuyenNamSauController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QuyetToan/QuyetToanNhanh/rptQuyetToanNam_ThongBaoSoChuyenNamSau_TongHopDenLNS.xls";
        private const String sFilePath1 = "/Report_ExcelFrom/QuyetToan/QuyetToanNhanh/rptQuyetToanNam_ThongBaoSoChuyenNamSau_TongHopDenDonVi.xls";
        public static String NameFile = "";

        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ViewData["path"] = "~/Report_Views/QuyetToan/QuyetToanNhanh/rptQuyetToanNam_ThongBaoSoChuyenNamSau.aspx";
        ...
        /// <returns></returns>
        public static DataTable rptQuyetToanNam_ThongBaoSoChuyenNamSau(String MaND,String iID_MaPhongBan,String iID_MaDonVi,String iID_MaNamNganSach)
        {
...
OR SUM(CASE WHEN iID_MaNamNganSach=1 THEN rDaCapTien ELSE 0 END)<>0) a
INNER JOIN 
...
",DKPhongBan,DKDonVi,DK);
        ...
        {
            DataRow r;
            DataTable data = rptQuyetToanNam_ThongBaoSoChuyenNamSau(MaND, iID_MaPhongBan, iID_MaDonVi, iID_MaNamNganSach);
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan, String iID_MaDonVi,String iID_MaNamNganSach,String iLoai)
        {
            HamChung.Language();
            String sDuongDan = "";
               if (iLoai == "DonVi")
