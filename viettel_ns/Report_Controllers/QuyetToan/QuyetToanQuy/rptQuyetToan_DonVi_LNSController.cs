...
{
    public class rptQuyetToan_DonVi_LNSController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
    ...
    String.Format(@"SELECT SUBSTRING(sLNS,1,1) as sLNS1,
            ...
            cmd.Dispose();
            DataColumn column = new DataColumn("rChiTieu", typeof(decimal));
        ...
        {
            String MaPhongBan = Request.Form["QuyetToanNganSach" + "_iID_MaPhongBan"];
