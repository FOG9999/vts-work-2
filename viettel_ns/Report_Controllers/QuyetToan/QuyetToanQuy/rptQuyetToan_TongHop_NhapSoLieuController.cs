...
{
    public class rptQuyetToan_TongHop_NhapSoLieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public static DataTable rptQuyetToan_TongHop_NhapSoLieu(String MaND, String iThang_Quy, String iID_MaNamNganSach, String iID_MaPhongBan)
        {
            ...
            String SQL = String.Format(@"
                        SELECT A.iID_MaDonVi,A.sTenDonVi as sTenDonVi, A.sLNS as sLNS, SUM(A.rTuChi) as rLuyKe,A.sLNS + '-' + B.sMoTa as sMoTa,
                        rTuChi=SUM(CASE WHEN iThang_Quy=@iThang_Quy THEN rTuChi ELSE 0 END) 
                        FROM QTA_ChungTuChiTiet as A 
                            INNER JOIN NS_MucLucNganSach as B ON A.sLNS=B.sLNS
                        WHERE sTenDonVi<>'' AND rTuChi<>'0' AND A.iTrangThai=1 AND B.iTrangThai=1 
                            AND LEN(B.sLNS)=7 AND SUBSTRING(B.sLNS,1,1)<>'8' AND B.sL = ''  
                            AND iNamLamViec=@iNamLamViec 
                            AND iThang_Quy<=@iThang_Quy {0} {1} {2}
                        GROUP BY iID_MaDonVi,sTenDonVi, A.sLNS, B.sMoTa
                        ORDER BY iID_MaDonVi", DKPhongBan, DKDonVi, DK);
        ...
        private void LoadData(FlexCelReport fr, String MaND, String iThang_Quy, String iID_MaNamNganSach, String iID_MaPhongBan)
        {
            ...
            DataTable dtDonVi = HamChung.SelectDistinct("dtDonVi", data, "iID_MaDonVi,sTenDonVi", "iID_MaDonVi,sTenDonVi");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iThang_Quy, String iID_MaNamNganSach, String iID_MaPhongBan)
        {
            HamChung.Language();
            String sDuongDan = "";
