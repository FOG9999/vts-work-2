...
{
    public class rptQuyetToan_TongHop_LNSController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
        ...
        public static DataTable rptQuyetToan_TongHop_LNS(String MaND, String sLNS, String iThang_Quy, String MaTo, String iID_MaNamNganSach, String iID_MaPhongBan)
        {
            ...
            //                                        , iID_MaNamNganSach
            //                                        , iID_MaPhongBan, iThang_Quy, iThang_Quy, sLNS, MaND);
            return dt;
        }
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iThang_Quy, String sLNS, String MaTo, String iID_MaNamNganSach, String iID_MaPhongBan)
        {
            HamChung.Language();
            String sDuongDan = "";
            if (MaTo == "1")
