...
{
    public class rptQTQS_LienThamController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QuyetToan/QuyetToanQuanSo/rptQTQS_LienTham.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/QuyetToan/QuyetToanQuanSo/rptQTQS_LienTham.aspx";
                ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path)
        {
            ...
            LoadData(fr);
            fr = ReportModels.LayThongTinChuKy(fr, "rptQTQS_LienTham", MaND);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public DataTable DT_rptQTQS_LienTham()
        {
...
", DKThangTruoc, DKThangNay, DKPhongBan,DKDonVi,DK);
        ...
        {
            DataRow r;
            DataTable data = DT_rptQTQS_LienTham();
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaPhongBan, String iThang_Quy, String LoaiThang_Quy, String bCheckTongHop)
        {
            HamChung.Language();
            this.MaND = MaND;
            this.iID_MaDonVi = iID_MaDonVi;
