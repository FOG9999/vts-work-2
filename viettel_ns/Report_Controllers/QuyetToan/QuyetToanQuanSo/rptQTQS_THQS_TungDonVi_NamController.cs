...
{
    public class rptQTQS_THQS_TungDonVi_NamController : Microsoft.AspNetCore.Mvc.Controller
    {
...
", DK, DKDonVi, DKPhongBan);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaPhongBan, String bCheckTongHop)
        {
            HamChung.Language();
            this.MaND = MaND;
            this.iID_MaDonVi = iID_MaDonVi;
