...
{
    public class rptQTQS_THQS_TungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
...
GROUP BY sKyHieu", DKDV, DKPhongBan, DKDonVi, DK);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaPhongBan, String iThang)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaDonVi, iID_MaPhongBan, iThang);
