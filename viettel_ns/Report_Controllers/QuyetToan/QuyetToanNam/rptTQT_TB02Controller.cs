...
{
    public class rptTQT_TB02Controller : FlexcelReportController
    {
        ...
        private const string _filePath_TongHop = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptTQT_TB02_NG_DonVi.xls";
        private const string _filePath = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptTQT_TB02_NG.xls";
            ...
            string phuluc)
        {
            ...
            sql = FileHelpers.GetSqlQuery("tqt_tb02_2.sql");
            ...
            string date)
        {
            ...
            var filename = $"Quyết_toán_{NganSachService.Default.GetDonVi(PhienLamViec.iNamLamViec, iID_MaDonVi).sMoTa}_năm_{PhienLamViec.iNamLamViec}_Phụ_lục_2II.xls";
