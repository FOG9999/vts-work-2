...
{
    public class rptTQT_TB02_ChonToController : FlexcelReportController
    {
        private const string sFilePath = "~/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptTQT_DonVi_TB02_ChonTo.xls";
        private const string sFilePath6 = "~/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptTQT_DonVi_TB06.xls";
        private const string sFilePath7 = "~/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptTQT_DonVi_TB07_ChonTo.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            var view = string.Format("{0}{1}.cshtml", "~/Views/Report_Views/QuyetToan/TQT/", "rptTQT_TB02_ChonTo");
            return View(view, vm);
        }
            ...
            int toSo)
        {
            ...
            var filename = $"Quyết_toán_{NganSachService.Default.GetDonVi(PhienLamViec.iNamLamViec, iID_MaDonVi).sMoTa}_năm_{PhienLamViec.iNamLamViec}_tb_{loaiPl}_tờ_số_{toSo}.xls";
            return Print(xls, ext, filename);
        }

        public Microsoft.AspNetCore.Mvc.ActionResult Ds_To(string iID_MaPhongBan, string iID_MaDonVi, string loai)
        {
        ...
        private DataSet getDataSet(string iID_MaPhongBan, string iID_MaDonVi, string loai)
        {
            using (var conn = ConnectionFactory.Default.GetConnection())
            {
                ...
                var cmd = new SqlCommand("qt_report_plI_v2", conn);
            ...
            int toSo)
        {
            ...
            {
                data.Columns.Add(new DataColumn($"V{i + 1}", typeof(decimal)));
            }
