...
{
    public class rptQuyetToan_KiemToan101102_TXController : Microsoft.AspNetCore.Mvc.Controller
    {
...
;
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iNamLamViec, String iID_MaNamNganSach)
        {
            HamChung.Language();
            this.iNamLamViec = iNamLamViec;
            this.iID_MaNamNganSach = iID_MaNamNganSach;
