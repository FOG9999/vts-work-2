...
{
    public class rptTongHopQuanSoTangGiamTheoDonVi_48Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        // Created: Huyền Lê
        // Edited: Thương
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iThang, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iThang, iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
