...
{
    public class rptQuanSoQuyetToan_52Controller : Microsoft.AspNetCore.Mvc.Controller
    {         
        //Created: Huyền Lê
        //Edited: Thương
        ...
        /// <param name="iMaDV">Mã đơn vị</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iQuy, String iID_MaTrangThaiDuyet, String iAll, String iMaDV)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iQuy, iID_MaTrangThaiDuyet, iAll, iMaDV);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
