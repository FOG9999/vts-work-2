...
{
    public class rptQuyetToanNam_SoPheDuyetController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
...
", DKPhongBan,DKDonVi,DK);
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan, String iID_MaDonVi,String iID_MaNamNganSach,String iLoai,String iID_MaNguonNganSach,String iID_MaMauBaoCao)
        {
            HamChung.Language();
            String sDuongDan = "";
