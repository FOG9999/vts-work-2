...
{
    public class rptQuyetToanNam_2A_ViewModel
    {
...
{
    public class rptQuyetToanNam_2AController : FlexcelReportController
    {
        ...
        private const string _filePath_TongHop_Lns =
            "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_LNS.xls";
        //"/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_LNS_RutGon.xls";
        //"/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_LNS_RutGon2.xls";

        private const string _filePath_TongHop_DonVi =
            "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_DonVi.xls";

        private const string _filePath_TongHop_DonVi_Bql =
         "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_DonVi_Bql.xls";

        private const string _filePath_TongHop_DonVi_RutGon =
            "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_DonVi_RutGon.xls";

        private const string _filePath_DonVi = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_DonVi.xls";
        //private const string _filePath = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_4.xls";
        private const string _filePath_NG = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A_TongHop_NG_DonVi.xls";
        private const string _filePath = "/Report_ExcelFrom/QuyetToan/QuyetToanNam/rptQuyetToanNam_2A.xls";
            ...
            string iID_MaNamNganSach)
        {
            ...
            sql = _sOrL == 1
                ? FileHelpers.GetSqlQuery("qt_nam_2a_rutgon.sql")
                : FileHelpers.GetSqlQuery("qt_nam_2a_ng.sql");
            ...
            using (var conn = ConnectionFactory.Default.GetConnection())
            {
                ...
                var phongban_list =
                    (iID_MaPhongBan.IsEmpty("-1") ? "05,06,07,08,10,16,17" : iID_MaPhongBan).ToList();

                foreach (var phongban in phongban_list)
                {
                    using (var cmd = new SqlCommand(sql, conn))
                    {
                        cmd.Parameters.AddWithValue("iID_MaPhongBan", phongban.ToParamString());
                        cmd.Parameters.AddWithValue("iID_MaNamNganSach",
                            string.IsNullOrWhiteSpace(iID_MaNamNganSach) || iID_MaNamNganSach == "0"
                                ? "1,2"
                                : iID_MaNamNganSach);
                        cmd.Parameters.AddWithValue("iNamLamViec", PhienLamViec.iNamLamViec);
                        cmd.Parameters.AddWithValue("iNamLamViecNS", Convert.ToInt32(PhienLamViec.iNamLamViec) + 1);
                        ...
                        if (data == null)
                        {
                            ...
                            data.AsEnumerable().ToList()
                               .ForEach(r =>
                               {
                                   r["iID_MaPhongBan"] = phongban;
                               });
                        }
                        else
                        {
                            dt.Columns.Add("iID_MaPhongBan", typeof(string));
            ...
            string loaiBaoCao)
        {
            ...
            //    FillDataTable(fr, data, "sLNS1 sLNS3 sLNS5 sLNS iID_MaPhongBan iID_MaDonVi,sTenDonVi", PhienLamViec.iNamLamViec);
            //}
            ...
            else if (loaiBaoCao == "2" || loaiBaoCao == "3")
            {
                FillDataTable(fr, data, "sLNS1 sLNS3 sLNS5 sLNS sL,sK sM sTM sTTM,sNG", PhienLamViec.iNamLamViec);
            }
            else if (loaiBaoCao == "10")
            ...
            fr.SetValue("BQuanLy",
                GetPhongBanId(iID_MaPhongBan).IsEmpty() ? "" : _nganSachService.GetPhongBanById(iID_MaPhongBan.ToList().FirstOrDefault()).sMoTa);
        ...
        private string getXlsFile(string loaiBaoCao)
        {
            ...
            else if (loaiBaoCao == "0") path = _filePath_TongHop_DonVi;
            else if (loaiBaoCao == "10") path = _filePath_TongHop_DonVi_Bql;
            else if (loaiBaoCao == "1") path = _filePath_TongHop_Lns;
            else if (loaiBaoCao == "3") path = _filePath_NG;
