...
{
    public class rptQuyetToanQuanSo_47Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //Quyết toán quân số
        //Edit date: 07-7-2012
        ...
        /// <param name="iMaDV">Mã đơn vị</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iThang, String iID_MaTrangThaiDuyet, String iAll, String iMaDV)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iThang, iID_MaTrangThaiDuyet, iAll, iMaDV);
