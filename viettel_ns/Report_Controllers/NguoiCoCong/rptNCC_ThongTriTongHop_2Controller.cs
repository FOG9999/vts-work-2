...
{
    public class rptNCC_ThongTriTongHop_2Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String Loai = "", String Kieu = "")
        {
            String sFilePath = "";
            if (Loai == "1" && Kieu == "1")
            {
        ...
        public ExcelFile CreateReport(String path, String MaND, String LoaiThangQuy, String Thang_Quy, String sLNS, String iID_MaDonVi, String iID_MaTrangThaiDuyet,String Loai,String Kieu)
        {
            ...
            LoadData(fr, MaND, LoaiThangQuy, Thang_Quy, sLNS, iID_MaDonVi, iID_MaTrangThaiDuyet,Loai,Kieu);
                ...
                fr.SetValue("BTL", ReportModels.CauHinhTenDonViSuDung(2,MaND));
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String LoaiThangQuy, String Thang_Quy, String sLNS, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String Loai, String Kieu)
        {
