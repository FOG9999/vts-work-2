...
{
    public class rptDuToan_103_TungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            var loaiKhoan = HamChung.GetLoaiKhoanText("1030100");
...
,rTuChi=SUM(rTuChi/{3})
 ...
 WHERE iTrangThai in (1,2)  AND sLNS LIKE '1030100%' 
...
ORDER BY sTen,sLNS,sL,sK,sM,sTM,sTTM,sNG,a.sMoTa"
 , "", DKPhongBan, DKDonVi, DVT);
        ...
        private void LoadData(FlexCelReport fr, String MaND, String iID_MaDonVi)
        {
            ...
            //dttinh chat
            dtTinhChat.Columns.Add("iTinhChatTemp", typeof(String));
            for (int i = 0; i < dtTinhChat.Rows.Count; i++)
            {
                ...
                if (r["iTinhChat"].ToString()=="0")
                    r["iTinhChatTemp"] = "3";
                else
                {
                    r["iTinhChatTemp"] = r["iTinhChat"];
                }
            }
            DataView dv = dtTinhChat.DefaultView;
            dv.Sort = "iLoai,iThamQuyen,iTinhChatTemp";
            dtTinhChat = dv.ToTable();
            ...
            //nhom
            dtNhom.Columns.Add("iTinhChatTemp", typeof(String));
            ...
            dv = dtNhom.DefaultView;
            dv.Sort = "iLoai,iThamQuyen,iTinhChatTemp,iNhom";
            dtNhom = dv.ToTable();
