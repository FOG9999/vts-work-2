...
{
    public class rptDuToan_1030100_TongHop_3bCController : Microsoft.AspNetCore.Mvc.Controller
    {
...
,Cot2=SUM(CASE WHEN iLoai=3 AND iNhom=9 THEN rTuChi/{2} ELSE 0 END)
,Cot3=SUM(CASE WHEN iLoai=3 AND iNhom=7 THEN rTuChi/{2} ELSE 0 END)
,Cot4=SUM(CASE WHEN iLoai=3 AND iNhom=8 THEN rTuChi/{2} ELSE 0 END)
...
,Cot8=SUM(CASE WHEN iLoai=3 AND iNhom IN (3,5) THEN rTuChi/{2} ELSE 0 END)
 ...
 WHERE DT_ChungTuChiTiet.iTrangThai in (1,2)  AND sLNS LIKE '1030100%' AND DT_ChungTuChiTiet.iNamLamViec=@iNamLamViec {0} {1}
...
,Cot2=SUM(CASE WHEN iLoai=3 AND iNhom=9 THEN rDuPhong/{2} ELSE 0 END)
,Cot3=SUM(CASE WHEN iLoai=3 AND iNhom=7 THEN rDuPhong/{2} ELSE 0 END)
,Cot4=SUM(CASE WHEN iLoai=3 AND iNhom=8 THEN rDuPhong/{2} ELSE 0 END)
