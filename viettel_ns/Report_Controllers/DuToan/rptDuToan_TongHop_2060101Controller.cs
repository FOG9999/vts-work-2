...
", "", DKPhongBan, DKDonVi, DVT);
        ...
        /// <returns></returns>
        /// 
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaPhongBan, int trinhky = 0)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaPhongBan, int trinhky = 0)
        {
            HamChung.Language();
