...
{
    public class rptDT_ChiNganSachSD_II_02Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
       ...
       // private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDT_ChiNganSachSD_II_02.xls";
        ...
        /// </summary>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String Check = "")
        {
            String sFilePath = "";
            if (Check == "off" )
            {
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi, String iID_MaDanhMuc, String sLNS, String iID_MaTrangThaiDuyet, String Check)
        {
            ...
            fr.SetValue("CucTaiChinh", ReportModels.CauHinhTenDonViSuDung(2,MaND));
            fr.Run(Result);
            return Result;
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaDanhMuc, String sLNS, String iID_MaTrangThaiDuyet, String Check)
        {
            HamChung.Language();
            String sFilePath = "";
            if (Check == "off")
