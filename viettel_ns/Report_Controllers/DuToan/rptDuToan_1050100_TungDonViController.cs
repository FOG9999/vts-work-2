...
{
    public class rptDuToan_1050100_TungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1050100_TungDonVi.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1050100_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1050100_TungDonVi");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1050100_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rHangNhap=SUM(rHangNhap/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1050100' AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi", iID_MaDonVi,DKPhongBan,DKDonVi,DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1050100_TungDonVi(MaND, iID_MaDonVi);
        ...
        public clsExcelResult ExportToExcel(String MaND, String iID_MaDonVi)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "DuToan_1050100_TungDonVi.xls";
                clsResult.type = "xls";
                return clsResult;
            }
