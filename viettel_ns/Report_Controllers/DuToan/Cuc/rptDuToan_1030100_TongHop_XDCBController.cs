...
{
    public class rptDuToan_1030100_TongHop_XDCBController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_1030100_TongHop_XDCB.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_1030100_TongHop_XDCB.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1030100_TongHop_XDCB");
            ...
            var loaiKhoan = HamChung.GetLoaiKhoanText("1030000");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1030100_TongHop_XDCB(String MaND,String iID_MaPhongBan)
        {
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai in (1,2)  AND sLNS LIKE '1030100%' AND iNamLamViec=@iNamLamViec {0} {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaPhongBan
HAVING SUM(rTuChi)<>0 OR SUM(rDuPhong)<>0
ORDER BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa"
 , "", DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1030100_TongHop_XDCB(MaND, iID_MaPhongBan);
