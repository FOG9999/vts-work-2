...
{
    public class rptDuToan_1020200_TongHopController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_1020200_TongHop.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_1020200_TongHop.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1020200_TongHop");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020200_TongHop(String MaND,String iID_MaPhongBan)
        {
...
,rHangNhap=SUM(rHangNhap/{3})
 ...
 WHERE iTrangThai in (1,2)  AND sLNS='1020200' AND iNamLamViec=@iNamLamViec {0} {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa", "",DKPhongBan,DKDonVi,DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1020200_TongHop(MaND, iID_MaPhongBan);
