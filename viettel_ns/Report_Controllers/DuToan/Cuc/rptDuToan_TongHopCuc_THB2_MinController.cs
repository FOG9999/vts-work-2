...
{
    public class rptDuToan_TongHopCuc_THB2_MinController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_TongHop_THB2_Min.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_TongHopCuc_THB2_Min.aspx";
            ViewData["PageLoad"] = "0";
...
ORDER BY a.iID_MaDonVi", DVT, DKPhongBan, DKCauHinhBaoDam, DKCauHinhTX, DKCauHinhNV, DKCauHinhXDCB, DKCauHinhDN, DKCauHinhQPK, DKCauHinhNN, DKCauHinhKPK);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Update_GhiChu(String sMoTa)
        {
            ...
            SqlCommand cmd = new SqlCommand(SQL);
            cmd.Parameters.AddWithValue("@iID_MaBaoCao", ReportModels.LayNamLamViec(MaND) + "rptDuToan_TongHop_THB2_Min");
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
