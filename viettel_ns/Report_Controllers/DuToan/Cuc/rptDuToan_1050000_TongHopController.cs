...
{
    public class rptDuToan_1050000_TongHopController : FlexcelReportController
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_1050000_TongHop.xls";

        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_1050000_TongHop.aspx";
                ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1050000_TongHop(String MaND, String iID_MaPhongBan)
        {
            ...
            var sql = FileHelpers.GetSqlQuery("rptDuToan_1050000_TongHop.sql");
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1050000_TongHop(MaND, iID_MaPhongBan);
