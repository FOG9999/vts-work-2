...
{
    public class rptDuToan_1050100_TongHopController : FlexcelReportController
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_1050100_TongHop.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_1050100_TongHop.aspx";
                ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1050100_TongHop");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1050100_TongHop(String MaND, String iID_MaPhongBan)
        {
...
,rHienVat=SUM(rHienVat/{3})
 ...
 WHERE iTrangThai in (1,2) AND sLNS='1050100'  AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa", DK, DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            //DataTable data = DT_rptDuToan_1050100_TongHop(MaND, iID_MaPhongBan);

            var data = getDataTable_1050100_ChonTo(iID_MaPhongBan);
        ...
        public clsExcelResult ExportToExcel(String MaND, String iID_MaPhongBan)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "DuToan_1050100_TongHop.xls";
                clsResult.type = "xls";
                return clsResult;
            }
        ...
        /// <returns></returns>
        private DataTable getDataTable_1050100_ChonTo(string id_phongban = null)
        {
            var sql = FileHelpers.GetSqlQuery("rptDuToan_1050100_TongHop.sql");
            ...
            using (var cmd = new SqlCommand(sql, conn))
            {
                ...
                cmd.Parameters.AddWithValue("@lns", "1050100");
