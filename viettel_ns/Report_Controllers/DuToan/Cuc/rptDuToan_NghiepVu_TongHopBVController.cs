...
{
    public class rptDuToan_NghiepVu_TongHopBVController : FlexcelReportController
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_NghiepVu_TongHopBV.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_NghiepVu_TongHopBV.aspx";
                ViewData["PageLoad"] = "0";
        ...
        public static DataTable DT_rptDuToan_1020000_01_TongHop(String MaND, String iID_MaPhongBan)
        {
            ...
            var sql = FileHelpers.GetSqlQuery("rptDuToan_NghiepVu_TongHopBV.sql");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan, String iCapTongHop)
        {
            this.iCapTongHop = iCapTongHop;
            if (iCapTongHop == "Muc")
            {
