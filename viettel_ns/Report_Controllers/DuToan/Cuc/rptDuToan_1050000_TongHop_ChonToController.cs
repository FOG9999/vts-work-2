...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1050000_TongHop_ChonToController : FlexcelReportController
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string ToSo, int trinhky = 0)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string ToSo, int trinhky = 0)
        {
            HamChung.Language();
