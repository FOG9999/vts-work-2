...
{
    public class rptDuToan_TongHopCuc_PBQPController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_TongHopCuc_PBQP.xls";
        private const String sFilePath_NT = "/Report_ExcelFrom/DuToan/Cuc/rptDuToan_TongHopCuc_PBQP_NT.xls";
        ...
        {            
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/Cuc/rptDuToan_TongHopCuc_PBQP.aspx";
                ViewData["PageLoad"] = "0";
            ...
            using (var conn = _connectionFactory.GetConnection())
            {
                var dt = conn.GetTable(sql,
                    new
                    {
                        ...
                        pb = iID_MaPhongBan.ToParamString(),
                    });
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan, string loaiBaoCao = "0")
        {
            DataTable dtCauHinh = DuToan_ChungTuModels.GetCauHinhBia(User.Identity.Name);
            _xLNS = dtCauHinh.Rows[0]["xLNS"].ToString();
            _xDonVi = dtCauHinh.Rows[0]["xDonVi"].ToString();
