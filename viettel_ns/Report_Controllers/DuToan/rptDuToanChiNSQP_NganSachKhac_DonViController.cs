...
{
    public class rptDuToanChiNSQP_NganSachKhac_DonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaTrangThaiDuyet, String iID_MaDonVi, String sLNS)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaTrangThaiDuyet, iID_MaDonVi, sLNS);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
