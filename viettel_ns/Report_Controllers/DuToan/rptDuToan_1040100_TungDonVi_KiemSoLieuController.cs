...
{
    public class rptDuToan_1040100_TungDonVi_KiemSoLieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi, String iID_MaNganh)
        {
            ...
            string sql = String.Format(@"SELECT * FROM NS_MucLucNganSach_Nganh WHERE iNamLamViec=@iNamLamViec AND iTrangThai=1 AND iID = '" + iID_MaDonVi + "'");
        ...
        public static DataTable DT_rptDuToan_1040100_TungDonVi_KiemSoLieu(String MaND, String iID_MaDonVi, String iID_MaNganh)
        {
            ...
            {
                string sql = String.Format(@"SELECT * FROM NS_MucLucNganSach_Nganh WHERE iTrangThai=1 AND iNamLamViec = @iNamLamViec AND iID_MaNganh IN (" + arrNganh[i] + ")");
            ...
            int DVT = 1000;
            String SQL = String.Format(@"SELECT MaNganh='',sTenNganh='',Nguon='1020100',Loai=1,iID_MaPhongBan,iID_MaPhongBanDich=iID_MaPhongBan,iID_MaDonVi,sTenDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa
,SUM(rTuChi) as rTuChi
,SUM(rHienVat) as rHienVat
FROM DT_ChungTuChiTiet
WHERE (sLNS='1020100'  OR  sLNS='1020000')AND iTrangThai=1  AND iNamLamViec=@iNamLamViec {0} {1}
...
SELECT MaNganh='',sTenNganh='',Nguon='1040100',Loai=2,iID_MaPhongBan,iID_MaPhongBanDich,iID_MaDonVi,sTenDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa
,SUM(rTuChi) as rTuChi
,SUM(rHienVat) as rHienVat
...
SELECT MaNganh='',sTenNganh='',Nguon='1040100',Loai=3,iID_MaPhongBan,iID_MaPhongBanDich,iID_MaDonVi,sTenDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa
,SUM(rTuChi) as rTuChi
,SUM(rHienVat) as rHienVat
FROM DT_ChungTuChiTiet_PhanCap
...
", DKChonDV, DKChonnganh);
            ...
            SQL = String.Format("SELECT * FROM NS_MucLucNganSach_Nganh WHERE iNamLamViec = @iNamLamViec");
            ...
            {
                String sNG = Convert.ToString(dt.Rows[i]["sNG"]);
                for (int j = 0; j < dtNganh.Rows.Count; j++)
                {
                    String sMaNganhMLNS = Convert.ToString(dtNganh.Rows[j]["iID_MaNganhMLNS"]);
                    if (sMaNganhMLNS.Contains(sNG))
                    {
                        dt.Rows[i]["MaNganh"] = Convert.ToString(dtNganh.Rows[j]["iID_MaNganh"]);
                        dt.Rows[i]["sTenNganh"] = Convert.ToString(dtNganh.Rows[j]["sTenNganh"]);
                    }
                }
        ...
        private void LoadData(FlexCelReport fr, String MaND, String iID_MaDonVi, String iID_MaNganh)
        {
            ...
            DataTable dtsTM = HamChung.SelectDistinct("dtsTM", data, "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,sLNS,sL,sK,sM,sTM,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,sLNS,sL,sK,sM,sTM,sMoTa,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "sLNS,sL,sK,sM,sTM,sTTM");
            DataTable dtsM = HamChung.SelectDistinct("dtsM", dtsTM, "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,sLNS,sL,sK,sM,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,sLNS,sL,sK,sM,sMoTa,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "sLNS,sL,sK,sM,sTM");
            DataTable dtNganh = HamChung.SelectDistinct("dtNganh", dtsTM, "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,MaNganh,sTenNganh,iID_MaDonVi,sTenDonVi", "sLNS,sL,sK,sM,sTM");
            DataTable dtDonVi = HamChung.SelectDistinct("dtDonVi", dtNganh, "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,iID_MaDonVi,sTenDonVi", "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich,iID_MaDonVi,sTenDonVi", "sLNS,sL,sK,sM,sTM");
            DataTable dtPhongBanDich = HamChung.SelectDistinct("dtPhongBanDich", dtDonVi, "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich", "Nguon,Loai,iID_MaPhongBan,iID_MaPhongBanDich", "");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaNganh)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaDonVi, iID_MaNganh);
