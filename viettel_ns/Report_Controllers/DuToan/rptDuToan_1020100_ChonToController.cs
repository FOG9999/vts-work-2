...
{
    public class rptDuToan_1020100_ChonToController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020100_ChonTo.aspx";
                ViewData["PageLoad"] = "0";
        ...
        private ExcelFile createReport(string sLNS, string MaTo)
        {
            ...
            var dtDonVi = DuToan_ReportModels.dtDonVi(Username, sLNS);
            String iID_MaDonVi = "";
            ...
            fr.UseCommonValue()
                .SetValue(new
                {
                    TieuDe2 = "Kinh phí nghiệp vụ các ngành"
                })
              .UseChuKy()
        ...
        private DataTable DT_rptDuToan_1020000_ChonTo2(string MaND, string sLNS, string MaTo)
        {
            ...
            var dt = _duToanService.ChonTo(MaND, sLNS ?? "1020100", int.Parse(MaTo));
            return dt;
        }
...
{3}
 ...
 WHERE ((iTrangThai=1 {2}) OR (iTrangThai = 2 AND iID_MaTrangThaiDuyet = 2 AND iID_MaPhongBanDich = @iID_MaPhongBan)) AND iNamLamViec=@iNamLamViec  {0} {1} 
