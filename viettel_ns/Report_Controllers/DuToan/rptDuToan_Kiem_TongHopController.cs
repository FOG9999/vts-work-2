...
{
    public class rptDuToan_Kiem_TongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
...
ORDER BY iID_MaDonVi", DVT, DKPhongBan, DKDonVi);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan,String iID_MaNguon)
        {
            HamChung.Language();
            String DuongDan = "";
            if (iID_MaNguon == "1")
