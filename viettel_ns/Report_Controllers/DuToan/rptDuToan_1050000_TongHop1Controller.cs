...
{
    public class rptDuToan_1050000_TongHop1Controller : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1050000_TongHop_Loai1.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1050000_TongHop_1.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1050000_TongHop_1");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1050000_TongHop_1(String MaND,String iID_MaPhongBan)
        {
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1050000' AND iNamLamViec=@iNamLamViec {0} {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa", "",DKPhongBan,DKDonVi,DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1050000_TongHop_1(MaND, iID_MaPhongBan);
