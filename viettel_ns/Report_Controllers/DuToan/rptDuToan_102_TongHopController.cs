...
{
    public class rptDuToan_102_TongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
...
,KhoiQKQD=SUM(CASE WHEN (iID_MaPhongBan<>06 AND  iID_MaPhongBan<>10)THEN (rTuChi)/{3} ELSE  0 END)
 ...
 WHERE iTrangThai=1  AND sLNS LIKE '102%' AND sNG='00'  AND iNamLamViec=@iNamLamViec {1} {2} AND rTuChi<>0
