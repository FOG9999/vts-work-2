...
namespace VIETTEL.Report_Controllers.DuToan
{
    ...
    public class rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        
        // EDIT MaND, Trang thai duyet: LE
        // GET: /rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonVi/
        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDTCNSQP_NganSachHoTroDoanhNghiep.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
             ...
             {
              ViewData["path"] = "~/Report_Views/DuToan/rptDTCNSQP_NganSachHoTroDoanhNghiep.aspx";          
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi, String iID_MaTrangThaiDuyet)
        {
            ...
            if (teN.Rows.Count>0)
            {
             ...
             String NgayThangNam = ReportModels.Ngay_Thang_Nam_HienTai();
              ...
              fr = ReportModels.LayThongTinChuKy(fr, "rptDTCNSQP_NganSachHoTroDoanhNghiepTheoDonVi");
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaDonVi, iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
        ...
        public static DataTable DTCNSQP_NganSachHoTroDoanhNghiep(String MaND, String iID_MaDonVi, String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = String.Format(@"SELECT b.iID_MaDonVi,b.sTen,sLNS,sL,sK, sM,sTM,sTTM,sNG,a.sMoTa,rTuChi, rHangNhap
                                         FROM (SELECT iID_MaDonVi,sLNS,sL,sK, sM,sTM,sTTM,sNG,sMoTa,SUM(rTuChi) as rTuChi,SUM(rHangNhap) as rHangNhap
                                                FROM DT_ChungTuChiTiet 
                                                WHERE sLNS='1050000' and sL='460' and sK='468' AND iID_MaDonVi=@iID_MaDonVi AND iTrangThai = 1 {0} {1}
                                                GROUP BY iID_MaDonVi,sLNS,sL,sK, sM,sTM,sTTM,sNG,sMoTa
                                                HAVING SUM(rTuChi) <>0 OR SUM(rHangNhap)<>0
                                                ) as a
                                        INNER JOIN (SELECT * FROM NS_DonVi WHERE iID_MaDonVi=@iID_MaDonVi AND iTrangThai=1 AND iNamLamViec_DonVi=@iNamLamViec) b ON a.iID_MaDonVi=b.iID_MaDonVi", ReportModels.DieuKien_NganSach(MaND,"DT_ChungTuChiTiet"),iID_MaTrangThaiDuyet);
