...
,rTonKho=SUM(rTonKho/{3})
 ...
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi", iID_MaDonVi, DKPhongBan, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaDonVi, int trinhky)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaDonVi, int trinhky)
        {
            HamChung.Language();
            var xls = CreateReport(iID_MaDonVi, trinhky);
