...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_2_TungDonViController : AppController
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(string ParentID, string iID_MaDonVi)
        {
...
HAVING SUM(rTuChi)<>0 OR SUM(rPhanCap/1000)<>0 OR SUM(rDuPhong/1000)<>0", iID_MaDonVi, DKPhongBan, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaDonVi, string iCapTongHop)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaDonVi, string iCapTongHop)
        {
            HamChung.Language();
