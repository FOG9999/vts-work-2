...
{
    public class  rptDuToan_1010000_TungDonVi_DoanhNghiepController : Microsoft.AspNetCore.Mvc.Controller
    {
...
HAVING SUM(rTuChi)<> 0 OR SUM(rChiTapTrung)<>0 ", iID_MaDonVi, DKPhongBan, DKDonVi, DVT, iID_MaPhongBanQuanLy);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi,String sTrinhKy)
        {
            HamChung.Language();            
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaDonVi);
