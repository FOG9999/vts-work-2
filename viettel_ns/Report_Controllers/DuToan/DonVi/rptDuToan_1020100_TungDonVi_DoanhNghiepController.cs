...
{
    public class rptDuToan_1020100_TungDonVi_DoanhNghiepController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/DonVi/rptDuToan_1020100_TungDonVi_DoanhNghiep.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/DonVi/rptDuToan_1020100_TungDonVi_DoanhNghiep.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1020100_TungDonVi_DoanhNghiep");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public  DataTable DT_rptDuToan_1020100_TungDonVi_DoanhNghiep(String MaND,String iID_MaDonVi)
        {
            ...
            String SQL = String.Format(@"SELECT sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi,SUM(rTuChi) as rTuChi,SUM(rHienVat) as rHienVat,SUM(rChiTapTrung) as rChiTapTrung
FROM
(
...
,rChiTapTrung=SUM(CASE WHEN iID_MaPhongBan='06' THEN rTuChi/{0}	ELSE rChiTapTrung/{0} END)
 ...
 AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec AND iID_MaPhongBan=@iID_MaPhongBanDoanhNghiep AND  {3}
  {1} {2}
...
,rChiTapTrung=SUM(rChiTapTrung/{0})
 ...
 AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec AND iID_MaPhongBanDich=@iID_MaPhongBanDoanhNghiep
  {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi
...
GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi
 ORDER BY sM,sTM,sTTM,sNG", DVT, DKPhongBan, DKDonVi, iID_MaPhongBanQuanLy);
            ...
            cmd.Parameters.AddWithValue("@iID_MaPhongBanDoanhNghiep", "06");
