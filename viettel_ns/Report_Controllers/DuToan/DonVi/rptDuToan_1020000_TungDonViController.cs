...
{
    public class rptDuToan_1020000_TungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/DonVi/rptDuToan_1020000_TungDonVi.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/DonVi/rptDuToan_1020000_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1020000_TungDonVi");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public  DataTable DT_rptDuToan_1020000_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rHienVat=SUM(rHienVat/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1020000' AND {4} AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi", iID_MaDonVi, DKPhongBan, DKDonVi, DVT, iID_MaPhongBanQuanLy);
            cmd.CommandText = SQL;
            cmd.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(MaND));
            cmd.Parameters.AddWithValue("@iID_MaDonVi", iID_MaDonVi);
           // cmd.Parameters.AddWithValue("@MaPhongBanQL", iID_MaPhongBanQuanLy);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1020000_TungDonVi(MaND, iID_MaDonVi);
