...
{
    public class rptDuToan_1020000_TongHopController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020000_TongHop.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020000_TongHop.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1020000_TongHop");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020000_TongHop(String MaND,String iID_MaPhongBan)
        {
...
,rHienVat=SUM(rHienVat/{3})
 ...
 WHERE iTrangThai=1  AND sLNS LIKE '1020100%' AND iNamLamViec=@iNamLamViec {0} {1} {2}
...
ORDER BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,sTenPB"
 , "", DKPhongBan, DKDonVi, DVT, sTenB10,sTenB6,sTenB);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1020000_TongHop(MaND, iID_MaPhongBan);
