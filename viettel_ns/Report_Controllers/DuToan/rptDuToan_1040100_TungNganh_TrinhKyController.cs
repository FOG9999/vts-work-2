...
{
    public class rptDuToan_1040100_TungNganh_TrinhKyController : FlexcelReportController
    {
        private readonly INganSachService _nganSachService;

        public rptDuToan_1040100_TungNganh_TrinhKyController()
        {
            _nganSachService = NganSachService.Default;
        }

        //
        // GET: /rptDuToan_1040100_TungNganh_TrinhKy/
        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath1 = "/Report_ExcelFrom/DuToan/rptDuToan_1040100_TungNganh_1.xls";
        private const String sFilePath2 = "/Report_ExcelFrom/DuToan/rptDuToan_1040100_TungNganh_2.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1040100_TungNganh_TrinhKy.aspx";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaChungTu)
        {
        ...
        //    fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1040100_TungNganh_TrinhKy",MaND);
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string Nganh, string ToSo, string sLNS, string iID_MaPhongBan, String iID_MaChungTu, string ext)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string Nganh, string ToSo, string sLNS, string iID_MaPhongBan)
        {
            HamChung.Language();
        ...
        public dataDuLieu1 get_dtDuToan_1050000(String MaND, String Nganh, String ToSo, String sLNS, String iID_MaPhongBan)
        {
            ...
            if (String.IsNullOrEmpty(iID_MaNganhMLNS)) 
                DSNganh = _nganSachService.ChuyenNganh_GetAll(PhienLamViec.iNamLamViec,MaND).AsEnumerable().Select(r => r.Field<string>("sNG")).JoinDistinct();
            String SQLNganh = "SELECT distinct sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa";
            SQLNganh += ",sM +'.'+ sTM +'.'+ sTTM +'.'+ sNG AS NG";
            SQLNganh += " FROM DT_ChungTuChiTiet_PhanCap WHERE sLNS='1020100' AND iID_MaChungTu IN (SELECT iID_MaChungTuChiTiet FROM DT_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu)  AND MaLoai<>'1' AND MaLoai <>'3' {1} AND iTrangThai=1 {2}  {0} {3}";

            SQLNganh += " UNION SELECT distinct sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa";
            SQLNganh += ",sM +'.'+ sTM +'.'+ sTTM +'.'+ sNG AS NG";
            SQLNganh += " FROM DT_ChungTuChiTiet WHERE sLNS=1040100 AND iKyThuat=1 AND iID_MaChungTu IN (SELECT iID_MaChungTuChiTiet FROM DT_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu)  AND MaLoai=1 {1} AND iTrangThai=1 {2}  {0}  {3} ORDER BY sM,sTM,sTTM,sNG";
            ...
            cmdNG.Parameters.AddWithValue("@iID_MaChungTu", iID_MaChungTu);
            ...
            SQL += " FROM DT_ChungTuChiTiet_PhanCap WHERE sNG = '24' and sLNS='1020100' AND MaLoai<>'1' AND iID_MaChungTu IN (SELECT iID_MaChungTuChiTiet FROM DT_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu)  AND MaLoai <>'3' {1}      AND iTrangThai=1 {2}   {0} {4}";
            ...
            SQL += ",SUM(rTuChi/{3}) AS rTuChi";
            SQL += ",SUM(rHienVat/{3}) AS rHienVat";
            SQL += " FROM DT_ChungTuChiTiet WHERE sNG = '24' and sLNS='1040100' AND iKyThuat=1   AND MaLoai=1 {1}  AND iID_MaChungTu IN (SELECT iID_MaChungTuChiTiet FROM DT_ChungTuChiTiet WHERE iID_MaChungTu=@iID_MaChungTu)  AND iTrangThai=1 {2}   {0} {4} ";
            SQL += " GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,iID_MaDonVi,sMoTa";
            SQL += " HAVING SUM(rTuChi)<>0 OR SUM(rHienVat)<>0";
        ...
        public JsonResult Ds_DonVi(String ParentID, String Nganh, String ToSo, String sLNS, String iID_MaPhongBan, String iID_MaChungTu)
        {
            this.iID_MaChungTu = iID_MaChungTu;
        ...
        public DataTable DanhSachToIn(String MaND, String Nganh, String ToSo, String sLNS, String iID_MaPhongBan)
        {
            _data = get_dtDuToan_1050000(MaND, Nganh, ToSo, sLNS, iID_MaPhongBan);
