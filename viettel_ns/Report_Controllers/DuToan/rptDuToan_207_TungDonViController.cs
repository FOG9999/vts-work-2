...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_207_TungDonViController : AppController
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, string iID_MaDonVi, int trinhky = 0)
        {
            ViewData["PageLoad"] = "1";
            ViewData["trinhky"] = trinhky;
...
", DSNganh, DKPhongBan, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaDonVi, int trinhky = 0)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaDonVi, int trinhky = 0)
        {
            HamChung.Language();
