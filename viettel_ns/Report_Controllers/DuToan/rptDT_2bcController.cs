...
{
    public class rptDT_2bcController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptDT_2bc/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID)
        {
            ...
            string filename = "";
            var myFile = HttpContextHelper.Current.Request.Files["uploadFile"];
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
