...
{
    public class rptDuToan_InBiaController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Thương
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NgayGui, String iID_MaDonVi)
        {
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), NgayGui, iID_MaDonVi);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
            {
