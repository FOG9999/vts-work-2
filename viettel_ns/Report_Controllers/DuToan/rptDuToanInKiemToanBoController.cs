...
{
    public class rptDuToanInKiemToanBoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
        ...
        /// <returns></returns>
        /// VungNV: add new params MaPhongBan
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaDonVi, String sLNS, String sL, String sK, String sM,String sTTM,String sNG,String MaPhongBan)
        {
            HamChung.Language();
            String sDuongDan = "";
            sDuongDan = sFilePath;
