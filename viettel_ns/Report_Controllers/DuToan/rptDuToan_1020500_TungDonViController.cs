...
{
    public class rptDuToan_1020500_TungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020500_TungDonVi.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020500_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1020500_TungDonVi");
            fr.SetValue("Nam", iNamLamViec);
            fr.SetValue("sTenDonVi", sTenDonVi);
            fr.SetValue("Cap1", ReportModels.CauHinhTenDonViSuDung(1,MaND));
            fr.SetValue("Ngay", ReportModels.Ngay_Thang_Nam_HienTai());

            var loaiKhoan = HamChung.GetLoaiKhoanText("1020500");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1020500_TungDonVi(String MaND,String iID_MaDonVi)
        {
...
,rChiTapTrung=SUM(rChiTapTrung/{3})
 ...
 WHERE iTrangThai in (1,2)  AND sLNS='1020500' AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi", iID_MaDonVi,DKPhongBan,DKDonVi,DVT);
        ...
        public static DataTable DT_rptDuToan_1020500_TungDonVi_GhiChu(String MaND, String iID_MaDonVi)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
            ...
            int DVT = 1000;
            String SQL = String.Format(@"SELECT sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi
,SUM(rTuChi/{3}) as rTuChi,sGhiChu
 FROM DT_ChungTuChiTiet
 WHERE iTrangThai in (1,2)  AND sLNS='1020500' AND iID_MaDonVi =@iID_MaDonVi AND iNamLamViec=@iNamLamViec {1} {2}
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi,sGhiChu", iID_MaDonVi, DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1020500_TungDonVi(MaND, iID_MaDonVi);
            DataTable dataGhiChu = DT_rptDuToan_1020500_TungDonVi_GhiChu(MaND, iID_MaDonVi);
        ...
        public clsExcelResult ExportToExcel(String MaND, String iID_MaDonVi)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "DuToan_1020500_TungDonVi.xls";
                clsResult.type = "xls";
                return clsResult;
            }
