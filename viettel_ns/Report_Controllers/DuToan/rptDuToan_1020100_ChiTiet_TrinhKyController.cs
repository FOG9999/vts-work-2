...
{
    public class rptDuToan_1020100_ChiTiet_TrinhKyController : AppController
    {
        private readonly INganSachService _nganSachService = NganSachService.Default;

        public string sViewPath = "~/Report_Views/DuToan/";
        private String sFilePath = "/Report_ExcelFrom/DuToan/TrinhKy/rptDuToan_1020100_ChiTiet_TrinhKy.xls";
        ...
        /// <returns></returns>
        /// 
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaChungTu)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaChungTu)
        {
            HamChung.Language();
            var xls = createReport(iID_MaChungTu);
        ...
        private DataTable DT_rptDuToan_1020100_ChiTiet_TrinhKy(string iID_MaChungTu, int dvt = 1000)
        {
            #region sql

            var sql =
@"SELECT    sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sGhiChu,
            rTuChi      =SUM(rTuChi/{0}),
    ...
    GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sGhiChu
    HAVING  SUM(rTuChi)<>0 OR 
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1020100_ChiTiet_TrinhKy(iID_MaChungTu, dvt);
            ...
            {
                fr.SetValue("sTenDonVi", DonViModels.Get_TenDonVi(data.Rows[0]["iID_MaDonVi"].ToString(), Username));
            } else
            {
