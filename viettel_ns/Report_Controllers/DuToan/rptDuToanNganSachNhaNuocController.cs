...
{
    public class rptDuToanNganSachNhaNuocController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String sLNS)
        {
        ...
        /// <param name="sLNS"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String sLNS, String MaND, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), sLNS, MaND, iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
