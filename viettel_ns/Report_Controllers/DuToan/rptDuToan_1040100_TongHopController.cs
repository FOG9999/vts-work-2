...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1040100_TongHopController : AppController
    {
        ...
        String iCapTongHop = "";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(int trinhky = 1)
        {
...
//            DataTable dtPhanCap = Connection.GetDataTable(cmd);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(string iID_MaPhongBan, string iCapTongHop, int trinhky = 0)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(string iID_MaPhongBan, string iCapTongHop, int trinhky = 0)
        {
            HamChung.Language();
