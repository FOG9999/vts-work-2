...
{
    public class rptDuToan_TongHop_2Controller : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_TongHop_2.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_TongHop_2.aspx";
            ViewData["PageLoad"] = "0";
...
,rChiTapChung=SUM(CASE WHEN iID_MaPhongBan IN ('07','10') AND sLNS IN ('1010000','1020000','1020100')THEN (rChiTapTrung)/{2} ELSE 0 END)
 ...
 WHERE iTrangThai=1  AND (sLNS LIKE '2%' OR sLNS LIKE '3%')  AND iNamLamViec=@iNamLamViec  AND MaLoai<>1 {0} {1} -- AND iID_MaDonVi NOT IN ('03','75')
...
,rChiTapChung=SUM(CASE WHEN iID_MaPhongBanDich IN ('07','10') AND sLNS IN ('1010000','1020000','1020100')THEN (rChiTapTrung)/{2} ELSE 0 END)
 ...
 WHERE iTrangThai=1  AND (sLNS LIKE '2%' OR sLNS LIKE '3%')   AND iNamLamViec=@iNamLamViec {0} {1} --AND iID_MaDonVi NOT IN ('03','75') 
 GROUP BY iID_MaDonVi,sTenDonVi
HAVING SUM(rTuChi/{2})+SUM(rDuPhong/{2})+SUM(rHangMua/{2})+SUM(rHangNhap/{2}) <>0 OR SUM(rChiTapTrung/{2})<>0
