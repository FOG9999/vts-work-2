...
{
    public class rptPhanBoDuToanNganSachNamController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptPhanBoDuToanNganSachNam_Old(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            if (MaND == "trolyphongban")
            {
                //DKDonVi = "";
            }
            else
...
,COT11=0
  ...
  UNION
  SELECT iID_MaDonVi,Loai=N'I. Phân cấp cho đơn vị'
  ,COT1=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6600 AND stm=6612 THEN rTuChi+rHangMua ELSE 0 END) 
,COT2=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6600 AND stm=6649 AND sTTM IN(10,20) THEN rTuChi+rHangMua ELSE 0 END) 
,COT3=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=7750 AND stm=7799 AND sTTM=10 AND sNG=22 THEN rTuChi+rHangMua ELSE 0 END)
,COT4=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6200  THEN rTuChi+rHangMua ELSE 0 END) 
,COT5=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6250 THEN rTuChi+rHangMua ELSE 0 END) 
,COT6=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6700 THEN rTuChi+rHangMua ELSE 0 END) 
,COT7=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6900 AND stm=6905 AND sTTM=00 AND sNG=65 THEN rTuChi+rHangMua ELSE 0 END) 
,COT8=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6500 AND stm IN (6501,6502) AND sTTM=00 AND sNG=56 THEN rTuChi+rHangMua ELSE 0 END) 
,COT9=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6900 AND stm=6907 AND sTTM=00 AND sNG=56  THEN rTuChi+rHangMua ELSE 0 END) 
,COT10=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=7000 AND stm=7001 AND sTTM IN(20,30) THEN rTuChi+rHangMua ELSE 0 END)
,COT11=0
...
", DK, DKPhongBan, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptPhanBoDuToanNganSachNam_New(String MaND, String iID_MaPhongBan)
        {
            String DKDonVi = "", DKPhongBan = "", DK = "";
            SqlCommand cmd = new SqlCommand();
            if (MaND == "trolyphongban")
...
,COT11=0
  ...
  UNION
  SELECT iID_MaDonVi,Loai=N'I. Phân cấp cho đơn vị'
  ,COT1=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6600 AND stm=6608 THEN rTuChi+rHangMua ELSE 0 END) 
,COT2=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6600 AND stm=6649 AND sTTM IN(10,20) THEN rTuChi+rHangMua ELSE 0 END) 
,COT3=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=7750 AND stm=7799 AND sTTM=10 AND sNG=22 THEN rTuChi+rHangMua ELSE 0 END)
,COT4=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6200  THEN rTuChi+rHangMua ELSE 0 END) 
,COT5=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6250 THEN rTuChi+rHangMua ELSE 0 END) 
,COT6=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6700 THEN rTuChi+rHangMua ELSE 0 END) 
,COT7=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6900 AND stm=6905 AND sTTM IN (10,20,30,40) AND sNG=65 THEN rTuChi+rHangMua ELSE 0 END) 
,COT8=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6500 AND stm IN (6501,6502) AND sTTM=00 AND sNG=56 THEN rTuChi+rHangMua ELSE 0 END) 
,COT9=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=6900 AND stm=6907 AND sTTM=00 AND sNG=56  THEN rTuChi+rHangMua ELSE 0 END) 
,COT10=SUM(CASE WHEN (sLNS=1020000 OR sLNS=1020100) AND sM=7000 AND stm=7001 AND sTTM IN(20,30) THEN rTuChi+rHangMua ELSE 0 END)
,COT11=0
...
", DK, DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(HttpContextHelper.Current.User.Identity.Name);
            int iNamLamViec = Convert.ToInt32(dtCauHinh.Rows[0]["iNamLamViec"]);
            DataTable data;
            if (iNamLamViec < 2018)
            {
                data = DT_rptPhanBoDuToanNganSachNam_Old(MaND, iID_MaPhongBan);
            }
            else
            {
                data = DT_rptPhanBoDuToanNganSachNam_New(MaND, iID_MaPhongBan);
            }
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaPhongBan);
