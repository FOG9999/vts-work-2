...
{
    public class rptDuToan_TongHop_KiemKhoBacController : Microsoft.AspNetCore.Mvc.Controller
    {
...
", DKPhongBan, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND,String iID_MaPhongBan,String iID_MaNguon,String iID_Muc)
        {
            HamChung.Language();
            this.iID_MaPhongBan = iID_MaPhongBan;
            this.iID_MaNguon = iID_MaNguon;
