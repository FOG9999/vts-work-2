...
{
    public class rptDuToan_BieuKiem_1010000Controller : Microsoft.AspNetCore.Mvc.Controller
    {
...
{1}
 ...
 GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,iID_MaDonVi,sTenDonVi {2}", iID_MaDonVi, DKSELECT,DKHAVING);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaDonVi, String MaChungTu, String KieuXem, String DonViTinh)
        {
            HamChung.Language();
            iID_MaDonVi = MaDonVi;
            iID_MaChungTu = MaChungTu;
