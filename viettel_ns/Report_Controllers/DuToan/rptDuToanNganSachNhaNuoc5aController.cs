...
{
    public class rptDuToanNganSachNhaNuoc5aController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public static DataTable DT_DuToanNganSachNhaNuoc5a(String MaND, String sNG, String sLNS,String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL =String.Format(@"SELECT sLNS,sM,sL,sK,sTM,sTTM,sNG,sMoTa
                                    ...
                                    {0}
                                    AND sLNS=@sLNS
                                    AND sNG IN (SELECT iID_MaNganhMLNS FROM NS_MucLucNganSach_Nganh WHERE iTrangThai=1 AND iNamLamViec=@iNamLamViec AND iID_MaNganh=@Nganh) 
                                    {1}
        ...
        /// <param name="sNG"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String sNG, String sLNS, String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), sNG, sLNS, iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
