...
{
    public class rtCongKhaiPhanBoVonDauTuCongTrinhPhoThongController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public ExcelFile CreateReport(String path, String iID_MaTrangThaiDuyet)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rtCongKhaiPhanBoVonDauTuCongTrinhPhoThong");
        ...
        public  DataTable CongKhaiPhanBoVonDauTu_CongTrinhPhoThong(String MaND,String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = string.Format(@"SELECT dbo.NS_MucLucDuAn.sMaCongTrinh
                                        ...
                                        WHERE  ChiTiet.iTrangThai = 1 {0} {1} AND LoaiDuAn.sTenKhoa!='01'
