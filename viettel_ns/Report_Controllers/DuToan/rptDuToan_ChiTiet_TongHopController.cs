...
{
    public class rptDuToan_ChiTiet_TongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
...
ORDER BY Cap1,Cap2,Cap3,Cap4,Cap5,Cap6,iID_MaPhongBan,sLNS", DK, DKBaoDam, DKDonVi, DVT);
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaPhongBan, String iCapTongHop, String iID_MaDonVi)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaND, iID_MaPhongBan, iCapTongHop, iID_MaDonVi);
