...
{
    public class rptDuToan_1020100_Tach_TungDonViKiemController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private  String sFilePath = "/Report_ExcelFrom/DuToan/BieuKiem/rptDuToan_1020100_Tach_TungDonViKiem.xls";
        String iCapTongHop = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if(HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath,User.Identity.Name))
            {
            ViewData["path"] = "~/Report_Views/DuToan/BieuKiem/rptDuToan_1020100_Tach_TungDonViKiem.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public clsExcelResult ExportToExcel(String MaND, String iID_MaDonVi,String iCapTongHop)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "DuToan_1020100_Tach_TungDonVi.xls";
                clsResult.type = "xls";
                return clsResult;
            }
