...
{
    public class rptDuToan_1020100_ML_TungDonViKiemController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private  String sFilePath = "/Report_ExcelFrom/DuToan/BieuKiem/rptDuToan_1020100_ML_TungDonViKiem.xls";
        String iCapTongHop = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if(HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath,User.Identity.Name))
            {
            ViewData["path"] = "~/Report_Views/DuToan/BieuKiem/rptDuToan_1020100_ML_TungDonViKiem.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public  DataTable DT_rptDuToan_1020100_TungDonVi(String MaND,String iID_MaDonVi)
        {
            ...
            var sql = FileHelpers.GetSqlQuery("rptDuToan_1020100_TungDonViKiem.sql");            
        ...
        public clsExcelResult ExportToExcel(String MaND, String iID_MaDonVi,String iCapTongHop)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                ms.Position = 0;
                clsResult.ms = ms;
                clsResult.FileName = "DuToan_1020100_Kiem_TungDonVi.xls";
                clsResult.type = "xls";
                return clsResult;
            }
