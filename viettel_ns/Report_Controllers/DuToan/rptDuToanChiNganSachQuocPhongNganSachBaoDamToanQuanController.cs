...
{
    public class rptDuToanChiNganSachQuocPhongNganSachBaoDamToanQuanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public DataTable DT_DuToanChiNganSachQuocPhong(String iID_MaTrangThaiDuyet, String sNG,String MaND)
        {
            ...
            SQL += " iTrangThai=1   {0} {1} and sNG IN (SELECT iID_MaNganhMLNS FROM NS_MucLucNganSach_Nganh WHERE iTrangThai=1 AND iNamLamViec=@iNamLamViec AND iID_MaNganh=@Nganh)";
        ...
        /// <param name="sNG"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaTrangThaiDuyet, String sNG)
        {
            HamChung.Language();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DanhSach()
        {
            return View(sViewPath + "ReportList.aspx");
        }

        public Microsoft.AspNetCore.Mvc.ActionResult XDCB()
        {
