...
{
    public class rptDuToanChiNganSachSuDungPhanCacNganhCapController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public static DataTable DT_DuToanPhanCacNganhPhanCap(String MaND,String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = String.Format(@"SELECT *
                                        ...
                                        WHERE iTrangThai=1 {0} AND sLNS IN('1020000','1020700') {1}
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ExportToPDF(String iID_MaTrangThaiDuyet)
        {
            HamChung.Language();
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaTrangThaiDuyet)
        {            
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaTrangThaiDuyet);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
