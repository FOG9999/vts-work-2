...
{
    public class rptDuToan_1030100_TongHop_CTPTController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1030100_TongHop_CTPT.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1030100_TongHop_CTPT.aspx";
            ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaPhongBan)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToan_1030100_TongHop_CTPT");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public static DataTable DT_rptDuToan_1030100_TongHop_CTPT(String MaND,String iID_MaPhongBan)
        {
...
WHERE iID_MaLoaiDanhMuc='bc5f9bb8-1dba-40fc-95b6-1098e5b0e68f'
AND iTrangThai=1");
            ...
            {
                if ( Convert.ToString(dtDanhMuc.Rows[i]["sTenKhoa"]) == "10")
                    sTenB10 = Convert.ToString(dtDanhMuc.Rows[i]["sGhiChu"]);
                if (Convert.ToString(dtDanhMuc.Rows[i]["sTenKhoa"]) == "06")
                    sTenB6 = Convert.ToString(dtDanhMuc.Rows[i]["sGhiChu"]);
                if (Convert.ToString(dtDanhMuc.Rows[i]["sTenKhoa"]) == "07")
                    sTenB = Convert.ToString(dtDanhMuc.Rows[i]["sGhiChu"]);
            }
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai=1  AND sLNS LIKE '1030100%'  AND SUBSTRING(sMaCongTrinh,5,1)=2 AND iNamLamViec=@iNamLamViec {0} {1} {2}
...
ORDER BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa,sTenPB"
 , "", DKPhongBan, DKDonVi, DVT, sTenB10,sTenB6,sTenB);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToan_1030100_TongHop_CTPT(MaND, iID_MaPhongBan);
