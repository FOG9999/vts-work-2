...
{
    public class rptGia_7cController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptGia_7c/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/GIA/rptGia_7c.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/GIA/rptGia_7c.aspx";
        ...
        public ExcelFile CreateReport(String path, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptGia_7c");

            LoadData(fr, iID_MaDonVi, iID_MaTrangThaiDuyet, NamLamViec);
            fr.SetValue("PhuLuc", "Biểu 7c");
            fr.SetValue("Ngay", NgayThang);
            fr.SetValue("Nam", NamLamViec);
            String MaND = User.Identity.Name;
            fr.SetValue("TenDonVi", ReportModels.CauHinhTenDonViSuDung(2,MaND));
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public DataTable rptGia_7c(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            String SQL = string.Format(@"SELECT iID_MaChiTietGia,iID_MaSanPham,iID_MaLoaiHinh,iID_MaDonVi
                                            ...
                                            ,(SELECT TOP 1 tbl2.rTien_DatHang_DeNghi FROM DM_SanPham_DanhMucGia AS tbl2 
                                            WHERE tbl2.iID_MaChiTietGia = tbl0.iID_MaChiTietGia AND LTRIM(RTRIM(sKyHieu)) = '10') AS TienDHDeNghi
                                            ,(SELECT TOP 1 tbl2.rTien_CTC_DeNghi FROM DM_SanPham_DanhMucGia AS tbl2 
                                            WHERE tbl2.iID_MaChiTietGia = tbl0.iID_MaChiTietGia AND LTRIM(RTRIM(sKyHieu)) = '10') AS TienCTCDeNghi
                                        FROM DM_SanPham_ChiTietGia AS tbl0 WHERE tbl0.iTrangThai = 1 AND tbl0.iID_LoaiDonVi = 3
                                        AND YEAR(tbl0.dNgayTao) = @NamLamViec
        ...
        private void LoadData(FlexCelReport fr, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            DataTable data = rptGia_7c(iID_MaDonVi, iID_MaTrangThaiDuyet, NamLamViec);
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaDonVi, iID_MaTrangThaiDuyet, NamLamViec);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
