...
{
    public class rptGia_4Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptGia_4/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/GIA/rptGia_4.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/GIA/rptGia_4.aspx";
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public DataTable rptGia_4(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
        ...
        private void LoadData(FlexCelReport fr, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ...
            DataTable data = rptGia_4(iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
