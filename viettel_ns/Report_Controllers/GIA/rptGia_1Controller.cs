...
{
    public class rptGia_1Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptGia_1C/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/GIA/rptGia_1.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/GIA/rptGia_1.aspx";
        ...
        public ExcelFile CreateReport(String path,  String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptGia_1b");
            LoadData(fr, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
            fr.SetValue("PhuLuc", "Biểu số 1");
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public DataTable rptGia_1b(String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ...
            String SQL = string.Format(@"SELECT iSTT,DMSP.iID_MaSanPham,sKyHieu,DMSP.sTen
                                        ...
                                        ,SUM(rSoLuong_DatHang_DeNghi) as SLDatHangDeNghi
                                        ,SUM(rDonGia_DatHang_DeNghi) as DGDatHangDeNghi
                                        ,SUM(rTien_DatHang_DeNghi) as TienDatHangDeNghi

                                        ,SUM(rSoLuong_CTC_DeNghi) as SLCTCDeNghi
                                        ,SUM(rDonGia_CTC_DeNghi) as DGCTCDeNghi
                                        ...
                                        GROUP BY iSTT,DMSP.iID_MaSanPham,sKyHieu,DMSP.sTen,DMSP.iDM_MaDonViTinh,rSosanh
                                        ORDER BY iSTT");
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF( String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
