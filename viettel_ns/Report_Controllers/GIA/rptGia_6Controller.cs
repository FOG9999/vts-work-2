...
{
    public class rptGia_6Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptGia_6/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/GIA/rptGia_6.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/GIA/rptGia_6.aspx";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult List(String ParentID)
        {
            ViewData["Controller"] = "rptGia_6";
            ViewData["iID_LoaiDonVi"] = 3;
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            String iID_MaDonVi = Convert.ToString(Request.Form[ParentID + "_iID_MaDonVi"]);
            String iID_MaTrangThaiDuyet = Convert.ToString(Request.Form[ParentID + "_iID_MaTrangThaiDuyet"]);
            return RedirectToAction("Index", new { iID_MaDonVi = iID_MaDonVi, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, iID_MaSanPham = iID_MaSanPham, iID_MaChiTietGia = iID_MaChiTietGia });
        }
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public DataTable rptGia_6(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ...
            String SQL = string.Format(@"SELECT iID_MaDanhMucGia, iID_MaDanhMucGia_Cha, sKyHieu,sTen
                                        ...
                                        ,rTien_DatHang_DeNghi AS TienDHDeNghi
                                        ,rTien_CTC_DeNghi AS TienCTCDeNghi
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                if (iID_MaDanhMucGia_Cha != "0")
                {
                    String query = String.Format((@"SELECT CONVERT(nvarchar(25),N'Trong đó: NSQP bảo đảm') AS sTen
                                                ...
                                                ,SUM(rTien_CTC_DeNghi) AS TienCTCDeNghi
                                                FROM DM_SanPham_DanhMucGia
        ...
        public DataTable SanPham(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            DataTable dt = new DataTable();
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <param name="iID_MaTrangThaiDuyet"></param>
        private void LoadData(FlexCelReport fr, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            if (String.IsNullOrEmpty(iID_MaDonVi))
            {
                iID_MaDonVi = Guid.Empty.ToString();
            }
            DataTable data = rptGia_6(iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
            data.TableName = "ChiTiet";
            fr.AddTable("ChiTiet", data);
            data.Dispose();
            DataTable dtSP = SanPham(iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public clsExcelResult ExportToPDF(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            clsExcelResult clsResult = new clsExcelResult();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public clsExcelResult ExportToExcel(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            clsExcelResult clsResult = new clsExcelResult();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String iID_MaSanPham, String iID_MaChiTietGia)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaDonVi, iID_MaTrangThaiDuyet, iID_MaSanPham, iID_MaChiTietGia);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
