...
{
    public class rptGia_7bController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptGia_7b/

        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/GIA/rptGia_7b.xls";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/GIA/rptGia_7b.aspx";
        ...
        public ExcelFile CreateReport(String path, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptGia_7b");

            LoadData(fr, iID_MaDonVi, iID_MaTrangThaiDuyet, NamLamViec);
            fr.SetValue("PhuLuc", "Biểu 7b");
        ...
        /// <param name="iID_MaTrangThaiDuyet"></param>
        /// <returns></returns>
        public DataTable rptGia_7b(String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            String SQL = string.Format(@"SELECT iID_MaChiTietGia,iID_MaSanPham,iID_MaLoaiHinh,iID_MaDonVi
                                        ...
                                        FROM DM_SanPham_ChiTietGia AS tbl0 WHERE tbl0.iTrangThai = 1 AND tbl0.iID_LoaiDonVi = 2
        ...
        private void LoadData(FlexCelReport fr, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String NamLamViec)
        {
            ...
            DataTable data = rptGia_7b(iID_MaDonVi, iID_MaTrangThaiDuyet, NamLamViec);
