...
{
    public class rptThongBaoChiTieuNganSachNamTheoLNSvaDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptTongHopNganSachNamTheoLNSvaDonVi/
        public string sViewPath = "~/Report_Views/DuToan/";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String KieuTrang="")
        {
            String sFilePath = "";
            if (KieuTrang == "1")
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaTrangThaiDuyet, String sLNS, String iID_MaDonVi, String KieuTrang, String Kieuin)
        {
            HamChung.Language();
            String sFilePath = "";
            if (KieuTrang == "1")
