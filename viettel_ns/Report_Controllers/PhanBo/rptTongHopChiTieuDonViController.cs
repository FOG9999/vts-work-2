...
{
    public class rptTongHopChiTieuDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        
          public string sViewPath = "~/Report_Views/";
          private const String sFilePath_A4_1 = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A4_1.xls";
          private const String sFilePath_A4_2 = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A4_2.xls";
          private const String sFilePath_A3_1 = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A3_1.xls";
          private const String sFilePath_A3_2 = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A3_2.xls";

          private const String sFilePath_A4_1_RG = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A4_1_RG.xls";
          private const String sFilePath_A4_2_RG = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A4_2_RG.xls";
          private const String sFilePath_A3_1_RG = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A3_1_RG.xls";
          private const String sFilePath_A3_2_RG = "/Report_ExcelFrom/PhanBo/rptTH_CTDonVi_A3_2_RG.xls";
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["path"] = "~/Report_Views/PhanBo/rptTongHopChiTieuDonVi.aspx";
                ViewData["PageLoad"] = "0";
        ...
        /// <param name="TruongTien"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND,String sLNS,String iID_MaDotPhanBo,String iID_MaTrangThaiDuyet,String TruongTien,String KhoGiay,String LuyKe,String ToSo)
        {
            HamChung.Language();
            String DuongDan = "";
            if (LuyKe != "on")
        ...
        public static DataTable LayDotPhanBo(String MaND, String sLNS, String TruongTien, String iID_MaTrangThaiDuyet)
        {
            ...
            String SQL = string.Format(@"SELECT DPB.iID_MaDotPhanBo,CONVERT(nvarchar,dNgayDotPhanBo,103) as dNgayDotPhanBo
                                        ...
                                        WHERE PB.iTrangThai=1 AND sLNS=@sLNS {0} {1} {2}
                                        GROUP BY DPB.iID_MaDotPhanBo,dNgayDotPhanBo
                                        ORDER BY MONTH(dNgayDotPhanBo),DAY(dNgayDotPhanBo)", TruongTien,DK_Duyet,ReportModels.DieuKien_NganSach(MaND,"PB"));
            SqlCommand cmd = new SqlCommand(SQL);
