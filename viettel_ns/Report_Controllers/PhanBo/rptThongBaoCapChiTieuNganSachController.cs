...
{
    public class rptThongBaoCapChiTieuNganSachController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThongBaoCapChiTieuNganSach/
        public string sViewPath = "~/Report_Views/";
        public static String NameFile = "";
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String KieuTrang = "", String Muc = "")
        {
            String sFilePath = "";
            if (KieuTrang == "1")
            {
        ...
        /// <param name="iID_MaDotPhanBo"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaDotPhanBo, String iID_MaDonVi, String iID_MaTrangThaiDuyet, String ThongBao, String Muc, String KieuTrang)
        {
            HamChung.Language();
            String sFilePath = "";
            if (KieuTrang == "1")
