...
{
    public class rptBH_Chi_74_4Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptBH_Chi_74_4/
...
GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG,sMoTa,bLaHangCha", iID_MaTrangThaiDuyet, ReportModels.DieuKien_NganSach(MaND), DKDonvi);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iID_MaDonVi, String LoaiBieu, String iID_MaTrangThaiDuyet, String BoDongTrong, String KhoGiay)
        {
            String sFilePath = "";
            if (KhoGiay == "1")
            {
