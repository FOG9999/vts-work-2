...
{
    public class rptBH_Chi_73_3Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptBH_Chi_73_3/
        ...
        public ExcelFile CreateReport(String path, String MaND, String ThangQuy, String LoaiThangQuy, String iID_MaTrangThaiDuyet, String TruongTien, String KhoGiay, String ToSo, String RutGon)
        {
            ...
            fr.SetValue("BLT", ReportModels.CauHinhTenDonViSuDung(1,MaND));
        ...
        /// <param name="TruongTien"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String ThangQuy, String LoaiThangQuy, String iID_MaTrangThaiDuyet, String TruongTien, String KhoGiay, String ToSo, String RutGon)
        {
            HamChung.Language();
            String DuongDan = "";
            if (RutGon == "on")
