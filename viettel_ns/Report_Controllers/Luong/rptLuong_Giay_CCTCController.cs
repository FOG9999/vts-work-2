...
{
    public class rptLuong_Giay_CCTCController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Thương
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamLuong, String ThangLuong, String DonVi, String MaCB, String Duyet, String KhoGiay)
        {
            HamChung.Language();
            String sFilePath = "";
            switch (KhoGiay)
