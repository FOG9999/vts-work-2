...
{
    public class rptLuong_DanhSachCaNhan_NguoiPhuThuocController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <param name="Nam"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaBL)
        {
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), MaBL);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
            {
