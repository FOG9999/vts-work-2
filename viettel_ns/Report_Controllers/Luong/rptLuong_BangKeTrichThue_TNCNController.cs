...
{
    public class rptLuong_BangKeTrichThue_TNCNController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="Nam"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String Thang, String Nam, String TrangThai,String isALLDonVi,String KhoGiay,String isGroup)
        {
            HamChung.Language();
            String sFilePath = "";
            switch(KhoGiay)
