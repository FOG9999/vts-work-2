...
{
    public class rptLuong_DSCaNhan_NopThueDauVaoController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Le Van Thuong
        ...
        /// <param name="MaDV"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iMaBL)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iMaBL);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
