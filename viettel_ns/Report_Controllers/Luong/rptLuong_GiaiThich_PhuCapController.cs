...
{
    public class rptLuong_GiaiThich_PhuCapController : Microsoft.AspNetCore.Mvc.Controller
    {
        // create: Thương
        ...
        /// <param name="iReport">Loại báo cáo</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iThang, String iNam, String iTrangThai,String iReport)
        {
            HamChung.Language();
