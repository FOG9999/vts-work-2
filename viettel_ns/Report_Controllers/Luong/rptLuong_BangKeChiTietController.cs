...
{
    public class rptLuong_BangKeChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Thương
        ...
        /// <param name="Duyet">Trạng thái duyệt</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String TuThang, String DenThang, String Duyet)
        {
            HamChung.Language();            
