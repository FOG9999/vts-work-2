...
{
    public class rptLuong_DSCaNhan_CoThuLao_ThuongController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Le Van Thuong
        ...
        /// <param name="MaDV"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaBangLuong)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iID_MaBangLuong);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
