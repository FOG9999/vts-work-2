...
{
    public class rptLuong_TongHopThuThueDauVaoController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Le Van Thuong
        ...
        /// <param name="DenThang"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String TuThang, String DenThang, String NamLuong, String TrangThai)
        {
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), TuThang, DenThang,NamLuong,TrangThai);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
            {
