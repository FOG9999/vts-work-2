...
{
    public class rptDuToanBS_TongHop_ChonToController : Microsoft.AspNetCore.Mvc.Controller
    {

        public string sViewPath = "~/Report_Views/DuToan/";
        private const String sFilePath = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_TongHop_ChonTo.xls";
        private const String sFilePath_to2 = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_TongHop_ChonTo_To2.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToanBS/rptDuToanBS_TongHop_ChonTo.aspx";
                ViewData["PageLoad"] = "0";
      ...
      [Authorize]
        ...
        public ExcelFile CreateReport(String path, String MaND,String sLNS,String MaTo)
        {
            ...
            DataTable dtDonVi = DuToanBS_ReportModels.dtDonVi(MaND, "ALL");
            //Lay ten don vi
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToanBS_TongHop_ChonTo",MaND);
        ...
        /// <returns></returns>
         [Authorize]
        public static DataTable DT_rptDuToanBS_TongHop_ChonTo(String MaND, String sLNS, String MaTo)
        {
            MaTo = "1";
...
", DK, DKDonVi, DKPhongBan, DKCASEDonVi, DKSUMDonVi, DKHAVINGDonVi,DuToan_ReportModels.DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToanBS_TongHop_ChonTo(MaND, sLNS, MaTo);
        ...
        /// 
         [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String sLNS, String MaTo)
        {
            HamChung.Language();
            String DuongDan = "";
            if (MaTo == "1")
         ...
         public JsonResult LayDanhSachDot(String ParentID, String iID_MaDot, String iID_MaPhongBan, String iID_MaTo)
         {
             String MaND = User.Identity.Name;
             String ViewNam = "~/Views/DungChung/DonVi/To_DanhSach.ascx";

             DataTable dt =   DuToanBS_ReportModels.dtTo(MaND, "ALL");
             DanhSachDonViModels Model = new DanhSachDonViModels(MaND, iID_MaTo, dt, ParentID);
