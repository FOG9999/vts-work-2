...
{
    public class rptDuToanBS_BieuKiem_1010000Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaDonVi, String MaChungTu, String KieuXem, String DonViTinh,String ChiTapTrung)
        {
            HamChung.Language();
            idMaDonVi = MaDonVi;
            idMaChungTu = MaChungTu;
