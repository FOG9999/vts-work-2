...
{
    public class rptTCDN_BaoCaoChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
...
SELECT sKyHieu
 FROM TCDN_ChiTieu
  ...
  WHERE iTrangThai=1 AND sKyHieu=@sKyHieu AND bLaTong=1)
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String MaND, String iQuy, String bTrongKy, String iID_MaDoanhNghiep, String iLoai, String DVT)
        {
            HamChung.Language();
            String sDuongDan = "";
            if (iLoai == "0")
