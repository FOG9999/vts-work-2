...
{
    public class rptTCDN_BaoCaoTongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iNamLamViec, String iQuy, String iID_MaLoaiDoanhNghiep)
        {
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iNamLamViec, String iQuy, String iID_MaLoaiDoanhNghiep)
        {
            HamChung.Language();
            String xfilePath = sFilePath;
            if (iQuy == "4") xfilePath = sFilePath1;
