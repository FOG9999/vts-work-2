...
{
    public class rptTCDN_BangCanDoiKeToan_B01DNController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iQuy, String iNam, String iMaDN)
        {
            HamChung.Language();            
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), iQuy, iNam, iMaDN);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
