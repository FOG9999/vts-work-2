...
{
    public class rptTCDN_BaoCaoTaiChinhQuyController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptDT_2bc/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Reports(String iNam, String iQuy)
        {
            ViewData["PageLoad"] = "1";
...
rDaNop_TienThueDat<>0 OR rConPhaiNop_TienThueDat<>0 OR rTongSoConPhaiNop<>0 OR rTongSoDaNop<>0)
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamLamViec,String Quy, String To)
        {
            String xfilePath = "/Report_ExcelFrom/TCDN/rptTCDN_BaoCaoTaiChinhQuy" + To + ".xls";
            ExcelFile xls = CreateReport(Server.MapPath(xfilePath), NamLamViec, Quy);
