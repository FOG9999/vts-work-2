...
{
    public class rptTCDN_BC_ChiTieuTaiChinh_QuyNam_02Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        // Edit: Thương
        ...
        /// <param name="iMaDN">Mã doanh nghiệp</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iQuy, String iNam, String iAll, String iMaDN)
        {
            HamChung.Language();
