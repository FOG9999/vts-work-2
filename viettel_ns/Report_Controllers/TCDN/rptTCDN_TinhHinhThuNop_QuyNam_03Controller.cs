...
{
    public class rptTCDN_TinhHinhThuNop_QuyNam_03Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        // Created: Thương 
        ...
        /// <param name="iMaDN">Mã doanh nghiệp</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iQuy, String iNam, String iAll, String iLoaiDN, String iMaDN)
        {
            HamChung.Language();
