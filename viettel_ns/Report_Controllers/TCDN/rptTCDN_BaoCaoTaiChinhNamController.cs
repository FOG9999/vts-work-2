...
{
    public class rptTCDN_BaoCaoTaiChinhNamController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptDT_2bc/
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String NamLamViec,String To)
        {
            String xfilePath = "/Report_ExcelFrom/TCDN/rptTCDN_BaoCaoTaiChinhNam" + To + ".xls";
            ExcelFile xls = CreateReport(Server.MapPath(xfilePath), NamLamViec);
