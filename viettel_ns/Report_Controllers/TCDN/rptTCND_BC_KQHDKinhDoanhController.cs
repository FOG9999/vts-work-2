...
{
    public class rptTCND_BC_KQHDKinhDoanhController : Microsoft.AspNetCore.Mvc.Controller
    {
        // Created by: Thương
        ...
        /// <param name="MaDN">Mã doanh nghiệp</param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String Quy, String Nam, String MaDN)
        {
            HamChung.Language();
            ExcelFile xls = CreateReport(Server.MapPath(sFilePath), Quy, Nam, MaDN);
            using (FlexCelPdfExport pdf = new FlexCelPdfExport())
