...
{
    public class rptTCDN_BaoCaoInKiemController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /rptThuNop_4CC/
        ...
        /// <param name="iID_MaDonVi"></param>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String iLoai)
        {
            HamChung.Language();
            String sDuongDan = "";
            if (iLoai == "0")
