...
namespace Viettel.Services
{
    public interface ISharedService
    {
        ...
        Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(ExcelFile exfile);
    ...
    public class SharedService : ISharedService
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewPDF(ExcelFile exfile)
        {
            HamChung.Language();
        ...
        {
            string Content = "";
            int Nam = Convert.ToInt32(LayNamLamViec(HttpContextHelper.Current.User.Identity.Name));
