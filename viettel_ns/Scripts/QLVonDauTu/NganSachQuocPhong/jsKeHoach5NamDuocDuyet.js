...
function SendFile(id, idDonVi, iGiaiDoanTu, iGiaiDoanDen) {
    $.ajax({
        type: "POST",
        dataType: "html",
        url: "/QLVonDauTu/KeHoachTrungHanDuocDuyet/SendFile",
        data: { id: id, idDonVi: idDonVi, giaiDoanTu: iGiaiDoanTu, giaiDoanDen: iGiaiDoanDen },
        success: function (data) {
            $.ajax({
                type: "POST",
                url: "/Modal/OpenModal",
