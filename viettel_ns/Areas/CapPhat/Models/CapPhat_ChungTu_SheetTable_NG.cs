...
";
            ...
            sql = sql
                ...
                .Replace("@ng", entity.sDSLNS.Contains("1040100") ? _nganSachService.Nganh_GetAll_ChuyenNganh(HttpContextHelper.Current.User.Identity.Name, PhienLamViecViewModel.Current.NamLamViec).ToList().JoinFormat(format: "'{0}'") : "null")
