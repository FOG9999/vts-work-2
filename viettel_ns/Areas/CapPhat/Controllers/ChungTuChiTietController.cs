...
namespace VIETTEL.Areas.CapPhat.Controllers
{
    ...
    {
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string id_chungtu)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string id, int option = 0, string filters = null)
        {
