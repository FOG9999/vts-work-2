...
namespace VIETTEL.Areas.BaoHiemXaHoi.Controllers
{
    public class QLBenhNhanBHXHController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult QLBenhNhanBHXHListView(PagingInfo _paging, string sMaDonViBHXH, string sMaDonViNS, int? iThangFrom, int? iThangTo, int? iSoNgayDieuTri, string sHoTen, string sMaThe)
        {
            QLBenhNhanBHXHPagingViewModel vm = new QLBenhNhanBHXHPagingViewModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ImportBenhNhanBHXH()
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ImportFileBHXHListView(PagingInfo _paging, string sTenFile, string sMoTa, int? iThang)
        {
            TepBenhNhanBHXHPagingViewModel vm = new TepBenhNhanBHXHPagingViewModel();
            vm._paging = _paging;
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult LoadDataXML()
        {
        ...
        public Microsoft.AspNetCore.Mvc.FileResult Download(string sFileName)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DanhSachBenhNhanLoi()
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult XuatFileExcel()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult XuatFilePDF()
        {
            var datas = new List<QLBenhNhanBHXHViewModel>();
