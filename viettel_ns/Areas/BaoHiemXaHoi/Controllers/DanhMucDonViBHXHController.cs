...
namespace VIETTEL.Areas.BaoHiemXaHoi.Controllers
{
    public class DanhMucDonViBHXHController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult DonViBHXHListView(PagingInfo _paging, string sMaDonVi, string sTenDonVi, Guid? iID_BHXH_DonVi_ParentID, string iID_MaDonVi_NS)
        {
            DanhMucBHXHDonViPagingViewModel vm = new DanhMucBHXHDonViPagingViewModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ImportDonViBHXH()
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult LoadDataXLSX()
        {
