...
namespace VIETTEL.Areas.z.Controllers
{
    ...
    public abstract class ChungTuController : AppController
    {
        ...
        public virtual Microsoft.AspNetCore.Mvc.ActionResult Excel(string id_chungtu)
        {
            return View();
        }
        ...
        public abstract Microsoft.AspNetCore.Mvc.ActionResult Excel(ChungTuViewModel_QuyetToan vm);
    }
    ...
    public class QTController : ChungTuController
    {
        ...
        public override Microsoft.AspNetCore.Mvc.ActionResult Excel(string id_chungtu)
        {
        ...
        public override Microsoft.AspNetCore.Mvc.ActionResult Excel(ChungTuViewModel_QuyetToan vm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult excel_check(Guid id_chungtu, HttpPostedFileBase file)
        {
...
";
        ...
        public Microsoft.AspNetCore.Mvc.PartialViewResult excel_file_select(string file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult excel_check_file(Guid id_chungtu, string file_name, string z_file)
        {
