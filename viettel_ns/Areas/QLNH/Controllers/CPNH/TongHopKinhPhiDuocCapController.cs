...
{
    public class TongHopKinhPhiDuocCapController : FlexcelReportController
    {
        ...
        private const string sFilePathBaoCao1 = "/Report_ExcelFrom/QLNH/rpt_TongHopKinhPhiDuocCap.xlsx";
        private int _columnCountBC1 = 7;
        private const string sControlName = "TongHopKinhPhiDuocCap";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            List<CPNHThucHienNganSach_Model> list = _cpnhService.getListKinhPhiDuocCapTheoDonViModels(null, null, null).ToList();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopKinhPhiDuocCapSearch(DateTime? dTuNgay, DateTime? dDenNgay, Guid? iDonvi)
        {
            CPNHThucHienNganSach_ModelPaging vm = new CPNHThucHienNganSach_ModelPaging();
            List<CPNHThucHienNganSach_Model> list = _cpnhService.getListKinhPhiDuocCapTheoDonViModels(dTuNgay, dDenNgay, null).ToList();
            List<CPNHThucHienNganSach_Model> listData = getList(list);
            vm.Items = listData;
        ...
        private List<CPNHThucHienNganSach_Model> getList(List<CPNHThucHienNganSach_Model> list)
        {
            ...
            if (list != null)
            {
                foreach (var item in list)
                {
                    ...
                    sttTong++;
                    if (item.iID_DonVi != idDonVi && item.iID_DonVi != Guid.Empty)
                    {
                        SttChuongTrinh = 0;
                        SttDuAn = 0;
                        SttLoai = 0;
                        ...
                        List<CPNHThucHienNganSach_Model> listDataCha = list.Where(x => x.iID_DonVi == item.iID_DonVi).ToList();
                        ...
                        DataCha.sTenNoiDungChi = item.sTenDonVi;
                        DataCha.depth = "";
                        DataCha.isTitle = "font-bold-red";
                        idDonVi = item.iID_DonVi;
                    ...
                    if (item.IDNhiemVuChi != idChuongTrinh && item.IDNhiemVuChi != Guid.Empty)
                    {
                        ...
                        idHopDong = null;
                        CPNHThucHienNganSach_Model DataCha = new CPNHThucHienNganSach_Model();
                        List<CPNHThucHienNganSach_Model> listDataCha = list.Where(x => x.IDNhiemVuChi == item.IDNhiemVuChi && x.iID_DonVi == item.iID_DonVi).ToList();
                        DataCha.HopDongUSD = listDataCha.Sum(x => x.HopDongUSD);
                        DataCha.HopDongVND = listDataCha.Sum(x => x.HopDongVND);
                    ...
                    if (item.IDDuAn != idDuAn && item.IDDuAn != Guid.Empty)
                    {
                        ...
                        idHopDong = null;
                        CPNHThucHienNganSach_Model DataCha = new CPNHThucHienNganSach_Model();
                        List<CPNHThucHienNganSach_Model> listDataCha = list.Where(x => x.IDDuAn == item.IDDuAn && x.IDNhiemVuChi == item.IDNhiemVuChi && x.iID_DonVi == item.iID_DonVi).ToList();
                        DataCha.HopDongUSD = listDataCha.Sum(x => x.HopDongUSD);
                        DataCha.HopDongVND = listDataCha.Sum(x => x.HopDongVND);
                    ...
                    if (item.iLoaiNoiDungChi != idLoai && item.iLoaiNoiDungChi != 0)
                    {
                        ...
                        idHopDong = null;
                        CPNHThucHienNganSach_Model DataCha = new CPNHThucHienNganSach_Model();
                        List<CPNHThucHienNganSach_Model> listDataCha = list.Where(x => x.iLoaiNoiDungChi == item.iLoaiNoiDungChi && x.IDDuAn == item.IDDuAn && x.IDNhiemVuChi == item.IDNhiemVuChi && x.iID_DonVi == item.iID_DonVi).ToList();
                        DataCha.HopDongUSD = listDataCha.Sum(x => x.HopDongUSD);
                        DataCha.HopDongVND = listDataCha.Sum(x => x.HopDongVND);
                    ...
                    if (item.IDHopDong != idHopDong && item.IDHopDong != Guid.Empty)
                    {
                        SttHopDong++;
                        CPNHThucHienNganSach_Model DataCha = new CPNHThucHienNganSach_Model();
                        List<CPNHThucHienNganSach_Model> listDataCha = list.Where(x => x.IDHopDong == item.IDHopDong && x.iLoaiNoiDungChi == item.iLoaiNoiDungChi && x.IDDuAn == item.IDDuAn && x.IDNhiemVuChi == item.IDNhiemVuChi && x.iID_DonVi == item.iID_DonVi).ToList();
                        DataCha.HopDongUSD = listDataCha.Sum(x => x.HopDongUSD);
                        DataCha.HopDongVND = listDataCha.Sum(x => x.HopDongVND);
