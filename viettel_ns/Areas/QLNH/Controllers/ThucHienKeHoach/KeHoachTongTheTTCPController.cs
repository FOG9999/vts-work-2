...
namespace VIETTEL.Areas.QLNH.Controllers.ThucHienKeHoach
{
    public class KeHoachTongTheTTCPController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ListPage(NH_KHTongTheTTCPFilter input, PagingInfo paging)
        {
            if (paging == null)
            {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetDetail(Guid? id, string state)
        {
            ...
            ViewBag.State = state;
            ViewBag.ListKHTongTheTTCP = _qlnhService.getLookupKHTTCPByStage().ToList();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult NhiemVuChiDetail(NH_KHTongTheTTCPModel input, string state, bool isUseLastTTCP = false)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SaveKHTongTheTTCP(List<NH_KHTongTheTTCP_NhiemVuChiDto> lstNhiemVuChis, string keHoachTongTheTTCP, string state)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult FindParentTTCPActive(Guid id)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetDataLookupDetail()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult PlanDetailList(Guid khtt_id, Guid program_id)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult AddNew_NVC(Guid khtt_id)
        {
            var model = new KeHoachChiTietTTCPViewModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail_NVC(Guid? NVC_ID, Guid khtt_id)
        {
            var model = new KeHoachChiTietTTCPViewModel();
            if (NVC_ID != null)
            {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail_NVC_AddChild(Guid? NVC_ID, Guid khtt_id)
        {
            var model = new KeHoachChiTietTTCPViewModel();
            if (NVC_ID != null)
            {
