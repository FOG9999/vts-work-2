...
namespace VIETTEL.Areas.QLNH.Controllers.DuAnHopDong
{
    public class QLThongTinHopDongController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiem(PagingInfo _paging, string sTenHopDong, Guid? iDonVi, string maDonVi, Guid? iChuongTrinh, Guid? iDuAn, string soHopDong, DateTime? ngayKyHopDong, Guid? iLoaiHopDong)
        {
            NHDAThongTinHopDongViewModel vm = new NHDAThongTinHopDongViewModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult GetContractInfo(Guid? id, bool? isDieuChinh)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult GetContractInfoDetail(Guid? id)
        {
            NH_DA_HopDongModel data = new NH_DA_HopDongModel();
            if (id.HasValue)
            {
