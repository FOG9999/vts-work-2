...
namespace VIETTEL.Areas.QLNH.Controllers.DuAnHopDong
{
    public class ChenhLechTiGiaHoiDoaiController : FlexcelReportController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiem(PagingInfo _paging, Guid? iDonVi, string maDonVi, Guid? iChuongTrinh, Guid? iHopDong)
        {
            ChenhLechTiGiaViewModel vm = new ChenhLechTiGiaViewModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportChenhLechTiGia(Guid? iDonVi, Guid? iChuongTrinh, Guid? iHopDong, string ext = "xlsx")
        {
