...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.QuyetToan
{
    public class VDT_ThongTriController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetListView(PagingInfo _paging, Guid? iID_DonViQuanLy = null, string sMaThongTri = "", DateTime? dNgayTaoThongTri = null, int? iNamThucHien = null, string sNguoiLap = "", string sTruongPhong = "", string sThuTruongDonVi = "")
        {
            var listDonVi = _vdtService.GetListDataDonViByUser(Username);
            ViewBag.ListDonVi = listDonVi.ToSelectList("iID_Ma", "sTen");
            var result = new VDT_ThongTriPagingModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetDataLoaiCongTrinh()
        {
            var result = new List<dynamic>();
        ...
        [HttpGet]
        public Microsoft.AspNetCore.Mvc.ActionResult Update(string id)
        {
            var listDonVi = _vdtService.GetListDataDonViByUser(Username);
            ViewBag.ListDonVi = listDonVi.ToSelectList("iID_Ma", "sTen");
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ExportData(Guid? iID_DonViQuanLy = null, string sMaThongTri = "", DateTime? dNgayTaoThongTri = null, int? iNamThucHien = null, string sNguoiLap = "", string sTruongPhong = "", string sThuTruongDonVi = "")
        {
