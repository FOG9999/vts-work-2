...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.QuyetToan
{
    public class QuyetToanNienDoTroLyController : AppController
    {
        ...
        #region PartialView
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult QuyetToanNienDoTroLyView(PagingInfo _paging, Guid? iIdDonViQuanLy , int? iIdNguonVon , DateTime? dNgayDeNghiFrom , DateTime? dNgayDeNghiTo , int? iNamKeHoach )
        {
            string sMaNguoiDung = Username;
            QuyetToanNienDoTroLyPagingModel data = new QuyetToanNienDoTroLyPagingModel();
