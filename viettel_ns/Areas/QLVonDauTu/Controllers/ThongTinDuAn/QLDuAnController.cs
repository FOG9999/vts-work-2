...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.ThongTinDuAn
{
    public class QLDuAnController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiemDuAn(PagingInfo _paging, string sTenDuAn, string sKhoiCong, string sKetThuc, Guid? iID_DonViQuanLyID, Guid? iID_CapPheDuyetID, Guid? iID_LoaiCongTrinhID, int iTrangThai)
        {
            VDTDuAnPagingModel dataDuAn = new VDTDuAnPagingModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult xemChiTietDuAn(Guid? id)
        {
