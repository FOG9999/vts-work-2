...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.NganSachQuocPhong
{
    public class KeHoachTrungHanDeXuatController : AppController
    {
        ...
        */
        public Microsoft.AspNetCore.Mvc.ActionResult Index() // Hàm sau khi sửa 
        {
            KeHoach5NamDeXuatViewModel vm = new KeHoach5NamDeXuatViewModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KeHoach5NamDeXuatListView(PagingInfo _paging, string sSoQuyetDinh, DateTime? dNgayQuyetDinhFrom, DateTime? dNgayQuyetDinhTo, Guid? iID_DonViQuanLyID, string sMoTaChiTiet, int? iGiaiDoanTu, int? iGiaiDoanDen, int? iLoai, int? tabIndex)
        {
            KeHoach5NamDeXuatViewModel vm = new KeHoach5NamDeXuatViewModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetModalCt(string idDonVi, Guid? id)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetModal(Guid? id, bool isAggregate, List<KeHoach5NamDeXuatModel> lstItem)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetGridListExcelFromFTP(string idDonVi, string giaiDoanTu, string giaiDoanDen)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(Guid id, bool isDetail = false, bool isTongHop = false)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string id, bool isDetail = false, bool isTongHop = false, string filter = null)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ImportKH5NDX()
        {
            KeHoach5NamDeXuatChiTietGridViewModel vm = new KeHoach5NamDeXuatChiTietGridViewModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrameImport(string id, string filter = null)
        {
            var filters = filter == null ? Request.QueryString.ToDictionary() : JsonConvert.DeserializeObject<Dictionary<string, string>>(filter);
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult SaveImport(SheetEditViewModel vm)
        {
            try
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewInBaoCao(bool isModified, bool isCt)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportExcel(bool isModified, bool isCt)
        {
