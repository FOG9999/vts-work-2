...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.NganSachQuocPhong
{
    public class KeHoachVonNamPhanBoVonDVPheDuyetController : FlexcelReportController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KeHoachVonNamPhanBoVonDVPheDuyetSearch(PagingInfo _paging, string sSoQuyetDinh, DateTime? dNgayQuyetDinhFrom, DateTime? dNgayQuyetDinhTo, int? iNamKeHoach, int? iID_NguonVonID, Guid? iID_DonViQuanLyID)
        {
            KeHoachPhanBoVonDonViPheDuyetViewModel vm = new KeHoachPhanBoVonDonViPheDuyetViewModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KeHoachVonNamPhanBoVonDVPheDuyetDelete(Guid id)
        {
            bool status = false;
            try
            {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KeHoachVonNamPhanBoVonDVPheDuyetSave(VDT_KHV_PhanBoVon_DonVi_PheDuyet data, bool isModified)
        {
            Guid iID = Guid.Empty;
            try
            {
        ...
        [HttpGet]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(Guid id, bool isViewDetail = false)
        {
