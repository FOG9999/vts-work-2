...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.NganSachQuocPhong
{
    public class KeHoach5NamController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiem(PagingInfo _paging, string sSoQuyetDinh, DateTime? dNgayQuyetDinhFrom, DateTime? dNgayQuyetDinhTo, int? iGiaiDoanTu, int? iGiaiDoanDen, string sMaDonVi)
        {
            KeHoach5NamModel vm = new KeHoach5NamModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Add()
        {
