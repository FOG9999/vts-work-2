...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.NganSachQuocPhong
{
    public class KeHoachVonNamDeXuatController : FlexcelReportController
    {
        ...
        */// KeHoachVonNamDeXuatSearch truoc khi sua
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KeHoachVonNamDeXuatSearch(PagingInfo _paging, string sSoQuyetDinh, DateTime? dNgayQuyetDinhFrom, DateTime? dNgayQuyetDinhTo, int? iNamKeHoach, int? iID_NguonVonID, Guid? iID_DonViQuanLyID, int? tabIndex)
        {
            KeHoachVonNamDeXuatViewModel vm = new KeHoachVonNamDeXuatViewModel();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetModal(Guid? id, bool isTongHop, bool bIsDetail, List<VDT_KHV_KeHoachVonNam_DeXuat_ViewModel> lstItem)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult LoadDataDuAn(Guid iID_DonViID, int iNamKeHoach, int iID_NguonVonID)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(Guid id, bool isDieuChinh, bool bIsDetail = false, bool isViewDetail = false)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ImportKHVNDX()
        {
            KeHoachVonNamDeXuatChiTietGridViewModel vm = new KeHoachVonNamDeXuatChiTietGridViewModel();
        ...
        #region In báo cáo
        public Microsoft.AspNetCore.Mvc.ActionResult ViewInBaoCao(string isStatus)
        {
        ...
        [HttpPost]
        public JsonResult GetDataChungtu(string idMadv ,int namKh)
        {
            List<VDT_KHV_KeHoachVonNam_DeXuat> lstChungTuTH = _qLVonDauTuService.GetListChungTuTH(Guid.Parse(idMadv), namKh).ToList();
            //ViewBag.ListChungTuTH = lstChungTuTH.ToSelectList("iID_KeHoachVonNamDeXuatID", "sSoQuyetDinh");
        ...
        public bool ExportBCTheoDonVi(KHVNDXPrintDataExportModel data, List<string> arrIdNguonVon, List<string> arrDonVi, string isStatus)
        {
            try
            {
                ...
                if (strIdKeHoachVonNam == string.Empty)
                {
                    strIdKeHoachVonNam = Guid.Empty.ToString();
                }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportExcel(string isStatus)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetGridListExcelFromFTP(string idDonVi, string nam)
        {
