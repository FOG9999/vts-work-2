...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.NganSachQuocPhong
{
    public class QLKhoiTaoThongTinDuAnChuyenTiepController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sua(Guid id)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTiet(Guid id)
        {
            var data = _vdtService.GetDetailQLKhoiTaoDuAn(id);
            return View(data);
        }
        ...
        #region PartialView
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult QLKhoiTaoDuAnChuyenTiepView(PagingInfo _paging, string sTenDuAn, int? iNamKhoiTao)
        {
            VDTQLKhoiTaoDuAnPagingModel data = new VDTQLKhoiTaoDuAnPagingModel();
