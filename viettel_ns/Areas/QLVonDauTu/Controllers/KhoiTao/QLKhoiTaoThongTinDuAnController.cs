...
namespace VIETTEL.Areas.QLVonDauTu.Controllers.KhoiTao
{
    public class QLKhoiTaoThongTinDuAnController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult KhoiTaoTTDAListView(PagingInfo _paging, int? iNamKhoiTao, string sTenDonVi)
        {
            KhoiTaoThongTinDuAnViewModel vm = new KhoiTaoThongTinDuAnViewModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(Guid iID_KhoiTao, /*Guid iID_DonViQL*/ string sMaDonVi)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietKhoiTaoTTDAListView(byte type, int STT, Guid iID_KhoiTao, /*Guid iID_DonViQL*/ string sMaDonVi)
        {
            KhoiTaoThongTinDuAnChiTietViewModel vm = new KhoiTaoThongTinDuAnChiTietViewModel();
            vm._paging.CurrentPage = 1;
            vm.iID_KhoiTaoID = iID_KhoiTao;
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetModalChiTietThanhToan(Guid iID_KhoiTao_ChiTietID, Guid iID_DuAnID)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietHopDongListView(byte type, int STT, Guid iID_KhoiTaoDuLieuChiTietID, Guid iID_DuAnID)
        {
