...
{
    public class rptAdmin_IK01Controller : FlexcelReportController
    {
        private string _filePath = "~/Areas/Admin/FlexcelForm/rptAdmin_IK01.xls";
            ...
            string ext = "pdf")
        {
            ...
            {
                var filename = $"Danh_sách_đơn_vị_đã_nhập_số_liệu_dự_toán_{DateTime.Now.GetTimeStamp()}.{ext}";
