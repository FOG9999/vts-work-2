...
{
    public class rptDuToan_1020800_ChonToViewModel
    {
...
{
    public class rptDuToan_1020800_ChonToController : FlexcelReportController
    {
        #region var def 
        public string _viewPath = "~/Areas/DuToan/Views/Report/";
        private string _filePath = "~/Report_ExcelFrom/DuToan/rptDuToan_NSQP_ChonTo.xls";
        private string _filePath_to2 = "~/Report_ExcelFrom/DuToan/rptDuToan_NSQP_ChonTo_To2.xls";
        ...
        {
            var vm = new rptDuToan_1020800_ChonToViewModel
            {
            };
        ...
        public JsonResult Ds_To(string lns)
        {
            var data = getTable(lns);
        ...
        /// <returns></returns>
        private DataTable getTable(string lns)
        {
            return getTable(PhienLamViec.iNamLamViec, PhienLamViec.iID_MaPhongBan, PhienLamViec.iID_MaDonVi, lns);
        }

        private DataTable getTable(string namLamViec, string id_phongban, string id_donvi, string lns)
        {
            var sql = FileHelpers.GetSqlQuery("rptDuToan_NSQP_ChonTo.sql");
        ...
        {
            return $"{this.ControllerName()}_{Username}_{_nam}_{_lns}_{_dvt}";
        }
