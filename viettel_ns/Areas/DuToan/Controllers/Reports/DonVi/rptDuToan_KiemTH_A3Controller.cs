...
{
    public class rptDuToan_KiemTH_A3Controller : FlexcelReportController
    {
        #region var def
        private string _filePath = "~/Report_ExcelFrom/DuToan/DonVi/rptDuToan_KiemTH_A3.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            return View(@"~/Areas\DuToan\Views\Report\Kiem\rptDuToan_KiemTH_A3.cshtml", vm);
        }
        ...
        private Dictionary<bool, FlexCelReport> loadData(FlexCelReport fr)
        {
            ...
            {
                var data = dt.SelectDistinct("PhongBan", "sLNS1,sLNS3,sLNS5,sLNS,sL,sK,sM,sTM,sTTM,sNG,sXau,iID_MaPhongBan,TenPhongBan");
                           ...
                           .ForEach(r =>
                           {
                               var value1 = dt.AsEnumerable()
                                       ...
                                       .Where(x => x.Field<string>("iID_MaDonVi") == row.Field<string>("iID_MaDonVi") &&
                                                   x.Field<string>("iID_MaPhongBan") == r.Field<string>("iID_MaPhongBan") &&
                ...
                var ct = data.SelectDistinct("ChiTiet", "sLNS1,sLNS3,sLNS5,sLNS,sL,sK,sM,sTM,sTTM,sNG");
                FillDataTableLNS(fr, ct, FillLNSType.LNS1, PhienLamViec.iNamLamViec);
                fr.AddTable("PhongBan", data);
                fr.AddRelationship("ChiTiet", "PhongBan", "sLNS1,sLNS3,sLNS5,sLNS,sL,sK,sM,sTM,sTTM,sNG".Split(','), "sLNS1,sLNS3,sLNS5,sLNS,sL,sK,sM,sTM,sTTM,sNG".Split(','));
                return new Dictionary<bool, FlexCelReport>
                {
                    { true, fr }
                };
