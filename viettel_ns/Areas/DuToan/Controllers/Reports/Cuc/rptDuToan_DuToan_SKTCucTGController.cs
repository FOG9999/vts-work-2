...
{
    public class rptDuToan_DuToan_SKTCucTGController : FlexcelReportController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (PhienLamViec.iID_MaPhongBan == "02")
            {
                ...
                return View(@"~/Areas\DuToan\Views\Report\Kiem\rptDuToan_DuToan_SKTCucTG.cshtml", vm);
            }
            else
            {
        ...
        {            
            ...
            this.ex = Request.GetQueryStringValue("ex").ToString();
            this.ng = Request.GetQueryStringValue("ng").ToString();
            this.dv = Request.GetQueryStringValue("dv").ToString();
        ...
        {
            var sql = "DT_report_dutoan_skt_thcuctg";
