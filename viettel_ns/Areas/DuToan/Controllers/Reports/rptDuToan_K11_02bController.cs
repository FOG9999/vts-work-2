...
{
    public class rptDuToan_K11_02bController : FlexcelReportController
    {
        #region var def
        public string _viewPath = "~/Areas/DuToan/Views/Report/";
        private string _filePath = "~/Report_ExcelFrom/DuToan/KiemTra/rptDuToan_K11_02b.xls";
        ...
        private DataTable getTable(string nam, string id_phongban, string id_nganh, int loaiBaoCao, string username)
        {
            ...
            var sql = FileHelpers.GetSqlQuery("rptDuToan_K11_02b.sql");
