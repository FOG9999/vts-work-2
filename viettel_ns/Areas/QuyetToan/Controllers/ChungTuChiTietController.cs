...
namespace VIETTEL.Areas.QuyetToan.Controllers
{
    ...
    public class ChungTuChiTietController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string id, int option = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult Save1(string id, int filter)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult BaocaoThongTri(string id)
        {
