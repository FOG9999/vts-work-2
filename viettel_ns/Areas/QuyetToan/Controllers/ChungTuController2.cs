...
namespace VIETTEL.Areas.QuyetToan.Controllers
{
    public class ChungTu2Controller : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string id)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult NSQP()
        {
            return index(LNSType.NSQP.ToString());
        }

        public Microsoft.AspNetCore.Mvc.ActionResult NSNN()
        {
            return index(LNSType.NSNN.ToString());
        }

        public Microsoft.AspNetCore.Mvc.ActionResult NSK()
        {
            return index(LNSType.NSK.ToString());
        }

        private Microsoft.AspNetCore.Mvc.ActionResult index(string id)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(Guid id, string type)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(ChungTuViewModel vm)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(string id)
        {
            return View("Index");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Create(string id)
        {
