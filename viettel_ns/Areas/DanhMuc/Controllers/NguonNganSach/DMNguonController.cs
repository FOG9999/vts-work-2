...
namespace VIETTEL.Areas.DanhMuc.Controllers
{
    public class DMNguonController : AppController
    {
        ...
        #region Data grid
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string filter = null)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiemDMNguon(string sMaNguon, string sNoiDung, Guid? iID_NguonCha, PagingInfo _paging)
        {
        ...
        [HttpGet]
        public Microsoft.AspNetCore.Mvc.ActionResult CreateDMNguon()
        {
            return View();
        }

        public Microsoft.AspNetCore.Mvc.ActionResult EditDMNguon(Guid id)
        {
