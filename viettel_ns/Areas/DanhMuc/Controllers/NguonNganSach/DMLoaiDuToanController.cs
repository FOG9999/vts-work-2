...
namespace VIETTEL.Areas.DanhMuc.Controllers
{
    public class DMLoaiDuToanController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string filter = null)
        {
        ...
        #region PartialView
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult DMLoaiDuToanListView(PagingInfo _paging, string code, string name)
        {
            DMLoaiDuToanPagingModel data = new DMLoaiDuToanPagingModel();
