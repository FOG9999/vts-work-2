...
{
    public class rptNCSKT_IK05ViewModel
    {
        public SelectList NganhList { get; set; }
        public SelectList PhongBanList { get; set; }
        public SelectList DonViList { get; set; }
    }
    public class rptNCSKT_IK05Controller : FlexcelReportController
    {
        public string _viewPath = "~/Areas/SKT/Views/Reports/InKiem/";
        private const string _filePath = "~/Areas/SKT/FlexcelForm/InKiem/rptNCSKT_IK05/rptNCSKT_IK05.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            var vm = new rptNCSKT_IK05ViewModel()
            {
            ...
            var view = _viewPath + "rptNCSKT_IK05.cshtml";
        ...
        private DataSet getDataSet()
        {
            ...
            { 
                var cmd = new SqlCommand("sp_ncskt_report_ik05", conn);
