...
{
    public class rptNCSKT_TH09ViewModel
    {
        public SelectList PhongBanList { get; set; }
    }
    public class rptNCSKT_TH09Controller : FlexcelReportController
    {
        public string _viewPath = "~/Areas/SKT/Views/Reports/TongHop/";
        private string _filePath = "~/Areas/SKT/FlexcelForm/TongHop/rptNCSKT_TH09/rptNCSKT_TH09.xls";
        private string _filePath_dv = "~/Areas/SKT/FlexcelForm/TongHop/rptNCSKT_TH09/rptNCSKT_TH09_dv.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (User.Identity.Name.EndsWith("b2"))
            {
                ...
                var vm = new rptNCSKT_TH09ViewModel()
                {
                    PhongBanList = phongbanList.ToSelectList("sKyHieu", "sMoTa"),
                };

                var view = _viewPath + "rptNCSKT_TH09.cshtml";
        ...
        {           
            ...
            {
                var cmd = new SqlCommand("sp_ncskt_report_th09", conn);
