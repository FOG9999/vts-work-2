...
{
    public class rptNCSKT_TH15ViewModel
    {
        public SelectList NganhList { get; set; }
        public SelectList PhongBanList { get; set; }
        public SelectList DonViList { get; set; }
    }
    public class rptNCSKT_TH15Controller : FlexcelReportController
    {
        public string _viewPath = "~/Areas/SKT/Views/Reports/TongHop/";
        private const string _filePath = "~/Areas/SKT/FlexcelForm/TongHop/rptNCSKT_TH15/rptNCSKT_TH15.xls";
        private const string _filePath_dv = "~/Areas/SKT/FlexcelForm/TongHop/rptNCSKT_TH15/rptNCSKT_TH15_dv.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (User.Identity.Name.EndsWith("b2"))
            {
                ...
                var vm = new rptNCSKT_TH15ViewModel()
                {
                ...
                var view = _viewPath + "rptNCSKT_TH15.cshtml";
            ...
            int dvt = 1000)
        {
            ...
            var filename = $"Báo_cáo_tổng_hợp_phân_bổ_dự_toán_ngân_sách_quốc_phòng_năm_{PhienLamViec.iNamLamViec}_{DateTime.Today.ToShortDateString()}.{ext}";
        ...
        private ExcelFile createReport()
        {
            ...
            fr.SetValue(new
            {
                ...
                t = _loaiBC == 21 ? "Số kiểm tra" : "Dự toán",
            });
        ...
        private DataSet getDataSet()
        {
            ...
            { 
                var cmd = new SqlCommand("sp_ncskt_report_th15", conn);
