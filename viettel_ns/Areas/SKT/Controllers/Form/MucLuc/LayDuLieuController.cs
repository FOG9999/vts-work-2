...
namespace VIETTEL.Areas.SKT.Controllers
{
    ...
    public class LayDuLieuController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult GetComData()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult GetMLDacThu()
        {
            if (_ngansachService.GetUserRoleType(Username) == (int)UserRoleType.QuanTri
                || _ngansachService.GetUserRoleType(Username) == (int)UserRoleType.ThuTruong
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult GetSoLieuCanCu()
        {
            if ((_ngansachService.GetUserRoleType(Username) == (int)UserRoleType.QuanTri
                || _ngansachService.GetUserRoleType(Username) == (int)UserRoleType.ThuTruong
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult CopyMucLucNT()
        {
            if (_ngansachService.GetUserRoleType(Username) == (int)UserRoleType.QuanTri
                || _ngansachService.GetUserRoleType(Username) == (int)UserRoleType.ThuTruong
                || PhienLamViec.iID_MaPhongBan == "11")
