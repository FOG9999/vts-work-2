...
namespace VIETTEL.Areas.SKT.Controllers
{
    public class ChungTuController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string search = null, int page = 1, int loai = 1, string orderby = null)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(ChungTuEditViewModel vm)
        {
        ...
        [HttpGet]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(int Loai = 1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(ChungTuEditViewModel vm)
        {
        ...
        #region block   
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult OpenOrLock(Guid id)
        {
            var success = false;
            var msg = string.Empty;
        ...
        public Microsoft.AspNetCore.Mvc.PartialViewResult LockOrOpen()
        {
            var vm = getLockViewModel();
            return PartialView("_editor_id", vm);
        }
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult UpdateLock(
            int nam,
            int id_lock,
            string iloais = null,
            string donvis = null)
        ...
        #region
        public Microsoft.AspNetCore.Mvc.PartialViewResult ChuyenT()
        {
            var vm = getChuyenViewModel();
            return PartialView("_chuyen_id", vm);
        }
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ChuyenT(
            string id_donvi)
        {
            var success = false;
            var msg = ""; 
