...
{
    public class rptDuToanBS_InPhuLucViewModel
    {
    ...
    {
        #region ctor
        public string _viewPath = "~/Areas/DuToanBS/Views/Reports/InPhuLuc/";
        ...
        private string _filePath_ngang = "~/Areas/DuToanBS/FlexcelForm/InPhuLucTH/rptDuToanBS_PhuLuc_Ngang.xls";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            ...
            var vm = new rptDuToanBS_InPhuLucViewModel
            {
                DotList = dotList,
            ...
            int dvt = 1000)
        {
            ...
            var xls = createReport(Server.MapPath(path), iID_MaDot, dNgay, iID_MaDonVi, tenPhuLuc, quyetDinh, ghiChu, loaiBaoCao);
        ...
        public JsonResult Ds_DonVi(string iID_MaDot, int loaiBaoCao)
        {
            iID_MaDot = _dutoanbsService.GetChungTus_Gom(iID_MaDot).Join();

            var data = _dutoanbsService.GetDonviDT_DNs(PhienLamViec.iNamLamViec, iID_MaDot, PhienLamViec.iID_MaDonVi, loaiBaoCao == 4 ? "06" : "07,08,10,17");
            ...
            int loaiBaoCao)
        {
            ...
            var ds = LoadData(fr, iID_MaDot, iID_MaDonVi, loaiBaoCao);
        ...
        private DataTable getDataTable(string iID_MaDonVi, string iID_MaChungTu, int loaiBaoCao)
        {
            #region sql
        ...
        private IList<DataTable> LoadData(FlexCelReport fr, string iID_MaDot, string iID_MaDonVi, int loaiBaoCao)
        {
            var iID_MaChungTu = _dutoanbsService.GetChungTus_Gom(iID_MaDot).Join();

            var data = getDataTable(iID_MaDonVi, iID_MaChungTu, loaiBaoCao);
            if (loaiBaoCao == 3)
            {
            ...
            return new List<DataTable> { data };
        }
