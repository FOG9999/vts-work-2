...
{
    public class rptDuToanKT_M01NG_ViewModel
    {
...
{
    public class rptDuToanKT_M01NGController : FlexcelReportController
    {
        #region var def
        public string _viewPath = "~/Areas/DuToanKT/Views/Report/";
        private string _filePath = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M01NG.xls";
        private string _filePath_a4 = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M01NG_a4.xls";
        ...
        private string getTieuDe()
        {
            ...
            var tieude = $"Thông báo số đã phân cấp cho đơn vị năm {nam}";
