...
{
    public class rptDuToanKT_M03cViewModel
    {
...
{
    public class rptDuToanKT_M03cController : FlexcelReportController
    {
        #region var def
        public string _viewPath = "~/Areas/DuToanKT/Views/Report/";
        private const string _filePath = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M03c.xls";
        private const string _filePath_trinhky = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M03c.xls";
        ...
        {
            var sql = FileHelpers.GetSqlQuery("dtkt_report_m03c.sql");
