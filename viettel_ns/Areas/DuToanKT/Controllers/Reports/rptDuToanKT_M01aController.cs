...
{
    public class rptDuToanKT_M01aController : FlexcelReportController
    {
        #region var def
        public string _viewPath = "~/Areas/DuToanKT/Views/Report/";
        private string _filePath = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M01a.xls";
        private string _filePath_to2 = "~/Report_ExcelFrom/DuToanKT/rptDuToanKT_M01a_to2.xls";
        ...
        public rptDuToanKT_M01aController()
        {
        }
        ...
        private ExcelFile createReport(string tieuDe = null)
        {
            ...
            fr.SetValue("TieuDe2", "Biểu đối chiếu số Bql đề nghị và số đặc thù");
        ...
        private void loadData(FlexCelReport fr)
        {
            ...
            var data = dt.SelectDistinct("ChiTiet", "Code1,Code2,Code3,Code,sMoTa");
            ...
            for (int i = 0; i < _columnCount; i++)
            {
                ...
                if (i < columns.Count)
                {
                    ...
                    fr.SetValue(colName1, "Đề nghị");
                    fr.SetValue(colName2, "Đặc thù");
        ...
        {
            var sql = FileHelpers.GetSqlQuery("dtkt_report_m01a.sql");
