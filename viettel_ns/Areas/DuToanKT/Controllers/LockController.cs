...
namespace VIETTEL.Areas.DuToanKT.Controllers
{
    public class LockController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.PartialViewResult Editor(string id_donvi)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Update(DTKTLockViewModel vm)
        {
            var success = false;
            var msg = "";
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult UpdateLockId(
            int nam,
            int id_lock,
            string iloais = null,
            string ireqs = null,
