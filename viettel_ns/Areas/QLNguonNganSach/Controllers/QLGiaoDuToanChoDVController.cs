...
namespace VIETTEL.Areas.QLNguonNganSach.Controllers
{
    public class QLGiaoDuToanChoDVController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult NNSGiaoDuToanListView(PagingInfo _paging, string sSoChungTu, string sNoiDung, string sLoaiDuToan, string sSoQuyetDinh, DateTime? dNgayQuyetDinhTu, DateTime? dNgayQuyetDinhDen, string sSoCongVan, DateTime? dNgayCongVanTu, DateTime? dNgayCongVanDen)
        {
            NNSGiaoDuToanViewModel vm = new NNSGiaoDuToanViewModel();
            vm._paging = _paging;
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ExportData(string sSoChungTu = "", string sNoiDung = "", string sMaLoaiDuToan = "", string sSoQuyetDinh = "", DateTime? dNgayQuyetDinhTu = null, DateTime? dNgayQuyetDinhDen = null, string sSoCongVan = "", DateTime? dNgayCongVanTu = null, DateTime? dNgayCongVanDen = null, string sLoaiTep = "")
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietDuToan(string id)
        {
            var ids = id.Split('_');
            var idDuToan = "";
            if (ids.Length >= 1)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietDuToanNhiemVu(string idDuToan, string idMaChungTu, string idNhiemVu)
        {
            var nhiemVu = _qLNguonNSService.GetNhiemVuById(idNhiemVu);
            if (nhiemVu != null)
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrameNhiemVu(string id, string filter, string idMaChungTu, string idNhiemVu)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string id, string filter = null, bool isSaoChep = false)
        {
            var filters = filter == null ? Request.QueryString.ToDictionary() : JsonConvert.DeserializeObject<Dictionary<string, string>>(filter);
            var listModel = new List<NNSDuToanChiTietGetSoTienByDonViModel>();
            var ids = id.Split('_');
