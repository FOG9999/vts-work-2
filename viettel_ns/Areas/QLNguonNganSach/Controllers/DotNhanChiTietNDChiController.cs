...
namespace VIETTEL.Areas.QLNguonNganSach.Controllers
{
    public class DotNhanChiTietNDChiController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ViewDotNhanChiTietNDChi(Guid iID_DotNhan, string sNoiDung, string sMaLoaiDuToan, bool isClone, double fSoTienNhanTuBTC, double SoTienDaPhanNDC, double fSoTienConLai, Guid iID_DotNhanChiTiet)
        {
