...
namespace VIETTEL.Areas.QLNguonNganSach.Controllers
{
    public class NNSDuToanNhiemVuController : AppController
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string id, string filter = null)
        {
            //return View();
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult GetListChungTu(string idDuToan)
        {
