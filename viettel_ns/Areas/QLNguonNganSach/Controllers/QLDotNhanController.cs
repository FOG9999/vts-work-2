...
namespace VIETTEL.Areas.QLNguonNganSach.Controllers
{
    public class QLDotNhanController : AppController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult NNSDotNhanListView(PagingInfo _paging, string sSoChungTu, string sNoiDung, string sMaLoaiDuToan, string sSoQuyetDinh, DateTime? dNgayQuyetDinhFrom, DateTime? dNgayQuyetDinhTo)
        {
            DotNhanPagingViewModel vm = new DotNhanPagingViewModel();
            vm._paging = _paging;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(string id)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult ExportData(string sMaLoaiDuToan = "", string sSoChungTu = "", string sSoQuyetDinh = "", DateTime? dNgayQuyetDinhTu = null, DateTime? dNgayQuyetDinhDen = null, string sNoiDung = "", string sLoaiTep = "")
        {
