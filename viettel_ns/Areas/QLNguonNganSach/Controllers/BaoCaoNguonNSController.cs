...
namespace VIETTEL.Areas.QLNguonNganSach.Controllers
{
    public class BaoCaoNguonNSController : FlexcelReportController
    {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult BaoCaoTongHopNguonPartial(Guid? iNguonNganSach, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanNewPartial(int iLoaiNganSach, Guid? iID_Nguon, DateTime? dDateFrom, DateTime? dDateTo, string sSoQuyetDinh = null, int dvt = 1)
        {
            int iTotalCol = 0;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhPartial(int iLoaiNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            RptTongHopGiaoDuToanModel data = new RptTongHopGiaoDuToanModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhPartialExport(string ext = "pdf", int dvt = 1, int iLoaiNganSach = 0, int to = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietPhanCapDauNamTheoQuyetDinhPartial(int iLoaiNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            RptTongHopGiaoDuToanModel data = new RptTongHopGiaoDuToanModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhPhanCapPartialExport(string ext = "pdf", int dvt = 1, int iLoaiNganSach = 0, int to = 1)
        {
            string fileName = string.Format("{0}.{1}", "Tong_hop_du_toan_nsqp_giao_cho_dv_theo_soquyetdinh", ext);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToan()
        {
            DateTime firstDay = new DateTime(PhienLamViec.NamLamViec, 1, 1);
            DateTime lastDay = new DateTime(PhienLamViec.NamLamViec, 12, 31);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult PrintBCTongHopNguonBTC(string ext = "pdf", int dvt = 1, int to = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportExcel(string ext = "pdf", int dvt = 1, int iLoaiNganSach = 0, int to = 1)
        {
        ...
        #region Bao cao 4
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanBaoCao4()
        {
            List<NNSDMNguonViewModel> lstNguon = _danhMucService.GetAllDMNguonBaoCao(PhienLamViec.NamLamViec).ToList();
            lstNguon.Insert(0, new NNSDMNguonViewModel { iID_Nguon = Guid.Empty, sNoiDung = Constants.TAT_CA });
            ViewBag.ListDanhMucNguon = lstNguon.ToSelectList("iID_Nguon", "sNoiDung");
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanBaoCao4Partial(Guid? iNguonNganSach, DateTime? dDateFrom, DateTime? dDateTo, string sSoQuyetDinh = null, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportBaoCao4(string ext = "pdf", int dvt = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhBaoCao4Partial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
            RptTongHopGiaoDuToanModel data = new RptTongHopGiaoDuToanModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhBaoCao4PartialExport(string ext = "pdf", int dvt = 1)
        {
            string fileName = string.Format("{0}.{1}", "Tong_hop_du_toan_nsqp_giao_cho_dv_theo_soquyetdinh", ext);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietPhanCapDauNamTheoQuyetDinhBaoCao4Partial(string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            RptTongHopGiaoDuToanModel data = new RptTongHopGiaoDuToanModel();
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietQuyetDinhBaoCao4PhanCapPartialExport(string ext = "pdf", int dvt = 1)
        {
            string fileName = string.Format("{0}.{1}", "Tong_hop_du_toan_nsqp_giao_cho_dv_theo_soquyetdinh", ext);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanNSNam()
        {
            List<NNSDMNguonViewModel> lstNguon = _danhMucService.GetAllDMNguonBaoCao(PhienLamViec.NamLamViec).ToList();
            lstNguon.Insert(0, new NNSDMNguonViewModel { iID_Nguon = Guid.Empty, sNoiDung = Constants.TAT_CA });
            ViewBag.ListDanhMucNguon = lstNguon.ToSelectList("iID_Nguon", "sNoiDung");
        ...
        #region theo don vi
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanNSTheoDonViPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult XuatFileTongHopGiaoDuToanNSTheoDonVi(string ext = "pdf", int dvt = 1)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanNSTheoDonViBQLPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult XuatFileTongHopGiaoDuToanNSTheoDonViBQL(string ext = "pdf", int dvt = 1)
        {
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanNSTheoBQLDonViPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult XuatFileTongHopGiaoDuToanNSTheoBQLDonVi(string ext = "pdf", int dvt = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopQDBSDuToanNSNam()
        {
            List<NNSDMNguonViewModel> lstNguon = _danhMucService.GetAllDMNguonBaoCao(PhienLamViec.NamLamViec).ToList();
            lstNguon.Insert(0, new NNSDMNguonViewModel { iID_Nguon = Guid.Empty, sNoiDung = Constants.TAT_CA });
            ViewBag.ListDanhMucNguon = lstNguon.ToSelectList("iID_Nguon", "sNoiDung");
        ...
        #region theo don vi
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopQDBSDuToanNSNamTheoDonViPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
        ...
        #region theo don vi bql
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopQDBSDuToanNSNamTheoDonViBQLPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
            ...
            foreach (ThongTinDonVi item in lstDonVi)
            {
                ...
                foreach (ThongTinDotBS itemDotBS in lstSoQuyetDinh)
                {
                    List<RptChiTietTongHopQDBSDuToanNSNamModel> lstObjChiTiet = lstChiTiet.Where(x => x.iID_MaDonVi == item.iID_MaDonVi && x.iID_DuToan == itemDotBS.iID_DuToan).ToList();
                    if (lstObjChiTiet.Count > 0)
                        item.lstGiaTri.Add(new GiaTri
                        {
                            fSoTien = lstObjChiTiet.Sum(x => x.iTongTien)
                        });
                    else
                        item.lstGiaTri.Add(new GiaTri
                        {
        ...
        #region theo bql don vi
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopQDBSDuToanNSNamTheoBQLDonViPartial(Guid? iNguonNganSach, string sSoQuyetDinh, DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
            if (iNguonNganSach == Guid.Empty)
                iNguonNganSach = null;
            ...
            foreach (ThongTinPhongBan item in lstPhongBan)
            {
                ...
                foreach (ThongTinDotBS itemDotBS in lstSoQuyetDinh)
                {
                    ...
                    List<RptChiTietTongHopQDBSDuToanNSNamModel> lstObjChiTiet = lstChiTiet.Where(x => x.sMaPhongBan == item.sMaPhongBan && x.iID_DuToan == itemDotBS.iID_DuToan).ToList();
                    if (lstObjChiTiet.Count > 0)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportBaoCaoTongHopQDBSDuToanNSNam(string ext = "pdf", int dvt = 1, int iTypeBC = 1, int to = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanLNS()
        {
            DateTime firstDay = new DateTime(PhienLamViec.NamLamViec, 1, 1);
            DateTime lastDay = new DateTime(PhienLamViec.NamLamViec, 12, 31);
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult TongHopGiaoDuToanLNSPartial(DateTime? dDateFrom, DateTime? dDateTo, int dvt = 1)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ExportExcelTongHopGiaoDuToanLNS(string ext = "pdf", int dvt = 1)
        {
