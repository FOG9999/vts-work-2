...
namespace VIETTEL.Mvc
{
    ...
    public abstract class AppWebViewPage<TModel> : WebViewPage<TModel>
    {
        ...
        public string ApplicationPath
        {
            get
            {
                var appPath = HttpContextHelper.Current.Request.ApplicationPath;
                if (appPath == null)
                {
                    return "/";
                }
        ...
        protected bool UserIsAuthenticated => HttpContextHelper.Current.User.Identity.IsAuthenticated;

        //protected bool UserIsAdmin => User.IsInRole(AppConstants.AdminRoleName);

        protected string Username => UserIsAuthenticated ? HttpContextHelper.Current.User.Identity.Name : null;
