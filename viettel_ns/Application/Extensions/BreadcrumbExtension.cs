...
namespace VIETTEL
{
    ...
    {
        public static Microsoft.AspNetCore.Html.HtmlString BuildBreadcrumbNavigation(this HtmlHelper helper)
        {
            ...
            return Microsoft.AspNetCore.Html.HtmlString.Create(breadcrumb.Append("</ol>").ToString());
        }


        public static Microsoft.AspNetCore.Html.HtmlString BuildBreadcrumbButtons(this HtmlHelper helper, string className = "btn-default")
        {
            string area = (helper.ViewContext.RouteData.DataTokens["area"] ?? "").ToString();
            string controller = helper.ViewContext.RouteData.Values["controller"].ToString();
            string action = helper.ViewContext.RouteData.Values["action"].ToString();
        ...
        public static Microsoft.AspNetCore.Html.HtmlString BuildBreadcrumbWebNewButtons(this HtmlHelper helper, string className = "btn-default")
        {
        ...
        public static Microsoft.AspNetCore.Html.HtmlString BuildPagingButtons(this HtmlHelper helper, PagingInfo _paging)
        {

            if(_paging.TotalPages == 0) return Microsoft.AspNetCore.Html.HtmlString.Create(string.Empty);
