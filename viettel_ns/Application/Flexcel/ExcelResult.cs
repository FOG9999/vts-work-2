...
namespace VIETTEL.Flexcel
{
    ...
    public abstract class FlexcelFileResult : Microsoft.AspNetCore.Mvc.FileResult
    {
    ...
    public class FlexFilePdfResult : Microsoft.AspNetCore.Mvc.ActionResult
    {
        private readonly string _filename;
        private readonly ExcelFile _xls;
    ...
    public static class FlexcelResultExtension
    {
        ...
        public static Microsoft.AspNetCore.Mvc.FileResult ToFileResult(this ExcelFile xls, string filename = null, string ext = FileExts.Xls)
        {
            if (ext == FileExts.Pdf)
            {
