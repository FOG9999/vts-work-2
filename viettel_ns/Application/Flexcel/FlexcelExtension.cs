...
namespace VIETTEL.Flexcel
{
    public static class FlexcelExtension
    {
          ...
          string userDefault = "trolyphongban")
        {
            ...
            username = username ?? HttpContextHelper.Current.User.Identity.Name;
            ...
            string chuky = null)
        {
            ...
            {
                username = HttpContextHelper.Current.User.Identity.Name;
            }
            ...
            fields.ForEach(x =>
            {
                ...
                chuky = HttpContextHelper.Current.Request.GetQueryString("chuky", chuky);
...
";
        ...
        private static Dictionary<string, string> getLnsCache()
        {
            ...
            var lnsCache = HttpContextHelper.Current.Cache.Get(cacheKey);
            if (lnsCache == null)
            {
                lnsCache = new Dictionary<string, string>();
                HttpContextHelper.Current.Cache.Add(cacheKey,
                    lnsCache,
                    null,
        ...
        public static FlexCelReport UseForm(this FlexCelReport fr, Microsoft.AspNetCore.Mvc.Controller controller)
        {
