...
namespace VIETTEL.Controllers.ThuNop {
    public class ThuNop_CauHinhBaoCaoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TN_CauHinhBaoCao/
        public string sViewPath = "~/Views/ThuNop/CauHinhBaoCao/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iLoai)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaBaoCao_Cha, String iLoai)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaBaoCao, String iID_MaBaoCao_Cha, String iLoai)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_CauHinhBaoCao", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaBaoCao, String iLoai)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_CauHinhBaoCao", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaBaoCao, String iID_MaBaoCao_Cha)
        {
