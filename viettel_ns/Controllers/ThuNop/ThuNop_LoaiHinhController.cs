...
namespace VIETTEL.Controllers.ThuNop {
    public class ThuNop_LoaiHinhController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaLoaiHinh_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaLoaiHinh, String iID_MaLoaiHinh_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_DanhMucLoaiHinh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_DanhMucLoaiHinh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaLoaiHinh_Cha, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_DanhMucLoaiHinh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaLoaiHinh_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TN_DanhMucLoaiHinh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaLoaiHinh, String iID_MaLoaiHinh_Cha)
        {
