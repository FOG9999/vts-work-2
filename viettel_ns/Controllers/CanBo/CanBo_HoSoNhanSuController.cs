...
{
    public class CanBo_HoSoNhanSuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaCanBo)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaCanBo)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditTinhHinhKT(String ParentID, String iID_MaCanBo)
        {
            String MaND = User.Identity.Name;          
            Bang bang = new Bang("CB_CanBo");
            bang.MaNguoiDungSua = User.Identity.Name;
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaCanBo)
        {
