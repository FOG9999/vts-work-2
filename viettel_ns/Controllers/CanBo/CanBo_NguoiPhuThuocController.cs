...
{
    public class CanBo_NguoiPhuThuocController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /NguoiPhuThuoc/
        ...
        /// <returns></returns>
        public JavaScriptResult Edit_Fast_NguoiPhuThuoc_Submit(String ParentID, String OnSuccess, String iID_MaCanBo, String iID_MaQuaTrinhCongTac)
        {
            //Insert into data vào bảng: KT_ChungTuChiTiet
            Bang bang = new Bang("CB_NguoiPhuThuoc");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaNguoiPhuThuoc, String iID_MaCanBo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "CB_NguoiPhuThuoc", "Delete") == false)
            {
            ...
            bang.MaNguoiDungSua = User.Identity.Name;
            bang.IPSua = Request.UserHostAddress;
            bang.TruongKhoa = "iID_MaNguoiPhuThuoc";
            bang.GiaTriKhoa = iID_MaNguoiPhuThuoc;
            bang.Delete();
