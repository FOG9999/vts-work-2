...
{
    public class PhanHe_TrangThaiDuyet_NhomNguoiDungController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Loc_Index(String ParentID)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaPhanHe_TrangThaiDuyet_Xem)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_PhanHe_TrangThaiDuyet_NhomNguoiDung", "Edit") == false || !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaPhanHe_TrangThaiDuyet_Xem)
        {
