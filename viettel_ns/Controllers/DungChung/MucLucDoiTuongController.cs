...
{
    public class MucLucDoiTuongController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /MucLucDoiTuong/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaMucLucDoiTuong_Cha)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaMucLucDoiTuong, String iID_MaMucLucDoiTuong_Cha)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucDoiTuong", "Edit") == false)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaMucLucDoiTuong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucDoiTuong", "Edit") == false)
...
//                int iSoKyHieu = NganSach_DoiTuongModels.GetKyHieuDoiTuong(sKyHieu);
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaMucLucDoiTuong_Cha, String iID_MaMucLucDoiTuong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucDoiTuong", "Edit") == false)
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaMucLucDoiTuong_Cha)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucDoiTuong", "Edit") == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaMucLucDoiTuong, String iID_MaMucLucDoiTuong_Cha)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
