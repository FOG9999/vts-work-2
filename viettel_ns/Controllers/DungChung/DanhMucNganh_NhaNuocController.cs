...
{
    public class DanhMucNganh_NhaNuocController : Microsoft.AspNetCore.Mvc.Controller
    {


        public string sViewPath = "~/Views/DungChung/DanhMucNganh_NhaNuoc/";

        public Microsoft.AspNetCore.Mvc.ActionResult Index(int? page)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID, int? page)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID, int? page)
        {


            Bang bang = new Bang("NS_MucLucNganSach_Nganh_NhaNuoc");
            ...
            {
                if (MucLucNganSach_NganhModels.CheckTonTaiMaNganh_NhaNuoc(iID_MaNganh))
                {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(string iID, int? page)
        {
            Bang bang = new Bang("NS_MucLucNganSach_Nganh_NhaNuoc");
            bang.GiaTriKhoa = iID;
            bang.IPSua = Request.UserHostAddress;
