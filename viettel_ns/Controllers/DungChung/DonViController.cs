...
namespace VIETTEL.Controllers.DungChung
{
    ...
    public class DonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /DonVi/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaDonViCha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_DonVi", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDonVi)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_DonVi", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaDonVi)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_DonVi", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
            ...
            else
            {
                ...
                bang.CmdParams.Parameters.AddWithValue("@iNamLamViec_DonVi", ReportModels.LayNamLamViec(User.Identity.Name));
                bang.Save();
                //update cấp bậc
                int iCap = 1;
                if (sMaDonViCha != "")
                ...
                cmd.Parameters.AddWithValue("@iNamLamViec_DonVi", ReportModels.LayNamLamViec(User.Identity.Name));
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ThemDanhMucDonVi()
        {
            ...
            {
                if (CommonFunction.IsNumeric(ReportModels.LayNamLamViec(User.Identity.Name)))
                {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaDonVi)
        {
