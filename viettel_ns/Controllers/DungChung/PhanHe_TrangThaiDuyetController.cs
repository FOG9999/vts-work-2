...
{
    public class PhanHe_TrangThaiDuyetController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaTrangThaiDuyet)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_PhanHe_TrangThaiDuyet", "Edit") == false ||
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaTrangThaiDuyet)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaTrangThaiDuyet)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_PhanHe(String MaTrangThaiDuyet)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_PhanHeSubmit(String ParentID, String MaTrangThaiDuyet)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_PhanHe_TrangThaiDuyet", "Edit") == false ||
                !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SubmitEdit(String ParentID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                String MaPhanHe = Request.Form[ParentID + "_iID_MaPhanHe"];
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String MaPhanHe)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String ParentID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                String MaPhanHe = Request.Form[ParentID + "_iID_MaPhanHe"];
