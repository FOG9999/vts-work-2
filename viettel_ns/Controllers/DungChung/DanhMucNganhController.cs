...
{
    public class DanhMucNganhController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID, int? page)
        {
            ...
            {
                if (MucLucNganSach_NganhModels.CheckTonTaiMaNganh(sMaNguoiQuanLy,iID_MaNganh))
                {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ThemDanhMucNganh()
        {
            int iNamLamViec = Convert.ToInt16(ReportModels.LayNamLamViec(User.Identity.Name));
            SqlCommand cmd = new SqlCommand("ChuyenDSNganhNganh");
