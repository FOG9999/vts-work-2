...
namespace VIETTEL.Controllers.DungChung
{
    public class NguoiDungDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /NguoiDungDonVi/
        public string sViewPath = "~/Views/DungChung/NguoiDungDonVi/";
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String Code)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Edit") == false)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Add(String Code)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Edit") == false)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditNew(String Code)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Edit") == false)
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String Code)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Edit") == false)
                ...
                bang.IPSua = Request.UserHostAddress;
                bang.TruyenGiaTri(ParentID, Request.Form);
                bang.CmdParams.Parameters.AddWithValue("@iNamLamViec", ReportModels.LayNamLamViec(User.Identity.Name));
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult EditDetail(String Code, String NguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["DuLieuMoi"] = "0";
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult DeleteDetail(String Code, String NguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Delete") == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String Code)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_DonVi", "Delete") == false)
