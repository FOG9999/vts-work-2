...
{
    public class PhongBanLNSController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /PhongBanLNS/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult EditDetail(String Code, String MaID, String LNS)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                //if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_PhongBan_LoaiNganSach", "Edit") == false)
