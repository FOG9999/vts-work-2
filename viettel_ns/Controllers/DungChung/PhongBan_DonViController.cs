...
{
    public class PhongBan_DonViController : Microsoft.AspNetCore.Mvc.Controller
    {        
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(string phongban)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult PhongBan_DonVi_Index_Frame()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult PhongBan_DonVi_Edit_Frame(string phongban, string LuuThanhCong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(string phongban)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
