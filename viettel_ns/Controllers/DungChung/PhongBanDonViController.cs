...
{
    public class PhongBanDonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /PhongBanDonVi/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult EditDetail(String Code, String MaID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                //if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_PhongBan_DonVi", "Edit") == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult DeleteDetail(String Code, String MaID)
        {
