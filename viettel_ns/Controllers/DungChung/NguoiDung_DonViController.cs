...
{
    public class NguoiDung_DonViController : Microsoft.AspNetCore.Mvc.Controller
    {        
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(string maND)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult NguoiDung_DonVi_Index_Frame()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult NguoiDung_DonVi_Edit_Frame(string maND, string LuuThanhCong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(string maND)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
