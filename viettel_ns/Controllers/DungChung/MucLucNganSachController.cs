...
{
    public class MucLucNganSachController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /MucLucNganSach/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaMucLucNganSach)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult MLNSChiTiet_Frame(String sLNS,String LuuThanhCong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult CauHinh()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult CauHinh_Submit(String ParentID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
...
");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult LocSubmit(String ParentID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                String sLNS = Request.Form[ParentID + "_sLNS"];
