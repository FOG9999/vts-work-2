...
{
    public class NguoiDungPhongBanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String sMaNguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_PhongBan", "Edit") == false)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Add(String sMaNguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_PhongBan", "Edit") == false)
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditNew(String sMaNguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_PhongBan", "Edit") == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult EditDetail(String sMaNguoiDung, String MaNguoiDungPhongBan)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                //if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_PhongBan", "Edit") == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult DeleteDetail(String sMaNguoiDung, String MaNguoiDungPhongBan)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String sMaNguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_NguoiDung_PhongBan", "Delete") == false)
