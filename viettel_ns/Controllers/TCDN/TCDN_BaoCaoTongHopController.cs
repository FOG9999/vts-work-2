...
{
    public class TCDN_BaoCaoTongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult List(String iQuy, String iNam)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iQuy, String iNam, String iID_MaLoaiDoanhNghiep)
        {
            String MaND = User.Identity.Name;
            if (BaoMat.ChoPhepLamViec(MaND, "TCDN_BaoCaoTongHop", "Edit") == false)
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Reports(String iNamLamViec, String iQuy, String iID_MaLoaiDoanhNghiep)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iQuy, String iNam)
        {
            String MaND = User.Identity.Name;
