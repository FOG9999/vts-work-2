...
{
    public class TCDN_HoSoDoanhNghiepController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDoanhNghiep, String iQuy)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaDoanhNghiep, String iQuy)
        {
            String MaND = User.Identity.Name;
