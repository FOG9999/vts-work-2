...
{
    public class TCDN_HoSoDoanhNghiep_ChiTieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaChiTieuHoSo_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChiTieuHoSo, String iID_MaChiTieuHoSo_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_HoSoDoanhNghiep_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaChiTieuHoSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_HoSoDoanhNghiep_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaChiTieuHoSo_Cha, String iID_MaChiTieuHoSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_HoSoDoanhNghiep_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaChiTieuHoSo_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_HoSoDoanhNghiep_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChiTieuHoSo, String iID_MaChiTieuHoSo_Cha)
        {
