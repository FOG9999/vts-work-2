...
{
    public class TCDN_KinhDoanh_ChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TCDN_KinhDoanh_ChungTu/
        public string sViewPath = "~/Views/TCDN/KinhDoanh/ChungTu/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            return View(sViewPath + "TCDN_KinhDoanh_ChungTu_Index.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String Loai)
        {
            ...
            return RedirectToAction("Index", "TCDN_KinhDoanh_ChungTu", new { Loai = Loai, iQuy = iQuy, SoChungTu = SoChungTu, TuNgay = TuNgay, DenNgay = DenNgay, iID_MaDoanhNghiep = iID_MaDoanhNghiep, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet });
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChungTu)
        {
            ...
            return View(sViewPath + "TCDN_KinhDoanh_ChungTu_Edit.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTu)
        {
            ...
            else
            {
                ...
                if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
                {
                    ...
                    TCDN_KinhDoanh_ChungTuChiTietModels.ThemChiTiet(MaChungTuAddNew, sLoai, MaND, Request.UserHostAddress);
                    TCDN_KinhDoanh_ChungTuModels.InsertDuyetChungTu(MaChungTuAddNew, "Mới mới", User.Identity.Name, Request.UserHostAddress);
                }
                else
                {
            ...
            return RedirectToAction("Index", "TCDN_KinhDoanh_ChungTu");
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_KinhDoanh_ChungTu", "Delete") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
            int iXoa = 0;
            iXoa = TCDN_KinhDoanh_ChungTuModels.Delete_ChungTu(iID_MaChungTu, Request.UserHostAddress, User.Identity.Name);
            return RedirectToAction("Index", "TCDN_KinhDoanh_ChungTu");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTu)
        {
            ...
            TCDN_KinhDoanh_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TrinhDuyet, true, MaND, Request.UserHostAddress);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = TCDN_KinhDoanh_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, MaND, Request.UserHostAddress);

            ///Update Mã duyệt chứng từ cuối vào bảng chứng từ
            SqlCommand cmd;
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaDuyetChungTuCuoiCung", MaDuyetChungTu);
            TCDN_KinhDoanh_ChungTuModels.UpdateRecord(iID_MaChungTu, cmd.Parameters, User.Identity.Name, Request.UserHostAddress);
            cmd.Dispose();

            int iID_MaTrangThaiTuChoi = TCDN_KinhDoanh_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_TrinhDuyet(MaND, iID_MaChungTu);
            return RedirectToAction("Index", "TCDN_KinhDoanh_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu });
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTu)
        {
            ...
            TCDN_KinhDoanh_DuyetChungTuModels.CapNhapLaiTruong_sSua(iID_MaChungTu);

            ///Update trạng thái cho bảng chứng từ
            TCDN_KinhDoanh_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TuChoi, false, MaND, Request.UserHostAddress);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = TCDN_KinhDoanh_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, NoiDung, Request.UserHostAddress);

            ///Update Mã duyệt chứng từ cuối vào bảng chứng từ
            SqlCommand cmd;
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaDuyetChungTuCuoiCung", MaDuyetChungTu);
            TCDN_KinhDoanh_ChungTuModels.UpdateRecord(iID_MaChungTu, cmd.Parameters, MaND, Request.UserHostAddress);
            cmd.Dispose();
