...
{
    public class TCDN_ChiTieuTaiChinhController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TCDN_ChiTieuTaiChinh/
        public string sViewPath = "~/Views/TCDN/HoSoDoanhNghiep/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            return View(sViewPath + "TCDN_ChiTieuTaiChinh_Index.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult List(String iQuy, String iNam, String iID_MaDoanhNghiep)
        {
            String MaND = User.Identity.Name;
            if (BaoMat.ChoPhepLamViec(MaND, "TCDN_ChiTieuTaiChinh", "Edit") == false)
            {
                //Phải có quyền thêm chứng từ
                return RedirectToAction("Index", "PermitionMessage");
            }
            Boolean bCheck = TCDN_ChiTieuTaiChinhModels.CheckData(iQuy, iNam, iID_MaDoanhNghiep);
            if (bCheck == false)
            {
                //Thêm dữ liệu ban đầu vào bảng TCDN_ChiTieuTaiChinh
                TCDN_ChiTieuTaiChinhModels.ThemChiTiet(iID_MaDoanhNghiep, iQuy, iNam, MaND, Request.UserHostAddress);
            }

            return RedirectToAction("Edit", "TCDN_ChiTieuTaiChinh", new { iID_MaDoanhNghiep = iID_MaDoanhNghiep, iQuy = iQuy, iNam = iNam });
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDoanhNghiep,String iQuy, String iNam)
        {
            String MaND = User.Identity.Name;
            ...
            ViewData["iQuy"] = iQuy;
            ViewData["iNam"] = iNam;
            return View(sViewPath + "TCDN_ChiTieuTaiChinh_Edit.aspx");
        }
        [Authorize]
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaDoanhNghiep, String iQuy, String iNam)
        {
            String MaND = User.Identity.Name;
