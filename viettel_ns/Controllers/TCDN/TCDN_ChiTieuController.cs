...
{
    public class TCDN_ChiTieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TCDN_ChiTieu/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaChiTieu_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChiTieu, String iID_MaChiTieu_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaChiTieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaChiTieu_Cha, String iID_MaChiTieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaChiTieu_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TCDN_ChiTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChiTieu, String iID_MaChiTieu_Cha)
        {
