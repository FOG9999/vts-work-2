...
{
    public class TuLieu_DanhMucController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuLieu_DanhMuc/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaKieuTaiLieu_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaKieuTaiLieu, String iID_MaKieuTaiLieu_Cha)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaKieuTaiLieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_DanhMucTaiLieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaKieuTaiLieu_Cha, String iID_MaKieuTaiLieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_DanhMucTaiLieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaKieuTaiLieu_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_DanhMucTaiLieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaKieuTaiLieu, String iID_MaKieuTaiLieu_Cha)
        {
