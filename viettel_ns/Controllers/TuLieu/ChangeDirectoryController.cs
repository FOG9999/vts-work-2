...
{
    public class ChangeDirectoryController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /ChangeDirectory/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult submit(string ParentID, string sessionName, string contronllerName )
        {
            try
            {
    ...
    [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SubFoldersubmit( string path, string sessionName, string contronllerName)
        {
            try
            {
                // TODO: Add delete logic here
        ...
        [Authorize]
    public Microsoft.AspNetCore.Mvc.ActionResult SaveSubmit(string path, string sessionName, string contronllerName)
        {
            try
            {
                // TODO: Add delete logic here
