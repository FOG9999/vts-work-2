...
{
    public class ChangeDirectoryV2Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /ChangeDirectory/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult submit(string ParentID, string contronllerName)
        {
            try
            {
    ...
    [Authorize]
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
    public Microsoft.AspNetCore.Mvc.ActionResult SaveSubmit(string ParentID, string contronllerName)
        {
            try
            {
