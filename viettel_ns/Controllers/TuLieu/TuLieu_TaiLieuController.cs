...
{
    public class TuLieu_TaiLieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuLieu_TaiLieu/
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaTaiLieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_TaiLieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
    ...
    public class DownloadResult : Microsoft.AspNetCore.Mvc.ActionResult
    {
