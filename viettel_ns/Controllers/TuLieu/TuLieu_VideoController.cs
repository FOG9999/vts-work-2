...
{
    public class TuLieu_VideoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuLieu_Video/
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaTaiLieu, string path)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_Video", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
