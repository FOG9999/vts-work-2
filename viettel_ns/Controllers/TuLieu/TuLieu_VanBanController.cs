...
{
    public class TuLieu_VanBanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuLieu_TaiLieu/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String MaKieuTaiLieu)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult List(String MaKieuTaiLieu)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaTaiLieu, string path)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(String MaTaiLieu, string path)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_VanBan", "Detail") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail_LichLamViec(String MaTaiLieu, string path)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_VanBan", "Detail") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaTaiLieu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaTaiLieu, String MaKieuTaiLieu, string path)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_VanBan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaTuLieu)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaTuLieu)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Download(String MaTaiLieu)
        {
