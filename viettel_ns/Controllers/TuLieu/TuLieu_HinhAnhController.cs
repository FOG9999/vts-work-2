...
{
    public class TuLieu_HinhAnhController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuLieu_TaiLieu/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaTaiLieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_Anh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaTaiLieu, String selectPath)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "TL_Anh", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
