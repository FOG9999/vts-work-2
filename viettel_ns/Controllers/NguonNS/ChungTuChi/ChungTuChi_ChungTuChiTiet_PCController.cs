...
{
    public class ChungTuChi_ChungTuChiTiet_PCController : AppController
    {
        private readonly INguonNSService _nguonNSService = NguonNSService.Default;

        public string sViewPath = "~/Views/NguonNS/ChungTuChi/ChungTuChiTietPhanCap/";

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string Id_CTChi, string Id_NguonBTC)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame(string Ma_Nguon)
        {
            string Id_CTChi = Request.Form["ChungTuChi_ChungTuChiTiet_Id_CTChi"];
            string Id_NguonBTC = Request.Form["ChungTuChi_ChungTuChiTiet_Id_NguonBTC"];
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(string Id_CTChi, string Id_NguonBTC)
        {
                ...
                if (arrMaHang[i] != "")
                {
                    ...
                    else
                    {
                        ...
                        if (okCoThayDoi)
                        {
                            ...
                            {
                                bang.DuLieuMoi = true;
                                bang.CmdParams.Parameters.AddWithValue("@Id_CTChi", Id_CTChi);
                                bang.CmdParams.Parameters.AddWithValue("@Id_NguonBTC", Id_NguonBTC);
                                bang.CmdParams.Parameters.AddWithValue("@Id_ChiBQP", Id_BQP);
                                bang.CmdParams.Parameters.AddWithValue("@Id_MaDonVi", "00");
                                bang.CmdParams.Parameters.AddWithValue("@Id_PhongBan", "02");
            ...
            _nguonNSService.UpdateSotienChungTu("Nguon_CTChi", Id_CTChi);

            return RedirectToAction("ChungTuChiTiet_Frame", new { Id_CTChi = Id_CTChi, Id_NguonBTC = Id_NguonBTC, Ma_Nguon = arrGiaTriTimKiem["Ma_Nguon"] });
        }
    }
}
