...
namespace VIETTEL.Controllers.NguonNS
{
    public class ChungTuThu_ChungTuChiTietController : AppController
    {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string Id_CTThu)
        {
            ViewData["Id_CTThu"] = Id_CTThu;
            return View(sViewPath + "ChungTuChiTiet_Index.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame(string Ma_CTMT, string L, string K, string Ma_Nguon)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(string Id_CTThu, string Id_NguonBTC)
        {
