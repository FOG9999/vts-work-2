...
{
    public class Nguon_DMBTCController : Microsoft.AspNetCore.Mvc.Controller
    {        
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Nguon_DMBTC_Edit_Frame(string LuuThanhCong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
