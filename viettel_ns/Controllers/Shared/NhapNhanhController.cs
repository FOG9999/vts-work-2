...
{
    public class NhapNhanhController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /NhapNhanh/
        ...
        public JavaScriptResult Index(string id, string OnSuccess, string OnLoad)
        {
            ...
            switch (id.ToUpper())
            {
                ...
                case "CAPPHAT_THONGTRI":
                    ViewData["Partial_View"] = "~/Report_Views/CapPhat/rptCapPhat_ThongTri.aspx";
                    break;
                ...
                case "QUYETTOAN_BAOCAOTHONGTRI":
                    ViewData["Partial_View"] = "~/Report_Views/QuyetToan/QuyetToanQuy/rptQuyetToan_ThongTri.aspx";
                    break;
                //Du Toan
                ...
                case "DUTOANBS_BAOCAOINKIEM_GOM":
                    ViewData["Partial_View"] = "~/Views/DuToanBS/ChungTuChiTiet/DuToanBS_BaoCaoInKiem.aspx";
                    break;
                ...
                case "DUTOANBS_TUYCHINH":
                    ...
                    break;
                case "DUTOANBS_SAOCHEP":
                    ViewData["Partial_View"] = "~/Views/DuToanBS/ChungTuChiTiet/DuToan_SaoChep.aspx";
                    break;
                //cap phat
                case "CAPPHAT_TUYCHINH":
                    ViewData["Partial_View"] = "~/Views/CapPhat/ChungTuChiTiet/CapPhat_TuyChinh.aspx";
                    break;
                ...
                case "THUNOP_THONGTRI":
                    ViewData["Partial_View"] = "~/Views/Report_Views/ThuNop/ThongTri/rptThuNop_ThongTri.aspx";
                    break;
                case "THUNOP_INKIEM":
                    ViewData["Partial_View"] = "~/Report_Views/ThuNop/rptThuNop_InKiem.aspx";
                    break;
                //TCDN
