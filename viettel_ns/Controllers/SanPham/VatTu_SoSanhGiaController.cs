...
{
    public class VatTu_SoSanhGiaController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /SanPham/
        ...
        /// </summary>
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String ParentID)
        {
        ...
        public static DataTable Get_DanhSachVatTu(String sMa,String sTen, String sTenSanPham, int Nam, int NamSoSanh, int KieuSoSanh, String LoaiNganSach, int Trang = 1, int SoBanGhi = 0)
        {
            DataTable vR;
            ...
            {
                DK += " AND DM_VatTu.sMaVatTu LIKE @sMa";
        ...
        public static int Get_DanhSachVatTu_Count(String sMa,String sTen, String sTenSanPham, int Nam)
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand();
            //String DK = LuongCongViecModel.Get_DieuKien_TrangThaiDuyet_DuocXem(QuyetToanModels.iID_MaPhanHeQuyetToan, MaND);
