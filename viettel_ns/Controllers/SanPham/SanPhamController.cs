...
namespace VIETTEL.Controllers.SanPham
{
    public class SanPhamController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaSanPham)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaSanPham)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, " DM_SanPham", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaSanPham)
        {
            Bang bang = new Bang("DM_SanPham");
            bang.GiaTriKhoa = iID_MaSanPham;
            bang.Delete();
