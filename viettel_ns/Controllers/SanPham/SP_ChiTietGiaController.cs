...
{
    public class SP_ChiTietGiaController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /BaoHiem_ChungTuChiChiTiet/
        public string sViewPath = "~/Views/SanPham/ChiTietGia/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String ParentID, String iID_MaSanPham)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ViewData["iID_MaSanPham"] = iID_MaSanPham;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaChiTietGia)
        {
            ...
            if (String.IsNullOrEmpty(iID_MaChiTietGia))
            {
                ...
                DataTable dtSanPhamMoi = SanPham_VatTuModels.Get_SanPham_DanhMucGia(iID_MaSanPham);
                String iID_MaSanPhamCopy =Convert.ToString(CommonFunction.LayTruong("DM_SanPham", "iID_MaSanPham", iID_MaSanPham, "iID_MaSanPhamCopy"));
                DataTable dtSanPhamCopy = SanPham_VatTuModels.Get_SanPham_DanhMucGia(iID_MaSanPhamCopy);
                ...
                for (int i = 0; i < dtSanPhamCopy.Rows.Count; i++)
                {
                    for (int j = 0; j < dtSanPhamMoi.Rows.Count; j++)
                    {
                        ...
                        if (dtSanPhamCopy.Rows[i]["sTen"].ToString() == dtSanPhamMoi.Rows[j]["sTen"].ToString() && dtSanPhamCopy.Rows[i]["sKyHieu"].ToString() == dtSanPhamMoi.Rows[j]["sKyHieu"].ToString())
                        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChiTietGia, String iID_MaSanPham)
        {
            Bang bang = new Bang("DM_SanPham_ChiTietGia");
            bang.GiaTriKhoa = iID_MaChiTietGia;
            bang.Delete();
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTiet(String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ViewData["iID_MaSanPham"] = iID_MaSanPham;
            ViewData["iID_MaChiTietGia"] = iID_MaChiTietGia;
            //String SQL = String.Format(@"UPDATE DM_SanPham_DanhMucGia SET iID_MaChiTietGia=@iID_MaChiTietGia WHERE iID_MaSanPham=@iID_MaSanPham AND iID_MaLoaiHinh=0");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTiet_NS(String iID_MaSanPham, String iID_MaChiTietGia)
        {
            ViewData["iID_MaSanPham"] = iID_MaSanPham;
            ViewData["iID_MaChiTietGia"] = iID_MaChiTietGia;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaSanPham, String iID_MaChiTietGia, String iID_LoaiDonVi)
        {
