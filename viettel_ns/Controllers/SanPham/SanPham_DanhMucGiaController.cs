...
{
    public class SanPham_DanhMucGiaController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: / SanPham_DanhMucGia/
        public string sViewPath = "~/Views/SanPham/DanhMucGia/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iID_MaSanPham, String iID_MaLoaiHinh)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDanhMucGia, String iID_MaDanhMucGia_Cha, String iID_MaSanPham, String iID_MaLoaiHinh)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaDanhMucGia)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DM_SanPham_DanhMucGia", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaDanhMucGia_Cha, String iID_MaDanhMucGia, String iID_MaSanPham, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DM_SanPham_DanhMucGia", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaDanhMucGia_Cha, String iID_MaSanPham, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DM_SanPham_DanhMucGia", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaDanhMucGia, String iID_MaSanPham, String iID_MaLoaiHinh)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Frame(String iID_MaSanPham, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, " DM_SanPham_DanhMucGia", "List") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ChooseSubmit(String ParentID, String iID_MaDanhMucGia, String iID_MaSanPham, String iID_MaLoaiHinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DM_SanPham_DanhMucGia", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
