...
{
    public class SanPham_MauDanhMucController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDanhMuc, String iID_MaDanhMucCha)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaDanhMuc)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DC_DanhMuc", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaDanhMucCha, String iID_MaDanhMuc)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DC_DanhMuc", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaDanhMucCha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DC_DanhMuc", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaDanhMuc)
        {
