...
{
    public class SanPham_SoSanhGiaController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /SanPham/
        ...
        public static DataTable Get_DanhSachSanPham(String sMa,String sTen, int Nam, int NamSoSanh, int Trang = 1, int SoBanGhi = 0)
        {
            DataTable vR;
            ...
            {
                DK += " AND DM_SanPham.sMa LIKE @sMa";
        ...
        public static int Get_DanhSachSanPham_Count(String sMa,String sTen, int Nam)
        {
            DataTable vR;
            SqlCommand cmd = new SqlCommand();
            //String DK = LuongCongViecModel.Get_DieuKien_TrangThaiDuyet_DuocXem(QuyetToanModels.iID_MaPhanHeQuyetToan, MaND);
