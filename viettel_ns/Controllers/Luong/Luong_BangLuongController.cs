...
{
    public class Luong_BangLuongController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /Luong/
        public string sViewPath = "~/Views/Luong/BangLuong/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(int? BangLuong_page,String iNamLamViec,String iThangLamViec)
        {   
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(String iID_MaBangLuong)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaBangLuong,String iNamLamViec,String iThangLamViec)
        {
            Bang bang = new Bang("L_BangLuong");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Get)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaBangLuong, String iNamLamViec, String iThangLamViec)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaBangLuong, String Detail)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaBangLuong, String Detail)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        public String obj_CauHinhLuong(String MaND, String iThangLamViec, String iNamLamViec)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (LuongMoi)
                {
                    stbCB += MyHtmlHelper.ActionLink(Url.Action("Delete", "Luong_BangLuong", new { iID_MaBangLuong = R["iID_MaBangLuong"], iNamBangLuong = R["iNamBangLuong"], iThangBangLuong = R["iThangBangLuong"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                }
                stbCB += "</td></tr>";
            }
