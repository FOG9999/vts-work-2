...
{
    public class QuyetToan_QuanSo_MucLucQuanSoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaMucLucQuanSo_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaMucLucQuanSo, String iID_MaMucLucQuanSo_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucQuanSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaMucLucQuanSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucQuanSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaMucLucQuanSo_Cha, String iID_MaMucLucQuanSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucQuanSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaMucLucQuanSo_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "NS_MucLucQuanSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaMucLucQuanSo, String iID_MaMucLucQuanSo_Cha)
        {
