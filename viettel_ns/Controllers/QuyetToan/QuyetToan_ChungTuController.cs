...
{
    public class QuyetToan_ChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String Loai)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChungTu, String Loai)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        [ValidateInput(false)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTu, String Loai)
        {
            String MaND = User.Identity.Name;
            ...
            String iID_MaDonVi = String.IsNullOrEmpty(MaChungTu) ? Convert.ToString(Request.Form[ParentID + "_iID_MaDonVi"]) : dtChungTu.Rows[0]["iID_MaDonVi"].ToString();
            String sNoiDung = Convert.ToString(Request.Form[ParentID + "_sNoiDung"]);

            //String sLNS = Convert.ToString(Request.Form[ParentID + "_sLNS"]);

            var sLNS = Request.Form["sLNS"] ?? Convert.ToString(Request.Form[ParentID + "_sLNS"]);
            ...
            else
            {
                ...
                if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
                {
                    ...
                    bang.CmdParams.Parameters.AddWithValue("@iID_MaTrangThaiDuyet", LuongCongViecModel.Get_iID_MaTrangThaiDuyetMoi(QuyetToanModels.iID_MaPhanHeQuyetToan, username: MaND));
                    MaChungTuAddNew = Convert.ToString(bang.Save());

                    //code them update dt tu ns+thanh

                    //                     SqlCommand cmd1 = new SqlCommand();
                    //                     String SQL1 = String.Format(@"INSERT INTO QTA_chungtuchitiet
                    //(iID_MaChungTu,iID_MaPhongBan,iID_MaTrangThaiDuyet,iNamLamViec,iID_MaNguonNganSach,
                    //iID_MaNamNganSach,iThang_Quy,bLoaiThang_Quy,iID_MaDonVi,sXauNoiMa,sLNS,sL,sK,sM,sTM,sTTM,sNG,
                    //rTuChi,rDonViDeNghi,brTuChi,sID_MaNguoiDung_DuocGiao,sID_MaNguoiDungTao,iID_MaMucLucNganSach,iID_MaMucLucNganSach_Cha)
                    //SELECT @MaChungtu,Bql,128,@NamLamViec,'1','2',qui,'0',Dvi,
                    //LNS+'-'+l+'-'+k+'-'+m+'-'+tm+'-'+ttm+'-'+ng,lns,l,k,m,tm,ttm,ng,tuchi,tuchi,1,@sID_MaNguoiDungTao,@sID_MaNguoiDungTao,'2A8E5161-A9CC-445D-AD06-2CCCF980986D','D8B49919-B56A-4C9B-A01F-89FFE1D6012E'
                    //FROM [VNS_T].[dbo].[QToan]
                    //WHERE BQL=@MaPhongBan
                    //--AND SUBSTRING(LNS,1,1)=2 
                    //AND  lns LIKE @lns
                    //AND qui=@quy AND dvi=@dvi
                    //
                    //--SELECT @MaChungtu,Bql,128,@NamLamViec,'1','2',qui,'0',Dvi,
                    //--LNS+'-'+l+'-'+k+'-'+m+'-'+tm+'-'+ttm+'-'+ng,lns,l,k,m,tm,ttm,ng,tuchi,tuchi,1,@sID_MaNguoiDungTao,@sID_MaNguoiDungTao,'2A8E5161-A9CC-445D-AD06-2CCCF980986D','D8B49919-B56A-4C9B-A01F-89FFE1D6012E'
                    //--FROM QT
                    ...
                    //----AND SUBSTRING(LNS,1,1)=2 
                    //--AND  lns LIKE @lns+'%'
                    //--AND qui=1 AND dvi=@dvi
                    //
                    //
                    //UPDATE QTA_chungtuchitiet
                    //SET sTenPhongBan=iID_MaPhongBan+ ' - B'+SUBSTRING(iID_MaPhongBan,2,1)
                    //,iID_MaMucLucNganSach_Cha=(SELECT iID_MaMucLucNganSach_Cha FROM NS_MucLucNganSach WHERE iNamLamViec=2017 AND NS_MucLucNganSach.iTrangThai=1 AND QTA_chungtuchitiet.sXauNoiMa=NS_MucLucNganSach.sXauNoiMa)
                    //,sTenDonVi=(SELECT sTen FROM NS_DonVi WHERE iNamLamViec_Donvi=2017 AND NS_DonVi.iID_MaDonVi=QTA_chungtuchitiet.iID_MaDonVi)
                    //,iID_MaMucLucNganSach=(SELECT iID_MaMucLucNganSach FROM NS_MucLucNganSach WHERE iNamLamViec=2017 AND NS_MucLucNganSach.iTrangThai=1 AND  QTA_chungtuchitiet.sXauNoiMa=NS_MucLucNganSach.sXauNoiMa)
                    //,sMoTa=(SELECT sMoTa FROM NS_MucLucNganSach WHERE NS_MucLucNganSach.iTrangThai=1 AND NS_MucLucNganSach.iNamLamViec=2017  AND QTA_chungtuchitiet.sXauNoiMa=NS_MucLucNganSach.sXauNoiMa)
                    //WHERE iID_MaChungTu=@MaChungtu");
                    //                     cmd1.CommandText = SQL1;
                    //                     cmd1.Parameters.AddWithValue("@MaChungtu", MaChungTuAddNew);
                    //                     cmd1.Parameters.AddWithValue("@NamLamViec", 2017);
                    //                     cmd1.Parameters.AddWithValue("@sID_MaNguoiDungTao", MaND);
                    //                     cmd1.Parameters.AddWithValue("@MaPhongBan", iID_MaPhongBan);
                    //                     cmd1.Parameters.AddWithValue("@lns", sLNS + "%");
                    //                     cmd1.Parameters.AddWithValue("@quy", iThang);
                    //                     cmd1.Parameters.AddWithValue("@dvi", iID_MaDonVi);
                    //                     var a = Connection.GetValue(cmd1, -1);
                ...
                else
                {
                    ...
                    String SQL = "UPDATE QTA_ChungTuChiTiet SET iID_MaPhongBan=@iID_MaPhongBan,sTenPhongBan=@sTenPhongBan, iID_MaTrangThaiDuyet=@iID_MaTrangThaiDuyet, " +
                            ...
                            "iThang_Quy=@iThang_Quy,bLoaiThang_Quy=@bLoaiThang_Quy,iID_MaDonVi=@iID_MaDonVi,sTenDonVi=@sTenDonVi " +
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_Fast_Submit(String ParentID, String MaChungTu, String Loai)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[ParentID + "_DuLieuMoi"] == "1" && LuongCongViecModel.NguoiDung_DuocThemChungTu(QuyetToanModels.iID_MaPhanHeQuyetToan, MaND) == false)
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_NhaMuoc_Submit(String ParentID, String MaChungTu, String Loai)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[ParentID + "_DuLieuMoi"] == "1" && LuongCongViecModel.NguoiDung_DuocThemChungTu(QuyetToanModels.iID_MaPhanHeQuyetToan, MaND) == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu, String Loai)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SearchDuyetSubmit(String ParentID, String Loai)
        {
            String TuNgay = Request.Form[ParentID + "_" + NgonNgu.MaDate + "dTuNgay"];
            String DenNgay = Request.Form[ParentID + "_" + NgonNgu.MaDate + "dDenNgay"];
            String SoChungTu = Request.Form[ParentID + "_iSoChungTu"];
        ...
        //TuChoi khi da duyet
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoiDuyet(String iID_MaChungTu, String Loai)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
            int iID_MaTrangThaiDuyet_TuChoi = QuyetToan_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_TuChoi(MaND, iID_MaChungTu);
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChuyenNamSau()
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_ChuyenNamSau()
        {
            String MaND = User.Identity.Name;
