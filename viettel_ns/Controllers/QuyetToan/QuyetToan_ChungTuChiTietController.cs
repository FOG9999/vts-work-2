...
{
    public class QuyetToan_ChungTuChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index_BH()
        {
            return View(sViewPath + "QuyetToan_BaoHiem_Index.aspx");
        }
        //Giải thích số tiền
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index_GTST()
        {
            return View(sViewPath + "QuyetToan_GiaiThichSoTien_Dialog.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame(string sLNS, string sL, string sK, string sM, string sTM, string sTTM, string sNG, string sTNG, string iID_MaDonVi, String MaLoai)
        {
        ...
        //Giải thích bằng lời
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index_GTBL()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaChungTu,String MaLoai)
        {
            ...
            ViewData["LoadLai"] = "";
            ViewData["MaLoai"] = MaLoai;
            ViewData["sLNS"] = arrGiaTriTimKiem["sLNS"];
            ViewData["sL"] = arrGiaTriTimKiem["sL"];
            ViewData["sK"] = arrGiaTriTimKiem["sK"];
            ViewData["sM"] = arrGiaTriTimKiem["sM"];
            ViewData["sTM"] = arrGiaTriTimKiem["sTM"];
            ViewData["sTTM"] = arrGiaTriTimKiem["sTTM"];
            ViewData["sNG"] = arrGiaTriTimKiem["sNG"];
            ViewData["sTNG"] = arrGiaTriTimKiem["sTNG"];
            ViewData["iID_MaDonVi"] = arrGiaTriTimKiem["iID_MaDonVi"];
            return View(sViewPath + "QuyetToan_ChungTuChiTiet_Index_DanhSach_Frame.aspx");
        }

        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit_BH(String iID_MaChungTu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit_GTBL(String iID_MaChungTu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult GiaiThichSoTien_Submit(String ParentID, String iID_MaChungTu)
        {
