...
{
    public class KeToanTongHop_CanDoiThuChiTaiChinhController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iNam, String iQuy, String iLoai)
        {
...
UPDATE KT_CanDoiThuChiTaiChinh set bLaHangCha=0 where bLaHangCha=1 AND iNam=@iNam AND iQuy=@iQuy and not exists (select iID_MaThuChi from KT_CanDoiThuChiTaiChinh ct where ct.iTrangThai=1 AND ct.iNam=@iNam AND ct.iQuy=@iQuy AND ct.sKyHieu_Cha=KT_CanDoiThuChiTaiChinh.sKyHieu);");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_ThuChi(String ParentID)
        {
