...
{
    public class TuDienController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /TuDien/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Add(String iID_MaTaiKhoanGoc)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaTuDien, String iID_MaTaiKhoanGoc)
        {
            ViewData["DuLieuMoi"] = "0";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult AddSubmit(String ParentID)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaTuDien)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_TuDien", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaTuDien)
        {
