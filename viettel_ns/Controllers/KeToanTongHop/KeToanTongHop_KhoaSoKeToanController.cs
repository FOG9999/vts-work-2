...
{
    public class KeToanTongHop_KhoaSoKeToanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String ParentID, String iNam)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult BangCanDoiTaiKhoan()
        {
            return View(sViewPath + "KeToanTongHop_BangCanDoiKeToan_Index.aspx");
        }
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String iNam)
        {
            String MaND = User.Identity.Name;
            String iThang = Request.Form[ParentID + "_iThangKhoaSo"];
