...
{
    public class KeToanTongHop_ChungTuChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTu_Frame()
        {
            return View(sViewPath + "KeToanTongHop_ChungTu_Frame.aspx");
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame()
        {
...
//                }
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTietTuChoi()
        {
            return View(sViewPath + "KeToanTongHop_ChungTuChiTietTuChoi.aspx");
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTietTuChoi_Frame()
        {
            return View(sViewPath + "KeToanTongHop_ChungTuChiTietTuChoi_Frame.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Show_Dialog_Tao_CTGS()
        {
            return View(sViewPath + "KeToanTongHop_ChungTu_Dialog.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Show_Dialog_F12()
        {
