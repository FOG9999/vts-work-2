...
{
    public class LoaiTaiKhoanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /LoaiTaiKhoan/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaTaiKhoan_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaTaiKhoan, String iID_MaTaiKhoan_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_TaiKhoan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaTaiKhoan)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_TaiKhoan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaTaiKhoan_Cha, String iID_MaTaiKhoan)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_TaiKhoan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaTaiKhoan_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_TaiKhoan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaTaiKhoan, String iID_MaTaiKhoan_Cha)
        {
