...
{
    public class KeToanTongHopController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /KeToanTongHop/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SoDoLuong()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                HamRiengModels.UserDefault(User.Identity.Name);
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult GiaiThichTaiKhoan_DauNam()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                HamRiengModels.UserDefault(User.Identity.Name);
