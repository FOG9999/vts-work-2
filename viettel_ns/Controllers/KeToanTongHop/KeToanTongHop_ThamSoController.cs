...
{
    public class KeToanTongHop_ThamSoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaThamSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_DanhMucThamSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaThamSo, String bChoPhepXoa)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaThamSo)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_DanhMucThamSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult CopyDuLieu(String ParentID)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_DanhMucThamSo", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
