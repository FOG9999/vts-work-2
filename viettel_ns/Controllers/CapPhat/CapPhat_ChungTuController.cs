...
{
    public class CapPhat_ChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /CapPhat_ChungTu/
        ...
        public static readonly string VIEW_ROOTPATH_CHUNGTU = "~/Views/CapPhat/ChungTu/";
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String MaDotNganSach, String sLNS, String DonVi, String Loai)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ...
                ViewData["Loai"] = Loai;
                return View(VIEW_ROOTPATH_CHUNGTU + VIEW_CAPPHAT_CHUNGTU_INDEX);
            }
            else
            {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChuyenNamSau(String MaDotNganSach, String sLNS, String DonVi)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ViewData["MaDotNganSach"] = MaDotNganSach;
                ViewData["sLNS"] = sLNS;
                ViewData["DonVi"] = DonVi;
                return View(VIEW_ROOTPATH_CHUNGTU + VIEW_CAPPHAT_CHUNGTU_CHUYENNAMSAU);
            }
            else
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiemChungTu(String ParentID, String DonVi, String Loai)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaChungTu(String iID_MaCapPhat, String Loai)
        {
            ...
            ViewData["Loai"] = Loai;
            return View(VIEW_ROOTPATH_CHUNGTU + VIEW_CAPPHAT_CHUNGTU_EDIT);
        }
        /// <summary>
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult LuuChungTu(String ParentID, String iID_MaCapPhat, String DonVi, String Loai)
        {
            String MaND = User.Identity.Name;
            ...
            if (Loai == "4")
            {
                sTienToChungTu = "Séc-DMNB-";
            }
            else
            {
                sTienToChungTu = PhanHeModels.LayTienToChungTu(PhanHeModels.iID_MaPhanHeCapPhat);
            }
            ...
            if (String.IsNullOrEmpty(sLNS))
            {
                if (Loai == "4")
                {
                    arrLoi.Add("err_sLNS", "Bạn chưa chọn ngành cấp!");
                }
                else
                {
                    arrLoi.Add("err_sLNS", "Bạn chưa chọn loại ngân sách!");
                }
            }
            if (arrLoi.Count > 0)
            {
            ...
            else
            {
                ...
                if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
                {
                    ...
                    bang.CmdParams.Parameters.AddWithValue("@sTienToChungTu", sTienToChungTu);
                    ...
                    if (Convert.ToString(Request.Form[ParentID + "_iID_MaTinhChatCapThu"]) == "-1")
                    {
                        bang.CmdParams.Parameters["@iID_MaTinhChatCapThu"].Value = DBNull.Value;
                    }
                    if (Convert.ToString(Request.Form[ParentID + "_iID_NguonDuToan"]) == "-1")
                    {
                        bang.CmdParams.Parameters["@iID_NguonDuToan"].Value = DBNull.Value;
                    }
                    ...
                    return RedirectToAction("Index", "CapPhat_ChungTuChiTiet", new { iID_MaCapPhat = MaChungTuAddNew, Loai = Loai });
                }
                else
                {
                    ...
                    var chungTu = CapPhat_ChungTuModels.LayChungTuCapPhat(iID_MaCapPhat).Rows[0];
                    if (string.IsNullOrEmpty(chungTu["iID_MaDonVi"].ToString()))
                    {

                        return RedirectToAction("Index", "CapPhat_ChungTu", new { Loai = Loai });
                    }
                    else
                    {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult XoaChungTu(String iID_MaCapPhat, String Loai)
        {
        ...
        //    return RedirectToAction("CapPhatChiTiet_Frame", "CapPhat_ChungTuChiTiet", new { iID_MaCapPhat = iID_MaCapPhat });
        //}
        ///// <summary>
