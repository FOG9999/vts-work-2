...
{
    public class CapPhat_ChungTuChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string DonVi, string iID_MaCapPhat)
        {
            int opt = 0;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult CapPhatChiTiet_Frame(string sLNS, string sL, string sK, string sM, string sTM, string sTTM, string sNG, string sTNG, string iID_MaDonVi, string iID_MaCapPhat, string f, string sMaLoai = "")
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult LuuChungTuChiTiet(string ChiNganSach, string iID_MaCapPhat, string DonVi)
        {
