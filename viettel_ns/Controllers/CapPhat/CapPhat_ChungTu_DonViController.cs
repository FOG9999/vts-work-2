...
{
    public class CapPhat_ChungTu_DonViController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <returns></returns>
        public Microsoft.AspNetCore.Mvc.ActionResult CapPhatChiTiet_Frame(String iID_MaCapPhat)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult LuuChungTu(String ParentID, String iID_MaCapPhat, String Loai)
        {
            String MaND = User.Identity.Name;
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaCapPhat, String sLyDo)
        {
            String MaND = User.Identity.Name;
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaCapPhat, String sLyDo)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet()
        {
            int opt = 0;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult LuuChungTuChiTiet(String iID_MaCapPhat)
        {
                ...
                if (arrMaHang[i] != "")
                {
                    ...
                    if (okCoThayDoi)
                    {
                        ...
                        if (MaChungTuChiTiet == "")
                        {
                            ...
                            bang.CmdParams.Parameters.AddWithValue("@bLoai", 0);
