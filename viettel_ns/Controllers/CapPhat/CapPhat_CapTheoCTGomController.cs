...
{
    public class CapPhat_CapTheoCTGomController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string id_chungtucp, string loai)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult InsertData(string id_chungtucp, string loai)
        {
