...
namespace VIETTEL.Controllers
{
    ...
    public class ChuKyController : AppController
    {
        ...
        // GET: ChuKy
        public Microsoft.AspNetCore.Mvc.ActionResult Sheet()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(string c, string tren = "", string duoi = "1,2,3,4,5", int popup = 0)
        {
            if ((string)TempData["isClosed"] == "1")
            {
                ViewBag.isClosed = 1;
            }
        ...
        [HttpPost]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(ChuKyViewModel vm, int popup = 0)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult DeletePhanHe(int id)
        {
            var success = false;
            var msg = string.Empty;
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SheetFrame(string filters = null)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(int? phanhe)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Copy(int phanhe = -1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult Copy(ChuKyCopyViewModel vm)
        {
