...
{
    public class KTCT_DuyetCapThuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String ParentID)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu_Duyet)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult AddNew()
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTTG_ChungTuCapThu_Duyet", "List") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DuyetSubmit(String iID_MaCapPhat)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaChungTu_Duyet)
        {
            SqlCommand cmd;
