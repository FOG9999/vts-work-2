...
{
    public class KeToanChiTietTienGuiController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /KeToanChiTietTienGui/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ...
                return View(sViewPath + "KeToanChiTiet_TienGui_ChungTu_Detail.aspx");
            }
            else
            {
