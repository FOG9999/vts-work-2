...
{
    public class KTCT_TienGui_ChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /KTCT_TienGui_ChungTu/
        public string sViewPath = "~/Views/KeToanChiTiet/TienGui/ChungTu/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            return View(sViewPath + "KTCT_TienGui_ChungTu_Index.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID)
        {
            ...
            return RedirectToAction("Index", "KTCT_TienGui_ChungTu", new { SoChungTu = SoChungTu, TuNgay = TuNgay, DenNgay = DenNgay, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet });
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChungTu)
        {
            ...
            if (BaoMat.ChoPhepLamViec(MaND, "KTTG_ChungTu", "Edit") == false)
            {
                //Phải có quyền thêm chứng từ
                return RedirectToAction("Index", "PermitionMessage");
            }
            ...
            return View(sViewPath + "KTCT_TienGui_ChungTu_Edit.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTu)
        {
            ...
            else
            {
                ...
                if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
                {
                    ...
                    //KTCT_TienGui_ChungTuChiTietModels.ThemChiTiet(MaChungTuAddNew, MaND, Request.UserHostAddress);
                    KTCT_TienGui_ChungTuModels.InsertDuyetChungTu(MaChungTuAddNew, "Mới mới", User.Identity.Name, Request.UserHostAddress);
                }
                else
                {
            ...
            return RedirectToAction("Index", "KTCT_TienGui_ChungTu");
        }

        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(int iNam, int iThang)
        {
            string idAction = Request.Form["idAction"];
            String MaND = User.Identity.Name;
            String IPSua = Request.UserHostAddress;

            String TenBangChiTiet = "KTTG_ChungTu";
            ...
            for (int i = 0; i < arrMaHang.Length; i++)
            {
                ...
                if (iHuyDuyet == "0" && arrHangDaXoa[i] == "1")
                {
                    ...
                    if (iID_MaChungTu != "")
                    {
                            ...
                            //Dữ liệu đã có
                            KTCT_TienGui_ChungTuModels.Delete_ChungTu(iID_MaChungTu, Request.UserHostAddress, User.Identity.Name);
                ...
                else
                {
                    ...
                    if (okCoThayDoi)
                    {
                        if (LuongCongViecModel.KiemTra_TroLyTongHop(MaND) || LuongCongViecModel.KiemTra_TroLyPhongBan(MaND))
                        {
                            ...
                            if (strSet != "")
                            {
                                cmdChungTuChiTiet.CommandText = String.Format("UPDATE KTTG_ChungTuChiTiet SET {0} WHERE iID_MaChungTu=@iID_MaChungTu", strSet);
                    ...
                    if (idAction == "1")
                    {
                        if (bChon)
                        {
                            KTCT_TienGui_ChungTuModels.TuChoiChungTu(iID_MaChungTu, MaND, IPSua);
                        }
                    }
                    else if (idAction == "2")
                    {
                        if (bChon)
                        {
                            KTCT_TienGui_ChungTuModels.TrinhDuyetChungTu(iID_MaChungTu, MaND, IPSua);
                        }
                    }
                }
            }
            ...
            //{
            //    KTCT_TienGui_ChungTuModels.TuChoiChungTu(iID_MaChungTu_Action, MaND, IPSua);
            //    id_iID_MaChungTu_Focus = iID_MaChungTu_Action;
            //}
            if (idAction == "1" && iHuyDuyet == "1")
            {
            ...
            //    }
            //}
            return RedirectToAction("ChungTu_Frame", "KTCT_TienGui_ChungTuChiTiet", new { iID_MaChungTu = id_iID_MaChungTu_Focus, sSoChungTu = sSoChungTu });
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTTG_ChungTu", "Delete") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
            int iXoa = 0;
            iXoa = KTCT_TienGui_ChungTuModels.Delete_ChungTu(iID_MaChungTu, Request.UserHostAddress, User.Identity.Name);
            return RedirectToAction("Index", "KTCT_TienGui_ChungTu");
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Duyet()
        {
            return RedirectToAction("Index", "KTCT_TienGui_ChungTu");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTu)
        {
            ...
            int iID_MaTrangThaiDuyet_TrinhDuyet = KTCT_TienGui_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_TrinhDuyet(MaND, iID_MaChungTu);
            ...
            KTCT_TienGui_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TrinhDuyet, true, MaND, Request.UserHostAddress);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = KTCT_TienGui_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, MaND, Request.UserHostAddress);

            ///Update Mã duyệt chứng từ cuối vào bảng chứng từ
            SqlCommand cmd;
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaDuyetChungTuCuoiCung", MaDuyetChungTu);
            KTCT_TienGui_ChungTuModels.UpdateRecord(iID_MaChungTu, cmd.Parameters, User.Identity.Name, Request.UserHostAddress);
            cmd.Dispose();

            int iID_MaTrangThaiTuChoi = KTCT_TienGui_ChungTuChiTietModels.Get_iID_MaTrangThaiDuyet_TrinhDuyet(MaND, iID_MaChungTu);
            return RedirectToAction("Index", "KTCT_TienGui_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu });
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTu)
        {
            ...
            ///Update trạng thái cho bảng chứng từ
            KTCT_TienGui_ChungTuModels.Update_iID_MaTrangThaiDuyet(iID_MaChungTu, iID_MaTrangThaiDuyet_TuChoi, false, MaND, Request.UserHostAddress);

            ///Thêm dữ liệu vào bảng duyệt chứng từ - Lấy mã duyệt chứng từ
            String MaDuyetChungTu = KTCT_TienGui_ChungTuModels.InsertDuyetChungTu(iID_MaChungTu, NoiDung, NoiDung, Request.UserHostAddress);

            ///Update Mã duyệt chứng từ cuối vào bảng chứng từ
            SqlCommand cmd;
            cmd = new SqlCommand();
            cmd.Parameters.AddWithValue("@iID_MaDuyetChungTuCuoiCung", MaDuyetChungTu);
            KTCT_TienGui_ChungTuModels.UpdateRecord(iID_MaChungTu, cmd.Parameters, MaND, Request.UserHostAddress);
            cmd.Dispose();
        ...
        {
            string strGiaTri = KTCT_TienGui_ChungTuModels.getSoChungTuGhiSo(iID_MaChungTu);
        ...
        {
            Boolean strGiaTri = KTCT_TienGui_ChungTuModels.KiemTra_sSoChungTu_Trung(iID_MaChungTu, sSoChungTu, iNamLamViec);
            return Json(strGiaTri, JsonRequestBehavior.AllowGet);
        }
        [Authorize]
        public JsonResult get_Check_iID_MaChungTu(String iID_MaChungTu)
        {
            Boolean Trung = KTCT_TienGui_ChungTuModels.KiemTra_iID_MaChungTu_Trung(iID_MaChungTu);
        ...
        public JsonResult CheckTrungSoGhiSo(String iID_MaChungTu, String sSoChungTu,String iNamLamViec)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM KTTG_ChungTu WHERE iID_MaChungTu=@iID_MaChungTu AND iTrangThai=1 ");
                ...
                {
                    DuLieuMoi = false;                
                    DataTable dt = KTCT_TienGui_ChungTuModels.GetChungTu(iID_MaChungTu);
            ...
            Boolean Trung = HamChung.Check_Trung("KTTG_ChungTu", "iID_MaChungTu", iID_MaChungTu, "sSoChungTu,iNamLamViec", sSoChungTu + "," + iNamLamViec, DuLieuMoi);
            if (Trung)
            {
                iID_MaChungTu = KTCT_TienGui_ChungTuModels.LayMaChungTu(sSoChungTu);
                DataTable dt = KTCT_TienGui_ChungTuModels.GetChungTu(iID_MaChungTu);
                TrangThaiDuyet = Convert.ToInt16(dt.Rows[0]["iID_MaTrangThaiDuyet"]);
                if (TrangThaiDuyet == LuongCongViecModel.Get_iID_MaTrangThaiDuyet_DaDuyet(PhanHeModels.iID_MaPhanHeKeToanTongHop))
                {
