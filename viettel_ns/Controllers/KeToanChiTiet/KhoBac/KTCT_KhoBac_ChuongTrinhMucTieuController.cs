...
{
    public class KTCT_KhoBac_ChuongTrinhMucTieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChuongTrinhMucTieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_ChuongTrinhMucTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaChuongTrinhMucTieu)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_ChuongTrinhMucTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChuongTrinhMucTieu)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort()
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KT_ChuongTrinhMucTieu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
