...
{
    public class KTCS_LoaiTaiSanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /KTCS_LoaiTaiSan/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_Ma)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_LoaiTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_Ma)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_LoaiTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
