...
{
    public class KTCS_TinhHachToanController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String ParentID, String NamLamViec)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult F4_Submit(String ParentID)
        {
