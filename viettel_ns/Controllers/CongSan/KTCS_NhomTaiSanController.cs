...
{
    public class KTCS_NhomTaiSanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /KTCS_NhomTaiSan/
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaNhomTaiSan_Cha)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaNhomTaiSan, String iID_MaNhomTaiSan_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_NhomTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaNhomTaiSan)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_NhomTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(String iID_MaNhomTaiSan_Cha, String iID_MaNhomTaiSan)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_NhomTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String iID_MaNhomTaiSan_Cha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_NhomTaiSan", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaNhomTaiSan, String iID_MaNhomTaiSan_Cha)
        {
