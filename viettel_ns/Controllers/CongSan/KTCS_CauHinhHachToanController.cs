...
{
    public class KTCS_CauHinhHachToanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String iID_MaKyHieuHachToan)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaKyHieuHachToanChiTiet)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_KyHieuHachToanChiTiet", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaKyHieuHachToanChiTiet)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_KyHieuHachToanChiTiet", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaKyHieuHachToanChiTiet)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "KTCS_KyHieuHachToanChiTiet", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
