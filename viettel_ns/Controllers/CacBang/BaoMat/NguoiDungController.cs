...
{
    public class NguoiDungController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /NguoiDung/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaNguoiDung)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaNguoiDung, String MaNhomNguoiDung)
        {
              if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult CapNhapKichHoat(String MaNguoiDung, String MaNhomNguoiDung, Boolean HoatDong)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult PasswordReset(String MaNguoiDung)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QT_NguoiDung", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(String MaNguoiDung)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QT_NguoiDung", "Detail") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
