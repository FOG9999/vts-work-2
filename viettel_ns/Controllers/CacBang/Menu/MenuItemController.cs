...
namespace Oneres.Controllers.CacBang.MENU
{
    public class MenuItemController : Microsoft.AspNetCore.Mvc.Controller
    {
       public string sViewPath = "~/Views/CacBang/Menu/MenuItem/";
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(string MaMenuItem)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Create(int MaMenuItemCha)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Get)]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(int MaMenuItem)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Get)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(int MaMenuItem)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ControlID)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Get)]
        public Microsoft.AspNetCore.Mvc.ActionResult Sort(int MaMenuItemCha)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "MENU_MenuItem", "Edit") == false || !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SortSubmit(String ControlID)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "MENU_MenuItem", "Edit") == false || !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Get)]
        public Microsoft.AspNetCore.Mvc.ActionResult MenuItem_Cam()
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "MENU_MenuItem", "Edit") == false || !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult MenuItem_CamSubmit(String MaLuat)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "MENU_MenuItem", "Edit") == false || !HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                return RedirectToAction("Index", "PermitionMessage");
