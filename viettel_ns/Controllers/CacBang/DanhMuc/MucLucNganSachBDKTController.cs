...
{
    public class MucLucNganSachBDKTController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /MucLucNganSach/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult MLNSBDKTChiTiet_Frame(String sLNS,String LuuThanhCong)
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
