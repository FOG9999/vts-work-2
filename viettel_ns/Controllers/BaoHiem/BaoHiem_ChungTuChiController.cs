...
{
    public class BaoHiem_ChungTuChiController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /BaoHiem_ChungTu/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChungTuChi,String bChi)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTuChi,String bChi)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTuChi, String bChi)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTuChi,String bChi)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTuChi,String bChi)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
