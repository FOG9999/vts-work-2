...
{
    public class BaoHiem_PhaiThuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /BaoHiem_ChungTu/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String bChi)
        {
            ViewData["bChi"] = bChi;
            return View(sViewPath + "BaoHiem_PhaiThu_Index.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult LaySoLieu()
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String bChi)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaBaoHiemPhaiThu,String bChi)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaBaoHiemPhaiThu, String bChi)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_LaySLieu(String ParentID, String iID_MaPhongBan)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaBaoHiemPhaiThu)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Duyet(String bChi)
        {
            return RedirectToAction("Index", "BaoHiem_PhaiThu");
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaBaoHiemPhaiThu)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaBaoHiemPhaiThu)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
