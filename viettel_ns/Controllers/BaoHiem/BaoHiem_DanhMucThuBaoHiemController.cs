...
{
    public class BaoHiem_DanhMucThuBaoHiemController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaDanhMucThuBaoHiem)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iNamLamViec, String iThang)
        {
            String MaND = User.Identity.Name;
