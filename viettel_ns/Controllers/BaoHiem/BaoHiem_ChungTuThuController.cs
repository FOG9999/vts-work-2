...
{
    public class BaoHiem_ChungTuThuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /BaoHiem_ChungTu/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaChungTuThu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTuThu)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTuThu, String iLoai)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTuThu)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTuThu)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
