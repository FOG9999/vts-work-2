...
{
    public class DuToanBS_ChungTu_BaoDamController : Microsoft.AspNetCore.Mvc.Controller
    {
        #region Hằng Số
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string MaDotNganSach, string iLoai, string iLan, string iKyThuat)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiemChungTu(string ParentID, string iLoai, string iID_MaChungTu_TLTH)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaChungTu(string MaDotNganSach, string iID_MaChungTu, string ChiNganSach, string sLNS, string iKyThuat)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ThemSuaChungTu(string ParentID, String MaChungTu, string sLNS1, string iKyThuat)
        {
            String MaND = User.Identity.Name;
