...
{
    public class DuToanBSChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        #region Hằng Số
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(string MaDotNganSach, string sLNS, string iLoai, string iLan, string iKyThuat)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult TimKiemChungTu(string parentID, string sLNS1, string iLoai, string maChungTu)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaChungTu(string iID_MaChungTu, string sLNS, String iKyThuat)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaChungTuTLTH(string iID_MaChungTu, string sLNS1)
        {
            string maND = User.Identity.Name;
            //Kiểm tra quyền
            if (String.IsNullOrEmpty(iID_MaChungTu) &&
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaChungTuTLTHCuc(string iID_MaChungTu, string sLNS1)
        {
            string maND = User.Identity.Name;
            //Kiểm tra quyền
            if (String.IsNullOrEmpty(iID_MaChungTu) &&
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ThemSuaChungTu(string parentID, string maChungTu, string sLNS, string iKyThuat)
        {
            string maND = User.Identity.Name;
            ...
            sDSLNS = Convert.ToString(Request.Form["sLNS"]);
            ...
            if (sChucNang == CREATE)
            {
                try
                {
                    string maChungTuAddNew = DuToanBSChungTuModels.ThemChungTu(bang, maND, sDSLNS, iKyThuat, dNgayChungTu);
                ...
                catch (Exception ex)
                {
                    ...
                    string[] ers = er.Split('|');
                    ModelState.AddModelError(parentID + "_" + ers[0], ers[0]);
                    ViewData["sLNS"] = sLNS;
            ...
            else
            {
                try
                {
                    ...
                    return RedirectToAction("Index", CONTROLLER_NAME, new { iKyThuat = iKyThuat, sLNS = sLNS });
                }
                catch (Exception ex)
                {
                    string er = ex.Message;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ThemSuaChungTuTLTH(string parentID, string maChungTu, string sLNS1)
        {
            string MaND = User.Identity.Name;
            string sChucNang = EDIT;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ThemSuaChungTuTLTHCuc(string parentID, string maChungTu, string sLNS1)
        {
            String MaND = User.Identity.Name;
            string sChucNang = EDIT;
            if (Request.Form[parentID + "_DuLieuMoi"] == "1")
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_GomNhanBKhac(string parentID, string maChungTu, string sLNS1, string iLan2)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[parentID + "_DuLieuMoi"] == "1")
        ...
        /// <returns>RedirectToAction</returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult XoaChungTu(string iID_MaChungTu, string MaDotNganSach, string ChiNganSach, string sLNS, String iKyThuat)
        {
            //Kiểm tra quyền
            ...
            return RedirectToAction("Index", CONTROLLER_NAME,
                new { MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach, sLNS = sLNS, iKyThuat = iKyThuat });
        }
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult XoaChungTuTLTH(string iID_MaChungTu, string sLNS1)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult XoaChungTuTLTHCuc(string iID_MaChungTu, string sLNS1)
        {
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyetChungTu(string maChungTu, string sLNS, string iKyThuat, string sLyDo, string maChungTuTLTH, string chiTiet)
        {
            string MaND = User.Identity.Name;
            ...
            if ((sLNS.StartsWith("1040100") || sLNS.Contains("1040100")) && iKyThuat == "1")
            ...
            //Chung tu phan cap gui B khac thi tao them chung tu moi voi loai #
            bool checkLNS = DuToanBSModels.checkLNSPC(maChungTu, sLNS);

            //if (LuongCongViecModel.KiemTra_TroLyPhongBan(MaND) && checkLNS)
            if (LuongCongViecModel.KiemTra_TroLyPhongBan(MaND) || LuongCongViecModel.KiemTra_TroLyPB11_02(MaND) 
                )
            {
                //kiem tra so lieu
                DataTable dtCheckPhongBan = DuToanBSChungTuModels.getPhongBanPhanCap(maChungTu, MaND);
                if (dtCheckPhongBan.Rows.Count > 0)
                {
                    DataTable dtChungTu = DuToanBSChungTuModels.LayChungTu(maChungTu);
                    for (int i = 0; i < dtCheckPhongBan.Rows.Count; i++)
                    {
                        String iID_MaPhongBan = dtCheckPhongBan.Rows[i]["iID_MaPhongBanDich"].ToString();
                        //tao DTBS_ChungTu
                        String iID_MaChungTu_ChungTuNew = "";
                        iID_MaChungTu_ChungTuNew = DuToanBSChungTuModels.TaoChungTuPhanCap(maChungTu, dtChungTu.Rows[0], iID_MaPhongBan);
                        if (!String.IsNullOrEmpty(iID_MaChungTu_ChungTuNew))
                        {
                            //tao DTBS_ChungTuChiTiet
                            //lay dtchungtuchitiet
                            DataTable dtChungTuChiTiet = DuToanBSChungTuModels.getChungTuChiTietCoPhanCap(maChungTu, MaND, iID_MaPhongBan);

                            String IID_MaChungTuChiTiet_New = "";
                            for (int j = 0; j < dtChungTuChiTiet.Rows.Count; j++)
                            {
                                double rTongPhanCap = 0;
                                double rTongTuChi = Convert.ToDouble(dtChungTuChiTiet.Rows[j]["rTuChi"]);
                                if (dtChungTuChiTiet.Rows[j]["iID_MaPhongBan"].ToString() != "02")
                                {
                                    rTongTuChi = 0;
                                }
                                IID_MaChungTuChiTiet_New = DuToanBSChungTuModels.TaoChungTuChiTietPhanCap(iID_MaChungTu_ChungTuNew, dtChungTuChiTiet.Rows[j], iID_MaPhongBan);
                                if (!String.IsNullOrEmpty(IID_MaChungTuChiTiet_New))
                                {
                                    DataTable dtChungTuChiTiet_PhanCap = DuToanBSChungTuModels.getChungTuChiTiet_PhanCap(dtChungTuChiTiet.Rows[j]["iID_MaChungTuChiTiet"].ToString(), iID_MaPhongBan);
                                    String iID_MaChungTuChiTiet_PhanCap_New = "";

                                    for (int z = 0; z < dtChungTuChiTiet_PhanCap.Rows.Count; z++)
                                    {
                                        iID_MaChungTuChiTiet_PhanCap_New = DuToanBSChungTuModels.TaoChungTuChiTietPhanCap_PhanCap(IID_MaChungTuChiTiet_New, dtChungTuChiTiet_PhanCap.Rows[z]);
                                        rTongPhanCap += Convert.ToDouble(dtChungTuChiTiet_PhanCap.Rows[z]["rTuChi"]);
                                    }
                                }
                                //update lai so phan cap
                                DuToanBSChungTuModels.UpdateChungTuChiTietBS(IID_MaChungTuChiTiet_New, rTongPhanCap, rTongTuChi);

                            }

                            //#region LONG SUA 10/10/2018

                            //for (int j = 0; j < dtChungTuChiTiet.Rows.Count; j++)
                            //{
                            //    double rPhanCap_TuChi = 0;
                            //    double rPhanCap_HienVat = 0;
                            //    IID_MaChungTuChiTiet_New = DuToanBSChungTuModels.TaoChungTuChiTietPhanCap(iID_MaChungTu_ChungTuNew, dtChungTuChiTiet.Rows[j], iID_MaPhongBan);
                            //    if (!String.IsNullOrEmpty(IID_MaChungTuChiTiet_New))
                            //    {
                            //        DataTable dtChungTuChiTiet_PhanCap = DuToanBSChungTuModels.getChungTuChiTiet_PhanCap(dtChungTuChiTiet.Rows[j]["iID_MaChungTuChiTiet"].ToString(), iID_MaPhongBan);
                            ...
                            //        {
                            //            iID_MaChungTuChiTiet_PhanCap_New = DuToanBSChungTuModels.TaoChungTuChiTietPhanCap_PhanCap(IID_MaChungTuChiTiet_New, dtChungTuChiTiet_PhanCap.Rows[z]);
                            //            rPhanCap_TuChi += Convert.ToDouble(dtChungTuChiTiet_PhanCap.Rows[z]["rTuChi"]);
                            //            rPhanCap_HienVat += Convert.ToDouble(dtChungTuChiTiet_PhanCap.Rows[z]["rHienVat"]);

                            //        }
                            //    }
                            //    //update lai so phan cap
                            //    DuToanBSChungTuModels.UpdateSoPhanCapChungTuChiTiet(IID_MaChungTuChiTiet_New, rPhanCap_TuChi, rPhanCap_HienVat);
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyetChungTuTLTH(string maChungTuTLTH, string iLoai, string sLNS,
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyetChungTuTLTHCuc(string maChungTuTLTHCuc, string iLoai, string sLNS)
        {
            string maND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoiChungTu(string maChungTu, string iLoai, string sLNS, string sLyDo, string maChungTuTLTH, string chiTiet, String iKyThuat)
        {
            string maND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
            ...
            return RedirectToAction("Index", "DuToanBSChungTu", new { sLNS = sLNS, iID_MaChungTu = maChungTuTLTH, iKyThuat = iKyThuat });
        }
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoiChungTuTLTH(string maChungTuTLTH, string iLoai, string sLNS, string maChungTuTLTHCuc)
        {
            string maND = User.Identity.Name;
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoiChungTuTLTHCuc(string maChungTuTLTHCuc, string iLoai, string sLNS)
        {
            string maND = User.Identity.Name;
