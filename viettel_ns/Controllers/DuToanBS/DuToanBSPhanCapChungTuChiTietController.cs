...
{
    public class DuToanBSPhanCapChungTuChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
            ...
            if (iKyThuat == "1" && MaLoai != "2")
            {
                for (int i = 0; i < arrMaHang.Length; i++)
                {
                    ...
                    if (arrMaHang[i] != "")
                    {
                        ...
                        if (DuToanBSChungTuChiTietModels.KiemTraDonViPhanCap2Lan(iID_MaDonVi) && Xau == "1020100-010-011-6950-6954-10-23")
                        {
