...
{
    public class DuToanBSChungTuChiTietController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        /// <returns></returns>
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTietFrame(string sLNS, string sL, string sK, string sM, string sTM, string sTTM, string sNG, string sTNG, string iID_MaDonVi, string MaLoai, string iLoai, string iChiTapTrung)
        {
            //Kiểm tra quyền của người dùng với chức năng
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, BANG_CHUNGTU_CHITIET, DETAIL) == false)
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChuyenSoLieu()
        {
            //Kiểm tra quyền của người dùng với chức năng
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, BANG_CHUNGTU_CHITIET, DETAIL) == false)
            {
    ...
    [Authorize]
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult CapNhatChungTuChiTiet(string ChiNganSach, string iID_MaChungTu, string sLNS, string iLoai, string iChiTapTrung)
        {
