...
{
    public class PhanBo_DotPhanBoController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult AddNewSubmit(String ParentID, String ChiNganSach)
        {
            String MaDotPhanBo = "";
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaDotPhanBo)
        {
            ViewData["MaDotPhanBo"] = MaDotPhanBo;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaDotPhanBo, String ChiNganSach)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaDotPhanBo, String ChiNganSach)
        {
        ...
        public static String get_NgayDotPhanBo(String ParentID, String NamLamViec, int bChiNganSach, String MaNguonNamNganSach, String MaNamNganSach, String sLNS)
        {
            ...
            if (dt != null)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String urlDelete = MyHtmlHelper.ActionLink("/PhanBo_DotPhanBo/Delete?MaDotPhanBo=" + R["iID_MaDotPhanBo"], "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete","");// "/PhanBo_DotPhanBo/Delete?MaDotPhanBo=" + R["iID_MaDotPhanBo"];
