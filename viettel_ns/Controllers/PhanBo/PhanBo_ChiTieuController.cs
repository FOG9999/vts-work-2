...
{
    public class PhanBo_ChiTieuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /PhanBo_ChiTieu/
        public string sViewPath = "~/Views/PhanBo/ChiTieu/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String MaDotPhanBo)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String MaDotPhanBo)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create_ChiTieu(String MaDotPhanBo, String iID_MaChiTieu)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaDotPhanBo, String iID_MaChiTieu)
        {
            String MaND = User.Identity.Name;
            if (String.IsNullOrEmpty(iID_MaChiTieu) && LuongCongViecModel.NguoiDung_DuocThemChungTu(PhanBoModels.iID_MaPhanHePhanBo, MaND) == false)
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Create(String MaDotPhanBo, String iID_MaChiTieu)
        {
            String MaND = User.Identity.Name;
            if (String.IsNullOrEmpty(iID_MaChiTieu) && LuongCongViecModel.NguoiDung_DuocThemChungTu(PhanBoModels.iID_MaPhanHePhanBo, MaND) == false)
            {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaDotPhanBo, String MaChiTieu)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_DauNam(String ParentID, String MaDotPhanBo, String MaChiTieu)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[ParentID + "_DuLieuMoi"] == "1" && LuongCongViecModel.NguoiDung_DuocThemChungTu(PhanHeModels.iID_MaPhanHePhanBo, MaND) == false)
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChiTieu, String MaDotPhanBo)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChiTieu)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChiTieu)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
