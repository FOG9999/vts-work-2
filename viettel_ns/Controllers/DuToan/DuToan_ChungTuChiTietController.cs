...
namespace VIETTEL.Controllers.ChungTuChiTiet
{
    public class DuToan_ChungTuChiTietController : AppController
    {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iID_MaChungTu, String sLNS, String iID_MaDonVi, String iLoai, String iChiTapTrung)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index_Gom(String iID_MaChungTu)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame(string sLNS, string sL, string sK, string sM, string sTM, string sTTM, string sNG, string sTNG, string iID_MaDonVi, String MaLoai, String iLoai, String iChiTapTrung)
        {
            //Kiểm tra quyền của người dùng với chức năng
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "DT_ChungTuChiTiet", "Detail") == false)
            {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String ChiNganSach, String iID_MaChungTu, String sLNS, String iLoai, String iChiTapTrung)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTu, String iLoai, String sLNS, String iKyThuat, String sLyDo, String iID_MaChungTu_TLTH)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTu, String iLoai, String sLNS, String sLyDo, String iID_MaChungTu_TLTH)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTuChiTiet, String iID_MaChungTu)
        {
