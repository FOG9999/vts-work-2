...
{
    public class DuToan_ChungTuController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /ChungTu/
        public string sViewPath = "~/Views/DuToan/ChungTu/";
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String MaDotNganSach, String sLNS, String iLoai)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String sLNS, String iLoai, String iID_MaChungTu_TLTH)
        {
            ...
            String iTrangThai_TK = Request.Form[ParentID + "_iTrangThai_TK"];
            String iID_MaTrangThaiDuyet = Request.Form[ParentID + "_iID_MaTrangThaiDuyet"];
            if (String.IsNullOrEmpty(TuNgay) == false && HamChung.isDate(TuNgay) == false)
            {

            }
            return RedirectToAction("Index", "DuToan_ChungTu", new { sLNS = sLNS, iLoai = iLoai, SoChungTu = SoChungTu, TuNgay = TuNgay, DenNgay = DenNgay, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, sLNS_TK = sLNS_TK, iTrangThai_TK = iTrangThai_TK, iID_MaChungTu = iID_MaChungTu_TLTH });
        }

        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaDotNganSach, String iID_MaChungTu, String ChiNganSach, String sLNS)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_Gom(String iID_MaChungTu, String sLNS)
        {
            String MaND = User.Identity.Name;
            if (String.IsNullOrEmpty(iID_MaChungTu))
            {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTu, String sLNS1)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_Gom(String ParentID, String MaChungTu, String sLNS1)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_Gom_THCuc(String ParentID, String MaChungTu, String sLNS1)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit_Fast_Submit(String ParentID, String MaDotNganSach, String ChiNganSach, String sLNS)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu, String MaDotNganSach, String ChiNganSach, String sLNS)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete_Gom(String iID_MaChungTu, String sLNS)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SearchDuyetSubmit(String ParentID, String ChiNganSach)
        {
