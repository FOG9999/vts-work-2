...
{
    public class DuToan_DotNganSachController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /DotNganSach/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaDotNganSach)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaDotNganSach, String ChiNganSach)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String MaDotNganSach, String ChiNganSach)
        {
        ...
        public static String get_NgayDotNganSach(String ParentID, String NamLamViec, int bChiNganSach, String MaNguonNamNganSach, String MaNamNganSach, String sLNS)
        {
            ...
            if (dt != null)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    builder.Append("</td>");
                    builder.Append("<td align=\"center\">");
                    builder.Append(String.Format("<a onclick=\"javascript:return confirm('Bạn có chắc chắn muốn xóa không?');\" href=\"{0}\">{1}</a>", urlDelete, "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>"));
                    builder.Append("</td>");
                    builder.Append("</tr>");
                }
