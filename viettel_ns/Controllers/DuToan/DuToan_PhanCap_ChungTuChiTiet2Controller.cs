...
{
    public class DuToan_PhanCapChungTuChiTiet2Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iID_MaChungTu)
        {
            ...
            return View(sViewPath + "PhanCap_ChungTuChiTiet_Index2.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult ChungTuChiTiet_Frame(String sLNS, String MaLoai)
        {
            ...
            return View(sViewPath + "PhanCap_ChungTuChiTiet_Index_DanhSach_Frame2.aspx", new { sLNS = sLNS });
        }
        ...
        {
            DataTable dtCT = DuToan_ChungTuChiTietModels.LayDanhSachChungTuChiTiet2(iID_MaChungTu);
