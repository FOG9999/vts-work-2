...
{
    public class DuToan_ChungTuChiTiet_GomController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Index(String iID_MaChungTu, String sLNS, String iID_MaDonVi)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaChungTu,String iLoai,String sLNS)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet_THCuc(String iID_MaChungTu, String iLoai, String sLNS)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaChungTu, String iLoai, String sLNS)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi_THCuc(String iID_MaChungTu, String iLoai, String sLNS)
        {
            String MaND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
