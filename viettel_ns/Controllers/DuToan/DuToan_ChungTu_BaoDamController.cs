...
{
    public class DuToan_ChungTu_BaoDamController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /ChungTu/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID, String iLoai, String iID_MaChungTu)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String MaDotNganSach, String iID_MaChungTu, String ChiNganSach, String sLNS, String iKyThuat)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String MaChungTu, String sLNS1, String iKyThuat)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit_Gom(String ParentID, String MaChungTu, String sLNS1, String iLan2)
        {
            String MaND = User.Identity.Name;
            string sChucNang = "Edit";
            if (Request.Form[ParentID + "_DuLieuMoi"] == "1")
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaChungTu, String MaDotNganSach, String ChiNganSach, String sLNS, String iKyThuat)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete_Gom(String iID_MaChungTu, String sLNS1)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult UpLoadExcel(String iID_MaChungTu, String Loai, String iLoai)
        {
