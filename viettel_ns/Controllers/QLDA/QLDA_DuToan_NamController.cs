...
{
    public class QLDA_DuToan_NamController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QLDA_DuToan_Nam/
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index()
        {
            if (HamChung.CoQuyenXemTheoMenu(Request.Url.AbsolutePath, User.Identity.Name))
            {
                ...
                if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QLDA_DuToan_Nam", "List") == false)
                {
                    return RedirectToAction("Index", "PermitionMessage");
                }
                return View(sViewPath + "QLDA_DuToan_Nam_Index.aspx");
            }
            else
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail()
        {
            ...
            return View(sViewPath + "QLDA_DuToan_Nam_Edit.aspx");
        }
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Search()
        {
            ...
            return View(sViewPath + "QLDA_DuToan_Nam_Search.aspx");
        }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult SearchSubmit(String ParentID)
        {
            ...
            return RedirectToAction("Index", "QLDA_DuToan_Nam", new { iID_MaDanhMucDuAn = iID_MaDanhMucDuAn, dTuNgay = dTuNgay, dDenNgay = dDenNgay });
            //return RedirectToAction("Search", "QLDA_DuToan_Nam", new { iID_MaDanhMucDuAn = iID_MaDanhMucDuAn, dTuNgay = dTuNgay, dDenNgay = dDenNgay });
        }
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String dNgayLap, String iID_MaDuToanNam_QuyetDinh)
        {
            if (String.IsNullOrEmpty(dNgayLap) || String.IsNullOrEmpty(iID_MaDuToanNam_QuyetDinh))
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
            DataRow R = dtCauHinh.Rows[0];
            String TenBangChiTiet = "QLDA_DuToan_Nam";
                ...
                else
                {
                    ...
                    if (okCoThayDoi)
                    {
                        ...
                        if (iID_MaDanhMucDuAnChiTiet == "")
                        {
                            ...
                            bang.CmdParams.Parameters.AddWithValue("@iID_MaDuToanNam_QuyetDinh", iID_MaDuToanNam_QuyetDinh);
            ...
            //}
            return RedirectToAction("Detail", new { iID_MaDuToanNam_QuyetDinh = iID_MaDuToanNam_QuyetDinh, dNgayLap = dNgayLap }); 
           // return RedirectToAction("Index", new {dNgayLap = dNgayLap });
        }

        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_MaDuToanNam_QuyetDinh)
        {
            string iID_MaDuToanNam = "";
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QLDA_DuToan_Nam_ChungTu", "Edit") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }
            ...
            if (arrLoi.Count > 0)
            {
                ...
                ViewData["iID_MaDuToanNam_QuyetDinh"] = iID_MaDuToanNam_QuyetDinh;
                return View(sViewPath + "QLDA_DuToan_Nam_ChungTu_Edit.aspx");
            }
            else
            {
                DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
                ...
                Bang bang = new Bang("QLDA_DuToan_Nam_ChungTu");
                ...
                bang.GiaTriKhoa = iID_MaDuToanNam_QuyetDinh;
                if (String.IsNullOrEmpty(iID_MaDuToanNam_QuyetDinh))
                {
                    Guid MaDuToanNam_QuyetDinhID = Guid.NewGuid();
                    bang.CmdParams.Parameters.AddWithValue("@iID_MaDuToanNam_QuyetDinh", Convert.ToString(MaDuToanNam_QuyetDinhID));
            ...
            {
                return RedirectToAction("Detail", new { iID_MaDuToanNam_QuyetDinh = iID_MaDuToanNam, dNgayLap = dNgayLap }); 
            }
            else
            {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDuToanNam_QuyetDinh)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaDuToanNam_QuyetDinh)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QLDA_DuToan_Nam_ChungTu", "Delete") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
            }

            SqlCommand cmd = new SqlCommand("UPDATE QLDA_DuToan_Nam_ChungTu SET iTrangThai = 0 WHERE iID_MaDuToanNam_QuyetDinh=@iID_MaDuToanNam_QuyetDinh");
            cmd.Parameters.AddWithValue("@iID_MaDuToanNam_QuyetDinh", iID_MaDuToanNam_QuyetDinh);
            Connection.UpdateDatabase(cmd);
            cmd.Dispose();

            Bang bang = new Bang("QLDA_DuToan_Nam");
            bang.GiaTriKhoa = iID_MaDuToanNam_QuyetDinh;
            bang.Delete();
            return RedirectToAction("Index");
        }
