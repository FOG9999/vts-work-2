...
{
    public class QLDA_HopDongController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QLDA_HopDong/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaHopDong)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID,String iID_MaHopDong)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaHopDong)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaHopDong)
        {
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
