...
{
    public class QLDA_QuyetToanController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QLDA_QuyetToan/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_MaQuyetToan_SoPhieu)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaQuyetToan_SoPhieu)
        {
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
