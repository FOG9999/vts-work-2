...
{
    public class QLDA_CapPhatController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QLDA_CapPhat/
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_MaDotCapPhat)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult AddCapPhat(String iID_MaDotCapPhat)
        {
            ViewData["DuLieuMoi"] = "1";
            ViewData["iID_MaDotCapPhat"] = iID_MaDotCapPhat;
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult SuaSubmit(String ParentID, String iID_MaDotCapPhat)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete_Dot(String iID_MaDotCapPhat)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(String iID_MaDotCapPhat)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QLDA_CapPhat", "List") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTiet(String iID_MaDotCapPhat)
        {
            if (BaoMat.ChoPhepLamViec(User.Identity.Name, "QLDA_CapPhat", "List") == false)
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult btnPrev(String iID_MaDotCapPhat, String iID_MaCapPhat, String iNam)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult btnNext(String iID_MaDotCapPhat, String iID_MaCapPhat, String iNam)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult btnCheck(String iID_MaDotCapPhat, String iID_MaCapPhat)
        {
            ViewData["DuLieuMoi"] = "1";
            ViewData["iID_MaDotCapPhat"] = iID_MaDotCapPhat;
            return View(sViewPath + "QLDA_CapPhat_List.aspx");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult btnTrinhDuyet(String iID_MaDotCapPhat, String iID_MaCapPhat)
        {
            ViewData["DuLieuMoi"] = "1";
            ViewData["iID_MaDotCapPhat"] = iID_MaDotCapPhat;
            return View(sViewPath + "QLDA_CapPhat_List.aspx");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult btnThongTri(String iID_MaDotCapPhat, String iID_MaCapPhat)
        {
            ViewData["DuLieuMoi"] = "1";
            ViewData["iID_MaDotCapPhat"] = iID_MaDotCapPhat;
            return View(sViewPath + "QLDA_CapPhat_List.aspx");
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult List(String iID_MaDotCapPhat, String iID_MaCapPhat)
        {
            ViewData["DuLieuMoi"] = "0";
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult LuuCapPhatSubmit(String ParentID, String iID_MaCapPhat, String iID_MaDotCapPhat)
        {
        ...
        public static String get_NgayDotNganSach(String ParentID, String NamLamViec, String MaND)
        {
            ...
            if (dt != null)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    builder.Append("</td>");
                    builder.Append("<td align=\"center\">");
                    builder.Append(String.Format("<a href=\"{0}\">{1}</a>", urlEdit, "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>"));
                    builder.Append("</td>");
                    builder.Append("<td align=\"center\">");
                    builder.Append(String.Format("<a href=\"{0}\">{1}</a>", urlDelete, "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>"));
                    builder.Append("</td>");
                    builder.Append("</tr>");
                }
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iID_MaDotCapPhat, String iID_MaHopDong, String iID_MaDanhMucDuAn)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult ChiTietSubmit(String iID_MaDotCapPhat)
        {
            String MaND = User.Identity.Name;
            String iID_MaChungTu = "";
            DataTable dtCauHinh = NguoiDungCauHinhModels.LayCauHinh(User.Identity.Name);
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TrinhDuyet(String iID_MaDotCapPhat, String iID_MaHopDong, String iID_MaDanhMucDuAn, String iNam)
        {
            String MaND = User.Identity.Name;
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult TuChoi(String iID_MaDotCapPhat, String iID_MaHopDong, String iID_MaDanhMucDuAn, String iNam)
        {
            String MaND = User.Identity.Name;
            DataTable dtChungTu = QLDA_CapPhatModels.GetChungTu(iID_MaDotCapPhat, iID_MaHopDong, iID_MaDanhMucDuAn, iNam);
            String iID_MaChungTu = "";
