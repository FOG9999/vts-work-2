...
{
    public class QLDA_KeHoachVonController : Microsoft.AspNetCore.Mvc.Controller
    {
        //
        // GET: /QLDA_KeHoachVon/
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult DetailSubmit(String iLoaiKeHoachVon, String dNgayKeHoachVon, String iID_KeHoachVon_QuyetDinh)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Detail(String iID_KeHoachVon_QuyetDinh, String dNgayKeHoachVon, String iLoaiKeHoachVon)
        {
            if (String.IsNullOrEmpty(iLoaiKeHoachVon) || String.IsNullOrEmpty(dNgayKeHoachVon) || String.IsNullOrEmpty(iID_KeHoachVon_QuyetDinh))
            {
                return RedirectToAction("Index", "PermitionMessage");
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public Microsoft.AspNetCore.Mvc.ActionResult EditSubmit(String ParentID, String iID_KeHoachVon_QuyetDinh)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit(String iID_KeHoachVon_QuyetDinh)
        {
        ...
        [Authorize]
        public Microsoft.AspNetCore.Mvc.ActionResult Delete(String iID_KeHoachVon_QuyetDinh)
        {
