    ...
    var L = function (h) {
        var j = function (e) {
            ...
            fnRowCallback: null, fnServerData: function (e, j, m, k) { k.jqXHR = h.ajax({ url: e, data: j, success: function (e) { e.sError && k.oApi._fnLog(k, 0, e.sError); h(k.oInstance).trigger("xhr", [k, e]); m(e) }, dataType: "json", cache: !1, type: k.sServerMethod, error: function (e, h) { "parsererror" == h && k.oApi._fnLog(k, 0, "DataTables warning: JSON data from server could not be parsed. This is caused by a JSON formatting error.") } }) }, fnServerParams: null, fnStateLoad: function (e) {
                ...
                oPaginate: { sFirst: "Đầu", sLast: "Cuối", sNext: "Sau", sPrevious: "Trước" }, sEmptyTable: "Không có dữ liệu cần tìm kiếm", sInfo: "Hiển thị _START_ đến _END_ của _TOTAL_ hàng", sInfoEmpty: "Hiển thị 0 đến 0 của 0 hàng", sInfoFiltered: "(Tìm trong _MAX_ hàng)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Hiển thị _MENU_ hàng", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "Tìm kiếm:", sUrl: "", sZeroRecords: "<p class='alert alert-danger tcenter'>Không tìm thấy hồ sơ nào</p>"
