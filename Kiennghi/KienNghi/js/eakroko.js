		...
		$('.dataTable').each(function(){
			var opt = {
				...
				"oLanguage":{
					...
					//"sInfo": "Hiển thị <span>_START_</span> đến <span>_END_</span> của <span>_TOTAL_</span> bài viết",
                    "sInfo": "",
					"sLengthMenu": " "
				}
			};
			...
			$('.dataTables_filter input').attr("placeholder", "Nhập từ khóa cần tìm...").addClass("input-xxlarge");
