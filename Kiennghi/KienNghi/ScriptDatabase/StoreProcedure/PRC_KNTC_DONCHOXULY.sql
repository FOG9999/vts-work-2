create or replace PROCEDURE PRC_KNTC_DONCHOXULY 
(
    ...
    (
        ...
        FROM KNTC_DON
            ...
            WHERE 1=1 
            AND ( P_USER = 0 OR P_USER = null OR KNTC_DON.IUSER =  P_USER)
            ...
            AND (P_DTUNGAY is null OR KNTC_DON.DNGAYNHAN >= P_DTUNGAY)
            AND (P_DDENNGAY is null OR KNTC_DON.DNGAYNHAN <= P_DDENNGAY)
