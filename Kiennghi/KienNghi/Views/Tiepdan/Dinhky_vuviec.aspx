        ...
        <div class="container-fluid">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Vụ việc tiếp nhận qua tiếp dân định kỳ</span>
                    </li>
                </ul>
            ...
            <div class="function_chung">
                    ...
                    <a data-original-title="Thêm mới" rel="tooltip" href="/Tiepdan/Themmoi/?sel=dinhky" class="add btn_f blue" onchange="$('#iTiepDinhKy').toggle()"><i class="icon-plus-sign"></i></a>
                    <form class="search" id="fromsearch" method="get" name="fromsearch" onsubmit="return false;">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th nowrap style="width: 30%">Người gửi / Địa chỉ</th>
                                             <th nowrap style="width: 32%">Nội dung vụ việc / Người tiếp</th>
                                              <th nowrap style="width:15%">Hình thức giám sát</th>         
                                            <th nowrap style="text-align: center">Hình thức xử lý</th>
                                            <th nowrap class="tcenter" width="7%">Mẫu đơn</th>
                                            <th nowrap class="tcenter" width="7%">Chức năng</th>
                                        </tr>
                                    </thead>
