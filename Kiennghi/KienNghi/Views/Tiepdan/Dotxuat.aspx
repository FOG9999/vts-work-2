...
<div id="main" class="">
    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Vụ việc tiếp nhận qua tiếp dân đột xuất</span>
			    </li>
		    </ul>
        ...
        <div class="function_chung">
                  ...
                  <a  data-original-title="Thêm mới vụ việc đột xuất" rel="tooltip" href="/Tiepdan/Themmoi/?sel=dotxuat" class="add btn_f blue" onchange="$('#iTiepDinhKy').toggle()"><i class="icon-plus-sign"></i></a>
                 <form class="search" id="fromsearch" name="fromsearch" onsubmit="return CheckForm();">
                        ...
                        <a onclick="CheckForm()" data-original-title="Tìm kiếm nội dung vụ việc đột xuất" rel="tooltip" class="add btn_f blue" style="margin-top: 0px !important;"><i class="icon-search"></i></a>
                      
                        <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Tiepdan/Ajax_Dotxuat_search/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-time"></i>Vụ việc tiếp nhận qua tiếp dân đột xuất</h3>
                        <ul class="tabs">
    ...
    <script type="text/javascript">
        ...
        function CheckForm() {
            ...
            window.location = "/Tiepdan/Dotxuat/?q=" + tentimkiem;
            return false;
        }
    ...
    <script type="text/javascript">
        ...
        function TimKiem(val) {
            ...
            $.post("/Tiepdan/Ajax_TDDOTXUAT_search/" + val + "", function (ok) {
