...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Thêm mới vụ việc tiếp công dân thường xuyên
</asp:Content>
    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Thêm mới vụ việc tiếp công dân thường xuyên</span>
			    </li>
		    </ul>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i>Thêm mới vụ việc tiếp công dân thường xuyên</h3>
				    </div>
					    ...
					    <form method="post" id="form_" class="nomargin" onsubmit="return CheckForm();" enctype="multipart/form-data">
                            <table class="table table-condensed table-bordered form4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="cDiaDiem" id="cDiaDiem" type="text" value="Trụ sở tiếp công dân" class="input-block-level" />
                                        </td>
                                    </tr>  
                                    <tr>
                                        ...
                                        <td><input type="text" name="cNguoiTiep" id="cNguoiTiep" class="input-block-level" /></td>
                                        
                                    </tr>                              
                                    <tr>
                                        <td class="f-red" width="15%">Người gửi *</td>
                                        <td width="35%">
                                            <input type="text" name="cNguoiGui_Ten" id="cNguoiGui_Ten" class="input-block-level" />
                                        </td>
                                        <td class="f-red" width="15%">Địa chỉ người gửi *</td>
                                        <td width="35%">
                                            <input type="text" name="cNguoiGui_DiaChi" id="cNguoiGui_DiaChi" class="input-block-level" />
                                        </td>
                                    </tr> 
                                    <tr>
                                        <td></td>
                                        <td colspan="3">
                                            <input type="checkbox" name="iDoan" class="nomargin" onchange="$('#doan').toggle();" /> Đoàn đông người
                                            <span id="doan" style="margin-left:15px; display:none">
                                                <input type="text" class="input-medium" id="iDoan_Nguoi" onchange="CheckNum('iDoan_Nguoi')" name="iDoan_Nguoi" id="iDoan_Nguoi" value="0" /></span>
                                        </td>
                                    </tr>                               
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" >
                                            <input type="text" name="cKetQua_NguoiTraLoi" class="input-block-level"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="">Kết quả trả lời, giải quyết</td>
                                        <td colspan="3" >
                                            <textarea name="cKetQua" class="input-block-level"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
