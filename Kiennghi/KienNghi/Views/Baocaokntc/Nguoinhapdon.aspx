...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Báo cáo thống kê người nhập đơn
                            </h3>
    ...
    <script>
        function Xem() {
            ...
            $.post("/Baocaokntc/Ajax_Xembaocao_Nguoinhapdon", $("#form_export").serialize(), function (ok) {
                $("#data").html(ok);
            });
            return false;
        ...
        function TaiExel() {
            ...
            window.location = "/Baocaokntc/Nguoinhapdon_Exl/?tungay=" + $("#dTuNgay").val() + "&denngay=" + $("#dDenngay").val() + "&iLoaidon=" + $("#iLoaiDon").val() + "&iLinhVuc=" + $("#iLinhVuc").val() + "&iNoiDung=" + $("#iNoiDung").val() + "&iTinhChat=" + $("#iTinhChat").val();
        }
