...
Báo cáo theo cơ quan thẩm quyền
</asp:Content>
  ...
  <%: Html.Partial("../Shared/_Left_Baocao") %>
            ...
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                      ...
                      <li>
                        <span>Theo cơ quan thẩm quyền</span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Báo cáo thống kê cơ quan thẩm quyền
                            </h3>
    ...
    <script>
        function Xem() {
            ...
            $.post("/Baocaokntc/Ajax_Xembaocao_Coquanthamquyen", $("#form_export").serialize(), function (ok) {
                $("#data").html(ok);
            });
            return false;
        ...
        function TaiExel() {
            ...
            window.location = "/Baocaokntc/Coquanthamquyen_Exl/?tungay=" + $("#dTuNgay").val() + "&denngay=" + $("#dDenngay").val() + "&iLoaidon=" + $("#iLoaiDon").val() + "&iLinhVuc=" + $("#iLinhVuc").val() + "&iNoiDung=" + $("#iNoiDung").val() + "&iTinhChat=" + $("#iTinhChat").val();
        }
