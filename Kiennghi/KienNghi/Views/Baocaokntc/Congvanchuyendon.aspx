...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Tổng hợp đơn ( công văn chuyển đơn )
                            </h3>
                            ...
                            <form method="post" name="form_export" id="form_export" enctype="multipart/form-data" class="form-horizontal form-column">
                                ...
                                <div class="row-fluid">
                                    <div class="control-group span6">
                                        ...
                                        <div class="controls">
                                            <select id="iLoai" name="iLoai" class="chosen-select">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-block-level">
                                                    <select name="iLoaiDon" id="iLoaiDon" class="input-block-level chosen-select">
    ...
    <script>
        function Xem() {
            ...
            $.post("/Baocaokntc/Ajax_Xembaocao_Congvanchuyendon", $("#form_export").serialize(), function (ok) {
                $("#data").html(ok);
            });
            return false;
        ...
        function TaiExel() {
            ...
            window.location = "/Baocaokntc/Congvanchuyendon_Exl/?tungay=" + $("#dTuNgay").val() + "&denngay=" + $("#dDenngay").val() + "&iLoaidon=" + $("#iLoaiDon").val() + "&iLoai=" + $("#iLoai").val();
        }
    </script>
</asp:Content>
