        ...
        <div class="breadcrumbs">
		    <ul>
               ...
               <li>
                ...
                <li>
				    <span>Danh sách loại văn bản </span>
			    </li>
		    </ul>
		    
	    </div>
        <div class="function_chung">
                <a onclick="ShowPopUp('','/Thietlap/Ajax_vanban_add')" data-original-title="Thêm mới" rel="tooltip" href="#" class="add btn_f blue"><i class="icon-plus-sign"></i></a>
                <form class="search" id="form_search" method="get">

                    <select name="select" id="select" class='chosen-select form-control' onchange="ChangeChosenSelect('select','/Thietlap/Ajax_vanban_search','div_change')">
                        <option selected value="0">Từ khóa tìm kiếm</option>
                            <%=ViewData["Option_vanban"] %>												
					</select>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered ">
				    <div class="box-title">
					    <h3><i class="icon-file"></i>Danh sách loại văn bản </h3>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th nowrap class="tcenter" width="3%">STT</th>  
                                      <th nowrap class="tcenter" width="6%">Mã văn bản</th>                                       
