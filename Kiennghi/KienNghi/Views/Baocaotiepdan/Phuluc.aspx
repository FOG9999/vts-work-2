...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span> Tiếp công dân phụ lục </span>
                    </li>
                </ul>
         ...
         <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3> <i class="icon-search"></i> Báo cáo tiếp công dân phụ lục </h3>
 ...
 <script>
     function Xem() {
        ...
        {
             $.post("/Baocaotiepdan/Ajax_Tiepcongdan_Phuluc", $("#form_export").serialize(), function (ok) {
     ...
     function TaiExel() {
         window.location = "/Baocaotiepdan/Download_Baocaotiepcongdanphuluc/?dTuNgay=" + $("#dTuNgay").val() + "&dDenNgay=" + $("#dDenngay").val() + "&iDonvi=" + $("#iDonvi").val() + "&iLoaidon=" + $("#iLoaidon").val() + "&iLinhVuc=" + $("#iLinhVuc").val();
     }
