...
Danh sách đơn đã chuyển xử lý, giải quyết chưa có trả lời
    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
                   <span> Đơn đã chuyển đến cơ quan có thẩm quyền xử lý, giải quyết chưa có trả lời</span>
			    </li>
		    </ul>
          ...
          <div class="function_chung">
                <form class="search" id="form_search" method="get" onsubmit="return false;">
                   <%-- <%=ViewData["select-donvi"] %>--%>
                    <button type="button" onclick="ShowPopUp('', '/Kntc/Ajax_xuat_kntc_chuatraloi')" class="btn_f blue"><i class="icon-print"></i></button>
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kntc/Ajax_Chuatraloi_formsearch/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-time"></i>Danh sách đơn đã chuyển đến cơ quan có thẩm quyền xử lý, giải quyết chưa có trả lời</h3>
      ...
      <script>
          ...
          function ChangeDonViTrangThai() {
              location.href = "/Kntc/Chuatraloi/?trangthai=" + $("#iTrangThai").val() + "";
          }
          function TimKiem() {
              //location.href = "/Kntc/Chuatraloi/?ikhoa=" + $("#iKyHop").val() + "&trangthai=" + $("#iTrangThai").val() + "&ip_noidung=" + $("#ip_noidung").val() + "&iCanhBao=" + $("#iCanhBao").val();
              $("#ip_data").empty().html("");
              $('#loadData').show();
              $.ajax({
                  type: "post",
                  url: "<%=Url.Action("Chuatraloi", "Kntc")%>",
                  ...
                  success: function (res) {
                      if (res) {
                          ...
                          $('#loadData').hide();
                          alert("Lỗi tìm kiếm đơn chưa trả lời!");
                      }
                  }
              });
              return false;
