    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Đơn thuộc lĩnh vực phụ trách</span>
			    </li>
		    </ul>
                ...
                <form class="search" id="form_search" method="get" onsubmit="return false;">
                    ...
                    <input type="text" name="ip_noidung" id="ip_noidung" onkeypress="if(event.keyCode==13){TimKiem()}" value="<%=ViewData["ip_noidung"] %>" placeholder="Nội dung đơn, người gửi đơn...">
                        <button type="button" title="Tìm kiếm" onclick="TimKiem()" class="btn_f blue"><i class="icon-search"></i></button>
                         ...
                         <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kntc/Ajax_Thuocthamquyen_formsearch/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-time"></i>Danh sách Đơn thuộc lĩnh vực phụ trách</h3>
      ...
      <script>
          ...
          function TimKiem() {
              location.href = "/Kntc/Thuocthamquyen/?ikhoa=" + $("#iKyHop").val() +"&ip_noidung=" + $("#ip_noidung").val();
              return false;
          }
      </script>
</asp:Content>
