...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Văn bản cử tri kiến nghị sửa đổi (đang được xem xét để sửa đổi, bổ sung)
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Văn bản cử tri kiến nghị sửa đổi (đang được xem xét để sửa đổi, bổ sung)</span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Văn bản cử tri kiến nghị sửa đổi (đang được xem xét để sửa đổi, bổ sung)
                            </h3>
    ...
    <script type="text/javascript">
        function Download(type) {
            ...
            window.location = "/Baocaokiennghi/Kiennghi_phuluc3_excel/?iKyHop=" +
        ...
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Kiennghi_phuluc3", $("#form_export").serialize(), function (ok) {
                //alert(ok);
