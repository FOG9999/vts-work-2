...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Kết quả giải quyết đối với kiến nghị tồn đọng qua nhiều kỳ họp 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Kết quả giải quyết đối với kiến nghị tồn đọng qua nhiều kỳ họp </span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i> Kết quả giải quyết đối với kiến nghị tồn đọng qua nhiều kỳ họp 
                            </h3>
                        </div>
    ...
    <script type="text/javascript">
        function Download(type) {
            ...
            //}
            window.location = "/Baocaokiennghi/Kiennghi_phuluc4_excel/?iKyHop=" +
        ...
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Kiennghi_phuluc4", $("#form_export").serialize(), function (ok) {
                //alert(ok);
