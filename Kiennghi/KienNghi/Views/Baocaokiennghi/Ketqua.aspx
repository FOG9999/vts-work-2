...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Báo cáo kết quả hoạt động của tổ đại biểu
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Báo cáo kết quả hoạt động của tổ đại biểu</span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Báo cáo kết quả hoạt động của tổ đại biểu
                            </h3>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function Download(type) {
            ...
            window.location = "/Baocaokiennghi/Kiennghi_Ketqua_excel/?iKyHop=" +
                $("#iKyHop").val() + "&iDonVi=" + $("#iDonVi").val() + "&iLinhVuc=" + $("#iLinhVuc").val() + "&iTruocKyHop=" + $('input[name="iTruocKyHop"]:checked').val() + "&iLoaiDon=" + $('input[name="iLoaiDon"]:checked').val();
        }
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Kiennghi_ketqua", $("#form_export").serialize(), function (ok) {
                //alert(ok);
        ...
        function ChangeDoiTuongGui() {
            ...
            if (!iKyHop) iKyHop = 0;
            $.post("/Kiennghi/Ajax_GetOpt_KyHopKhoaHop", 'iKyHop=' + iKyHop + '&iDoiTuongGui=' + $("input[name='iLoaiDon']:checked").val(), function (data) {
                console.log(data);
                $("#iKyHop").html(data);
