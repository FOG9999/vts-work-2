...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Bản tập hợp trả lời kiến nghị cử tri</span>
                    </li>
                </ul>
                <div class="function_chung"></div>
            </div>         
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i> Bản tập hợp trả lời kiến nghị cử tri
                            </h3>
                            ...
                            <form class="form-horizontal form-column" id="form_export" onsubmit="return Tracuu()">
                                <div class="row-fluid">                                                              
                                    ...
                                    <div class="control-group span6">
                                        ...
                                        <div class="controls">
                                            <select onchange="ChangeLinhVucByDonVI(this.value)" class="chosen-select" name="iDonVi" id="iDonVi">
    ...
    <script type="text/javascript">
        ...
        function Download(type) {
            ...
            window.location = "/Baocaokiennghi/Traloi_word/?iKyHop=" +
        ...
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Traloi", $("#form_export").serialize(), function (ok) {
                //alert(ok);
