...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Văn bản pháp luật đã ban hành có nội dung liên quan tới việc tiếp thu, giải quyết
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Văn bản pháp luật đã ban hành có nội dung liên quan tới việc tiếp thu, giải quyết</span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i> Văn bản pháp luật đã ban hành có nội dung liên quan tới việc tiếp thu, giải quyết
                            </h3>
                        </div>
                            ...
                            <form class="form-horizontal form-column" id="form_export" onsubmit="return Tracuu()">
                                <div class="row-fluid">                                                              
                                    ...
                                    <div class="control-group span6">
                                        ...
                                        <div class="controls">
                                            <select class="chosen-select" name="iDonVi" onchange="ChangeLinhVucByDonVI(this.value)" id="iDonVi">
    ...
    <script type="text/javascript">
        ...
        function Download(type) {
            ...
            window.location = "/Baocaokiennghi/Kiennghi_phuluc2_excel/?iKyHop=" +
        ...
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Kiennghi_phuluc2", $("#form_export").serialize(), function (ok) {
                //alert(ok);
