...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Danh mục kiến nghị cử tri gửi tới đang trong quá trình giải quyết
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid ">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Danh mục kiến nghị cử tri gửi tới đang trong quá trình giải quyết </span>
                    </li>
                </ul>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-search"></i>Danh mục kiến nghị cử tri gửi tới đang trong quá trình giải quyết
                            </h3>
    ...
    <script type="text/javascript">
        function Download(type) {
            ...
            window.location = "/Baocaokiennghi/Kiennghi_phuluc5b_excel/?iKyHop=" +
        ...
        function Tracuu() {
            ...
            $.post("/Baocaokiennghi/Ajax_Kiennghi_phuluc5b", $("#form_export").serialize(), function (ok) {
                //alert(ok);
