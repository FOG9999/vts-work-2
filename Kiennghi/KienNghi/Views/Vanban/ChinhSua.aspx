            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-tags"></i>Chỉnh sửa văn bản</h3>

                        </div>
                        <div class="box-content" style="text-align: left;">        
                                <% VB_VANBAN don = (VB_VANBAN)ViewData["don"]; %>
                            <form method="post" name="_form" id="_form" onsubmit="return CheckForm();" enctype="multipart/form-data" class="form-horizontal form-column">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" value="<%=ViewData["cTieude"] %>" name="cTieude" id="cTieude" class="input-block-level" />
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-block-level">
                                              <input type="text" value="<%=ViewData["dDate"] %>" name="dDate" id="dDate" class="input-block-level datepick" autocomplete ="off"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                         <div class="input-block-level">
                                       <textarea name="cTrichyeu" id="cTrichyeu" class="input-block-level"> <%=ViewData["cTrichyeu"] %> </textarea>
                                             </div>
                                    </div>
                                </div>
                                </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select name="iDonvi" id="iDonvi" class="input-block-level chosen-select" onchange="ChangeLinhVucByDonVI(this.value)">
                                                ...
                                                <option value="-1" class="b" selected><span class="b">Nhiều đơn vị ban hành</span></option>
                                                <%=ViewData["opt_donvi"] %>
                                            </select>
                                ...
                                <div class="span6">
                                  ...
                                  <% string dStlye = " display:none";
                                               if (Convert.ToInt32(ViewData["idonvi"]) >1)
                                               {
                                                   dStlye = " display:block";
                                               }
                                            %>
                                <div class="row-fluid" id="hienthi" style="margin-top:1%;<%=dStlye%>" >
                                <div class="span12">
                                    <div class="control-group">
