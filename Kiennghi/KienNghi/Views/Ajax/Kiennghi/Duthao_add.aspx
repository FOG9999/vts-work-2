            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"> </i> <%=ViewData["title"] %>
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" id="form_" enctype="multipart/form-data" action="/Kiennghi/Duthao_insert/" class="form-horizontal" onsubmit="return CheckForm()"> 
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <input type="text" class="input-medium datepick" value="<%=DateTime.Now.ToString("dd/MM/yyyy") %>" name="dNgayBanHanh" id="dNgayBanHanh" autocomplete ="off"/>
							        </div>
						        </div>  
                                <div class="control-group">
							        <label for="textfield" class="control-label ">Người ký</label>
							        <div class="controls">
                                        <input type="text" class="input-medium" name="cNguoiKy" id="cNguoiKy" />
							        </div>
						        </div>  
                                <div class="control-group">
