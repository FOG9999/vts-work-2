        		...
        		<div class="span12">
                    <div class="box box-color">
                        ...
                        <div class="box-content popup_info">
                            <form onsubmit="return CheckForm();" method="post" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_tra_nguonluc_update" >
