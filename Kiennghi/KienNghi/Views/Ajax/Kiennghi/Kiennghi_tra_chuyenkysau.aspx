        		...
        		<div class="span12">
                    <div class="box box-color">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" onsubmit="return CheckForm();" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_tra_chuyenkysau_insert" >
