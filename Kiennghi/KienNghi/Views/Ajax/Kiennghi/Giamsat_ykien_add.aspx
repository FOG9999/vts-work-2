        		...
        		<div class="span12">
                    <div class="box box-color">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat()" enctype="multipart/form-data" action="/Kiennghi/Giamsat_ykien_insert" >                                
                                 <div class="control-group">
							        <label for="textfield" class="control-label ">Ngày làm việc <i class="f-red">*</i></label>
							        <div class="controls">
                                        <input type="text" class="input-medium datepick" value="<%=DateTime.Now.ToString("dd/MM/yyyy") %>" name="DNGAYLAMVIEC" id="DNGAYLAMVIEC" />
							        </div>
						        </div>  
                                <div class="control-group">
						        ...
						        <div class="form-actions nomagin">
                                    <button type="submit" class="btn btn-success">Lưu ý kiến giám sát</button>
