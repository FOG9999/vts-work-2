            ...
            <div class="box-content popup_info" style="padding:0px !important">
                <form id="form_" method="post" onsubmit="return CheckFormSearch();" class="form-horizontal form-column">     
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                <label for="textfield" class="control-label  ">Đơn vị Tập hợp:</label>
                                <div class="controls">
                                    <div class="input-block-level">
...
<script type="text/javascript">
    ...
    function CheckFormSearch() {
        ...
        //window.location = "/Kiennghi/Tonghop_diaphuongchuyen/?" + $("#form_").serialize();
        ...
        //$.post("/Kiennghi/Ajax_search_tonghop_diaphuongchuyen_result", $("#form_").serialize(), function (ok) {
        //    $("#q_data").html(ok);
        //});
        //return false;
    }
