...
<script type="text/javascript">
    ...
    function CheckFormSearch() {
        location.href = "/Kiennghi/Tonghop_bandannguyen_chuyen/?" + $("#form_").serialize();
        //$("#q_data").html("<tr><td colspan=4 class='tcenter'><p class='tcenter'><img src='/Images/ajax-loader.gif'/></p></td></tr>");
        //$.post("/Kiennghi/Ajax_search_tonghop_bandannguyen_chuyen_result", $("#form_").serialize(), function (ok) {
        //    $("#q_data").html(ok);
        //});
        return false;
    }
