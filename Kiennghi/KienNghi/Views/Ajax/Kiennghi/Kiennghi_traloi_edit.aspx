                            ...
                            <form onsubmit="return CheckForm();" method="post" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_traloi_update" >
                                ...
                                <div class="row-fluid">
                                    <div class="control-group span6">
                                        ...
                                        <div class="controls">
                                            <select id="iDonViTraLoi" name="Đơn vị trả lời" class="chosen-select">
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                       <div class="control-group">
							                ...
							                <div class="controls">
                                                <input value="<%=Server.HtmlEncode(t.CCOQUANTRALOI) %>" type="text" name="cCoQuanTraLoi" id="cCoQuanTraLoi" class="input-block-level" />
							                </div>
						                </div>
                                   </div>
                                </div>
                                ...
                                <div class="row-fluid">
                                        <div class="control-group">
							                ...
							                <div class="controls">
                                                <textarea class="input-block-level" rows="4" id="cGhiChu" name="cGhiChu"><%=Server.HtmlEncode(t.GHICHU_KQ ) %></textarea>
							                </div>
						                </div>
                                    </div> 
