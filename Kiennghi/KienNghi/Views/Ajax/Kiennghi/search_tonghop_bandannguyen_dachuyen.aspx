                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <option value="0">- - - Chọn tất cả</option><%=ViewData["opt-donvixuly"] %></select>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function CheckFormSearch() {
        ...
        //$.post("/Kiennghi/Ajax_search_tonghop_bandannguyen_dachuyen_result", $("#form_").serialize(), function (ok) {
        //    $("#q_data").html(ok);
        //});
        return false;
    }
