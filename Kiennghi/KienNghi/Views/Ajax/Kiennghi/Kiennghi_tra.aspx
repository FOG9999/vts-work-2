            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Trả lại kiến nghị
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" onsubmit="return CheckForm();" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_traloi_insert" >
                                <div class="row-fluid">
                                   <div class="span6">
						        ...
						        <div class="form-actions nomagin">
                                    <input type="hidden" name="iTinhTrang" value="2" />
