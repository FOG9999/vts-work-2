    ...
    <div class="span12">
        <div class="box box-color">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3><i class="icon-search"></i>Tìm kiếm nâng cao đơn đủ điều kiện xử lý, giải quyết</h3>
                </div>
...
<script>
    ...
    function CheckForm() {
        ...
        //window.location = "/Kntc/Dudieukien/?" + $("#form_").serialize();
        //alert(window.location);
        //location.href = "/Kntc/Dudieukien/?" + pramt;
        $("#ip_data").empty().html("");
        $('#loadData').show();
        $.ajax({
            type: "post",
