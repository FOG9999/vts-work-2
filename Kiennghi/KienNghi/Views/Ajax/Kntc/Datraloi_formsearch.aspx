    ...
    <div class="span12">
        <div class="box box-color">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3><i class="icon-search"></i>Tìm kiếm nâng cao đơn đã chuyển xử lý, có văn bản trả lời</h3>
                </div>
                ...
                <form id="form_" method="post" onsubmit="return CheckForm();">
                        <table class="table table-bordered form4">
                            ...
                            <tr>
                                 <td>Trạng thái</td>
                                <td >
                                    <select name="trangthai" id="trangthai" class="input-block-level">
...
<script>
    ...
    function CheckForm() {
        ...
        //location.href = "/Kntc/Datraloi/?" + pramt;
        $("#ip_data").empty().html("");
        $('#loadData').show();
        $.ajax({
            type: "post",
            url: "<%=Url.Action("Datraloi", "Kntc")%>",
                ...
                success: function (res) {
                    if (res) {
                        ...
                        $('#loadData').hide();
                        alert("Lỗi tìm kiếm đơn đã trả lời!");
                    }
                }
            });
        return false;
