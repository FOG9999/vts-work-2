            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Cập nhật kế hoạch giám sát
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <% KNTC_GIAMSAT g = (KNTC_GIAMSAT)ViewData["g"];%>
                            <form method="post" name="_form" onsubmit="return CheckForm()"  action="/Kntc/Ajax_Giamsat_update" id="_form" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <input type="text" value="<%=g.CKEHOACH %>" class="input-block-level" name="cKeHoach" id="cKeHoach" />
							        </div>
						        </div>
                                <div class="control-group">
							        <label for="textfield" class="control-label">Chuyên đề<span class=" f-red">*</span></label>
							        <div class="controls">
                                        <input type="text" value="<%=g.CCHUYENDE %>" class="input-block-level" name="cChuyenDe" id="cChuyenDe" />
							        </div>
						        </div>
                                <div class="control-group">
							        <label for="textfield" class="control-label">Ý kiến đoàn giám sát</label>
							        <div class="controls">
                                        <textarea class="input-block-level" name="cNoiDung" id="cNoiDung"><%=g.CNOIDUNG %></textarea>
							        </div>
						        </div>
                                <div class="control-group">
