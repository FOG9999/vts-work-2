            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color">
                        <div class="box-title">
                            <h3>
                                <i class="icon-reorder"></i>Nhập lý do trùng đơn, lưu theo dõi
                            </h3>
                            <ul class="tabs">
                                <li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="__form" action="/Kntc/Ajax_Lydotrung_insert" id="_form" onsubmit="return CheckFormL();" class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Số lượng trùng<span class=" f-red">*</span></label>
                                    <div class="controls">
                                        <input type="text" id="iSoLuongTrung" name="iSoLuongTrung" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Ghi chú<span class=" f-red">*</span></label>
                                    <div class="controls">
                                        <textarea class="input-block-level" id="cLuuTheoDoi_LyDo" name="cLuuTheoDoi_LyDo"></textarea>
                                    </div>
                                </div>
                                <input type="hidden" name="id" value="<%=ViewData["id"] %>" />
                                <input type="hidden" name="idontrung" value="<%=ViewData["itrung"] %>" />
