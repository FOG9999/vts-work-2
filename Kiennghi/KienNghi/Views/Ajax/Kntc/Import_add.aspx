...
<div class="row-fluid">
    <div class="span12">
        <div class="box box-color box-bordered">
			<div class="box-title">
				<h3 >
					<i class="icon-reorder"></i> Thực hiện import dữ liệu khiếu nại tố cáo
				</h3>
                <ul class="tabs">
					<%-- <li class="active">
...
<script type="text/javascript">
    ...
    function CapNhat() {
        ...
        $.post("/Kntc/InsertFile_Kntc_Import", 'ghichu=' + $("#CGHICHU").val(), function (data) {
    ...
    function CheckFileImpport() {
        ...
        xhr.open('POST', '/Kntc/Check_import_insert');
        xhr.send(formdata);
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                $("#div_dataUpload").html(xhr.responseText);
                $.post("/Kntc/Get_status_check_file_import", function (data) {
