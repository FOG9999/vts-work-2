    ...
    <div class="span12">
        <div class="box box-color">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3><i class="icon-search"></i>Tìm kiếm nâng cao đơn thuộc thẩm quyền xử lý</h3>
                </div>
...
<script>
    ...
    function CheckForm() {
        ...
        //window.location = "/Kntc/Thuocthamquyen/?" + $("#form_").serialize();
        //alert(window.location);
        location.href = "/Kntc/Thuocthamquyen/?" + pramt;
        return false;
    }
</script>
