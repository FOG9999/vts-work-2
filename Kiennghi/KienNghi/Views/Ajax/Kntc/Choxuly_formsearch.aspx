    ...
    <div class="span12">
        <div class="box box-color">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3><i class="icon-search"></i>Tìm kiếm nâng cao đơn chờ xử lý</h3>
                </div>
                    ...
                    <form id="form_" method="post" onsubmit="return CheckForm();">
                        <table class="table table-bordered form4">
                            ...
                            <tr>
                                ...
                                <td>Điều kiện xử lí</td>
                                <td>
                                    <select id="iDieuKienXuLy" name="iDieuKienXuLy" class="chosen-select">
...
<script>
    ...
    $("#iDiaPhuong_0").chosen();
    $("#iDieuKienXuLy").chosen();
    $("#ikhoa").chosen();
    function CheckForm() {
        var params = $("#form_").serialize();
        //window.location = "/Kntc/Choxuly/?" + $("#form_").serialize();
        //alert(window.location);
        //location.href = "/Kntc/Choxuly/?" + params;
