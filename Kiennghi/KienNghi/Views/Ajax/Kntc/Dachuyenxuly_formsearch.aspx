    ...
    <div class="span12">
        <div class="box box-color">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    <h3><i class="icon-search"></i>Tìm kiếm nâng cao đơn đã chuyển xử lý, giải quyết</h3>
                </div>
                    ...
                    <form id="form_" method="post" onsubmit="return CheckForm();">
                        <table class="table table-bordered form4">
                            <tr>
                                <td class="">Từ khóa</td>
                                <td colspan="3">
                                    <input type="text" name="cNoiDung" placeholder="Nội dung đơn, người gửi đơn..." class="input-block-level" />
                                </td>
                            </tr>
                            <tr>
                                  <td>Trạng thái xử lý</td>
                                <td>
                                    <select class="input-block-level chosen-select" name="trangthai" id="trangthai">
                                        <%=ViewData["select-trangthai"] %>
                                    </select>
                                </td>
                                <td>Đơn vị thụ lý</td>
                                <td>
                                    <select class="input-block-level chosen-select" name="idonvi" id="idonvi">
                            ...
                            <tr>
                                ...
                                <td class="">Tỉnh thành </td>
                                <td >
                                    <select name="iDiaPhuong_0" id="iDiaPhuong_0">
                                        <option value="0">Chọn tất cả</option>
                                        <%=ViewData["opt-tinh"] %>
                                    </select>
                                </td>
...
<script>
    ...
    function CheckForm() {
        ...
        $.post("/Kntc/Ajax_Dachuyenxuly_searchtotal", $("#form_").serialize(), function (ok) {
            $("#ip_data").html(ok);
        });
        return false;
    }
