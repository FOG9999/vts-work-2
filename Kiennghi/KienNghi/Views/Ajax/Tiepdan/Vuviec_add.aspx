        		...
        		<div class="span12">
                    <div class="box box-color">
                        ...
                        <div class="box-content popup_info nopadding">
                            <form method="post" id="form_" class="nomargin" action="/TiepDan/Vuviec_insert" onsubmit="return CheckForm();" enctype="multipart/form-data">
                            
                                <table class="table table-condensed table-bordered form4">
                                    <tr>
                                        <td class="f-red" width="15%">Người tiếp *</td>
                                        <td width="35%">
                                            <input type="text" name="cNguoiTiep" id="cNguoiTiep" class="input-block-level" />
                                        </td>
                                        <td class="" width="15%">Đoàn đông người</td>
                                        <td width="35%">
                                            <input type="checkbox" name="iDoan" class="nomargin" onchange="$('#doan').toggle();" /> 
