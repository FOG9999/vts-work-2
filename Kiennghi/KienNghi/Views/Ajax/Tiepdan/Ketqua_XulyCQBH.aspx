            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Chuyển xử lý đến cơ quan có thẩm quyền
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" action="/Tiepdan/Ajax_Chuyenxuly_noibo_insert" id="_form" enctype="multipart/form-data" class="form-horizontal" onsubmit="return CapNhat()">
                                 ...
                                 <div class="control-group">
							        ...
							        <div class="controls">
                                        <textarea class="input-block-level" name="cKinhGui"></textarea>
							        </div>
						        </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <textarea class="input-block-level" name="cNoiNhan"></textarea>
							        </div>
						        </div>
                                <div class="control-group">
