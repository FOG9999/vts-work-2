            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Thêm mới tài khoản
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                               <div class="control-group">
							        ...
							        <div class="controls">
                                        <input type="text" value="" onchange="CheckUsername();" name="cUsername" id="cUsername" class="input-xlarge" />
                                        <span id="alert_user"></span>
							        </div>
						        </div>
                                <div class="control-group">
							        <label for="textfield" class="control-label ">Mật khẩu <i class="f-red">*</i></label>
							        <div class="controls">
                                        <p> <input type="password" value="" onkeyup="ChangePass();" name="cPassword" id="cPassword" class="input-xlarge" />
                                            <span id="result"></span> 
                                        </p>
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <input type="text" value="" name="cTen" id="cTen" class="input-xxlarge" />
							        </div>
						        </div>
                            ...
                            <label for="textfield" class="control-label "  >Thuộc phòng ban</label>
                                ...
                                <div class="control-group ">
							       ...
							       <div class="span6" style="width:50% !important;margin-left:10% !important"><label for="textfield" class="control-label " >Chức vụ</label>
							        <div class="controls" id ="loadChucVu">
                                ...
                                <div class="control-group ">
                                    <div class="span6" style="width:30% !important">
                                          <label for="textfield" class="control-label f-">Email</label>
							        <div class="controls">
                                        <input type="text" value="" name="cEmail" id="cEmail" class="input-xxlarge" />
							        </div>
                                    </div>
                                      <div class="span6" style="width:50% !important;margin-left:10% !important">
                                          <label for="textfield" class="control-label">Số điện thoại</label>
							        <div class="controls">
                                        <input type="text" value="" name="cSDT" id="cSDT" class="input-xxlarge" />
							        </div>
                                      </div>
...
<script type="text/javascript">
    ...
    function CheckUsername() {
        if ($("#cUsername").val() != "") {
            $.post("<%=ResolveUrl("~")%>Thietlap/Ajax_Taikhoan_CheckUsername",
                "id_user=0&username=" + $("#cUsername").val(),
                function (data) {
                    $("#check_user").val(data);
                    if (data == 1) {
...
<%--    function LoadDonVi() {
        alert(1);
            $.post("<%=ResolveUrl("~")%>Thietlap/Ajax_Load_Opt_donvi",  function (data) {
                $("#loaddonvi").html("<select name='iDonVi' id='iDonVi' class='input-xxlarge'><option value='0'>- - - Chọn đơn vị</option>" + data + "</select>");
                $("#iDonVi").chosen();
            });
    }--%>
    function ChangePass() {
    ...
    function checkStrength(password) {
        ...
        if (!(password.match(/([a-zA-Z])/) && password.match(/([0-9])/))) {
            ...
            //Bo sung phan nay de sua tam cho viec check password sai lien tuc
            strength = 2;
            $("#streng_pass").val(strength);
    ...
    function CapNhat() {
        ...
        if ($("#cPassword").val() == "") {
            alert("Vui lòng nhập mật khẩu!"); $("#cPassword").focus(); return false;
        }
        if ($("#cTen").val() == "") {
        ...
        $.post("/Thietlap/Ajax_Taikhoan_insert", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
            } else {
                alert(ok);
