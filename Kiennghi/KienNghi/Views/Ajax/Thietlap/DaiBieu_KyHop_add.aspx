            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Thêm kỳ họp thuộc đại biểu: <%=ViewData["cTen"] %>
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                              <input name="iddaibieu" id="iddaibieu" value="<%=ViewData["iddaibieu"] %>" type="hidden" />                         
                                    <div class="control-group">
							        <label for="textfield" class="control-label">Tên kỳ họp</label>
							        <div class="controls">
...
<script type="text/javascript">
    function CapNhat() {
        ...
        $.post("/Thietlap/Ajax_DaiBieu_KyHop_insert", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
