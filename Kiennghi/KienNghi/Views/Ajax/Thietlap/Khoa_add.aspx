            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color">
                        <div class="box-title">
                            <h3>
                                <i class="icon-reorder"></i>Thêm mới khóa
                            </h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <span class="span4">
                                            <label><input class="nomargin" type="radio"  name="iLoai" value="0" checked/>
                                            Quốc hội</label>
                                        </span>
                                        <span class="span4">
                                            <label><input class="nomargin" type="radio"  name="iLoai" value="1"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="" name="cTen" id="cTen" onchange="kiemtrungten()" class="input-block-level" />
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function CapNhat() {
        ...
        $.post("/Thietlap/Ajax_Khoa_insert", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
