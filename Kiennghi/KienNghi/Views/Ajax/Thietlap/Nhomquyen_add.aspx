            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Thêm mới nhóm tài khoản
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <textarea name="cMoTa" id="cMoTa" class="input-block-level" ></textarea>
							        </div>
						        </div>
...
<script type="text/javascript">
    function CapNhat() {
        ...
        $.post("/Thietlap/Ajax_Nhomtaikhoan_insert", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
