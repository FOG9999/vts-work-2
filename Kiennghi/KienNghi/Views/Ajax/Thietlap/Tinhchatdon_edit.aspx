            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Cập nhật tính chất đơn
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <% KNTC_TINHCHAT linhvuc = (KNTC_TINHCHAT)ViewData["Tinhchatdon"]; %>
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();" >
                              <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<%=Server.HtmlEncode(linhvuc.CCODE) %>"  name="cCode" id="cCode" class="input-medium" autofocus/>
                                    </div>
                                </div>
                                 <div class="control-group">
...
<script type="text/javascript">
    ...
    function CapNhat() {
        ...
        if ($("#iNhomnoidung").val() == 0) {
            alert("Vui lòng chọn nhóm nội dụng đơn"); $("#iNhomnoidung").focus();
            return false;
        }
        $(".form-actions").html("<p class=''>Đang xử lý, vui lòng đợi! &nbsp;&nbsp;&nbsp;<img src='/Images/ajax-loader.gif' /></p>");
        $.post("/Thietlap/Ajax_Tinhchatdon_update", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
