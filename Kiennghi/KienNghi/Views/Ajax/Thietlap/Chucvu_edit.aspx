            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Cập nhật chức vụ
							</h3>
                            <ul class="tabs">
								<li class="active">
                          ...
                          <% USER_CHUCVU chucvu = (USER_CHUCVU)ViewData["chucvu"]; %>
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<%=Server.HtmlEncode(chucvu.CCODE) %>"  name="cCode" id="cCode" class="input-medium"/>
                                    </div>
                                </div>
                                 <div class="control-group">
							        <label for="textfield" class="control-label ">Tên chức vụ <i class="f-red">*</i></label>
							        <div class="controls">
                                        <input type="text" value="<%=Server.HtmlEncode(chucvu.CTEN )%>"  name="cTen" id="cTen" class="input-block-level" autofocus />
							        </div>
						        </div>
                                <div class="control-group">
...
<script type="text/javascript">
    ...
    function CapNhat() {
        ...
        $.post("/Thietlap/Ajax_Chucvu_update", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
