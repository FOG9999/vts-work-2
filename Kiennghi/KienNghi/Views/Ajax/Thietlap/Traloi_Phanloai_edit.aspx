                        ...
                        <div class="box-content popup_info">
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<%= Server.HtmlEncode(ViewData["code"].ToString()) %>" name="cCode" id="cCode" class="input-medium"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label ">Tên trả lời phân loại <i class="f-red">*</i></label>
                                    <div class="controls">
                                        <input type="text" value="<%=Server.HtmlEncode(ViewData["ten"].ToString()) %>" name="cTen" id="cTen" class="input-block-level"   />
                                    </div>
                                </div>
                                <div class="control-group">
...
<script type="text/javascript">
    ...
    function CapNhat() {
        ...
        $.post("/Thietlap/Ajax_Traloi_Phanloai_update", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
