            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Cập nhật nguồn kiến nghị
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <% KN_NGUONDON linhvuc = (KN_NGUONDON)ViewData["Nguondon"]; %>
                            <form method="post" name="_form" id="_form" class="form-horizontal" onsubmit="return CapNhat();">
                               <div class="control-group">
							        <label for="textfield" class="control-label">Mã nguồn kiến nghị</label>
							        <div class="controls">
                                 ...
                                 <div class="control-group">
							        <label for="textfield" class="control-label ">Tên nguồn kiến nghị <i class="f-red">*</i></label>
							        <div class="controls">
                                        <input type="text" value="<%=Server.HtmlEncode(linhvuc.CTEN) %>"  name="cTen" id="cTen" class="input-block-level" onchange="kiemtrungten()" />
							        </div>
						        </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Thuộc nguồn kiến nghị</label>
                                    <div class="controls">
...
<script type="text/javascript">
    ...
    function CapNhat() {
        if ($("#cTen").val() == "") {
            alert("Vui lòng nhập nguồn kiến nghị"); $("#cTen").focus();
            return false;
        }
        $(".form-actions").html("<p class=''>Đang xử lý, vui lòng đợi! &nbsp;&nbsp;&nbsp;<img src='/Images/ajax-loader.gif' /></p>");
        $.post("/Thietlap/Ajax_Nguonkiennghi_update", $("#_form").serialize(), function (ok) {
            if (ok == 1) {
                location.reload();
                AlertAction("Cập nhật thành công");
            } else {
                alert("Mã nguồn kiến nghị đã tồn tại, Vui lòng kiểm tra lại!");
