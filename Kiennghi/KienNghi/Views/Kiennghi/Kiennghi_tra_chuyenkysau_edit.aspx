            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Chuyển kiến nghị theo dõi kỳ sau
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form onsubmit="return CheckForm();" method="post" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_tra_chuyenkysau_update" >
                                <% KN_KIENNGHI_TRALOI t = (KN_KIENNGHI_TRALOI)ViewData["traloi"]; %>
                                   
                                
                                
                                <div class="control-group">
							        <label for="textfield" class="control-label ">Lý do chuyển <i class="f-red">*</i></label>
							        <div class="controls">
...
<script type="text/javascript">
    function CheckForm() {
        if ($("#cNoiDung").val() == "") { alert("Vui lòng nhập lý do chuyển!"); $("#cNoiDung").focus(); return false;}
    }
</script>
