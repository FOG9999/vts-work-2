            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"></i> Cập nhật kết quả chưa có nguồn lực giải quyết
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info">
                            <form method="post" onsubmit="return CheckForm();" name="_form" id="_form" class="form-horizontal" enctype="multipart/form-data" action="/Kiennghi/Kiennghi_tra_nguonluc_insert" >
                                <div class="control-group">
							        <label for="textfield" class="control-label ">Nội dung <i class="f-red">*</i></label>
							        <div class="controls">
                                        <input type="text" name="cNoiDung" id="cNoiDung" class="input-block-level" value="" />
...
<script type="text/javascript">
    $("#cNoiDung").focus();
    function CheckForm() {
        if ($("#cNoiDung").val() == "") { alert("Vui lòng nhập nội dung!"); $("#cNoiDung").focus(); return false;}
    }
</script>