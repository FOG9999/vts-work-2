...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tập hợp kiến nghị chưa có trả lời
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Tập hợp kiến nghị chưa có trả lời</span>
                    </li>
                </ul>
            ...
            <div class="function_chung">
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_chuatraloi/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-tags"></i>Tập hợp kiến nghị chưa có trả lời</h3>
                            ...
                            <table class="table table-bordered table-condensed">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="">Ghi chú / Nội dung kiến nghị</th>
                                        <th class="tcenter" nowrap width="10%">Tình trạng</th>
                                        <th class="tcenter" nowrap width="5%">Trả lời kiến nghị</th>
    ...
    <script type="text/javascript">
        ...
        function ChangeDonVi_KyHop() {
            ...
            location.href = "/Kiennghi/Chuatraloi/?" + pramt;
        ...
        function TimKiem() {
            ...
            //}
            var pramt = $("#form_header").serialize();
            //location.href = "/Kiennghi/Chuatraloi/?q=" + $("#q").val() + "&" + pramt + "&iCanhBao=" + $("#iCanhBao").val();
            $("#ip_data").empty().html("");
            $('#loadData').show();
            $.ajax({
                type: "post",
                url: "<%=Url.Action("Chuatraloi", "Kiennghi")%>",
                ...
                success: function (res) {
                    if (res) {
                        ...
                        $('#loadData').hide();
                        alert("Lỗi tìm kiếm tập hợp kiến nghị chưa có trả lời!");
                    }
                }
            });
            return false;
