...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tập hợp kiến nghị chờ xử lý</span>
			    </li>
		    </ul>
		    
	    </div>
                  <div class="function_chung">
                <a <%=ViewData["bt-add"] %> onclick="ShowPageLoading()" data-original-title="Tạo Tập hợp và chuyển xử lý" rel="tooltip" href="/Kiennghi/Chontonghop/" class="add btn_f blue" ><i class="icon-plus-sign"></i></a>
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">                    
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_tonghop/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i> Tập hợp kiến nghị chờ xử lý
                            ...
                            <table class="table table-bordered table-condensed table-striped">
                                <thead>
                                    <tr >
                                        ...
                                        <th class="tcenter" nowrap width="20%">Thẩm quyền xử lý </th> 
   ...
   <script type="text/javascript">
       function ChangeDonVi_KyHop() {
           ...
           location.href = "/Kiennghi/Tonghop/?" + pramt;
       }
       function TimKiem() {
           var pramt = $("#form_header").serialize();
           location.href = "/Kiennghi/Tonghop/?" + pramt + "&q=" + $("#q").val();
            //$("#q_data").html("<tr><td colspan=4 class='tcenter'><p class='tcenter'><img src='/Images/ajax-loader.gif'/></p></td></tr>");
            //$.post("/Kiennghi/Ajax_search_tonghop_result", "q=" + $("#q").val() + "&" + pramt, function (ok) {
            //    $("#q_data").html(ok);
            //});
            //return false;
        }
