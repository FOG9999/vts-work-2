...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tập hợp kiến nghị chuyển Ủy ban nhân dân tỉnh
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tập hợp kiến nghị chuyển Ủy ban nhân dân tỉnh</span>
			    </li>
		    </ul>
                ...
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_tonghop_chuyendannguyen/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i> Tập hợp kiến nghị chuyển Ủy ban nhân dân tỉnh
   ...
   <script type="text/javascript">
        function ChangeDonVi_KyHop() {
            location.href = "/Kiennghi/Tonghop_chuyendannguyen/?iKyHop=" + $("#iKyHop").val() + "";
        }
        function TimKiem() {
            //if ($("#q").val() == "") {
            //    alert("Vui lòng nhập nội dung, từ khóa!"); $("#q").focus(); return false;
            //}
            location.href = "/Kiennghi/Tonghop_chuyendannguyen/?q=" + $("#q").val() + "&iKyHop=" + $("#iKyHop").val() + "";
            //$("#q_data").html("<tr><td colspan=5 class='tcenter'><p class='tcenter'><img src='/Images/ajax-loader.gif'/></p></td></tr>");
            //$.post("/Kiennghi/Ajax_search_tonghop_chuyendannguyen_result", "q=" + $("#q").val() + "&iKyHop=" + $("#iKyHop").val(), function (ok) {
            //    $("#q_data").html(ok);
            //});
            return false;
        }
