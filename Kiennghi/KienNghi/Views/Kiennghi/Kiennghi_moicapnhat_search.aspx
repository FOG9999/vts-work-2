            ...
            <div class="row-fluid">
        		<div class="span12">
                    <div class="box box-color">
						<div class="box-title">
							<h3 >
								<i class="icon-reorder"> TÌm kiếm kiến nghị cử tri mới cập nhật</i> 
							</h3>
                            <ul class="tabs">
								<li class="active">
                        ...
                        <div class="box-content popup_info" style="padding:0px !important">
                            <form id="form_" method="get" action="/Kiennghi/Moicapnhat/">     
                                <table class="table table-bordered form4">
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><span class="span5"><input type="radio" name="iTruocKyHop" id="iTruocKyHop" value="1" /> Trước kì họp</span>
                                            <span class="span5"><input type="radio" name="iTruocKyHop" id="iTruocKyHop" value="0" /> Sau kì họp</span></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Chương trình/Kế hoạch</td>
