...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tổng hợp kiến nghị chuyển Ủy ban nhân dân tỉnh
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tổng hợp kiến nghị chuyển Ủy ban nhân dân tỉnh</span>
			    </li>
		    </ul>
                ...
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_theodoi_dannguyen/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i> Tổng hợp kiến nghị chuyển Ủy ban nhân dân tỉnh
   ...
   <script type="text/javascript">
        function ChangeDonVi_KyHop() {
            location.href = "/Kiennghi/Theodoi_dannguyen/?iDonVi=" + $("#iDonVi").val() + "&iKyHop=" + $("#iKyHop").val() + "";
        }
        function TimKiem() {
            //if ($("#q").val() == "") {
            ...
            $.post("/Kiennghi/Ajax_search_theodoi_dannguyen_result", "q=" + $("#q").val() + "&iKyHop=" + $("#iKyHop").val(), function (ok) {
                $("#q_data").html(ok);
            });
            return false;
        }
