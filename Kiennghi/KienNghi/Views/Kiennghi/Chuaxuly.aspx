...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Tập hợp chưa giải quyết</span>
                    </li>
                </ul>
            ...
            <div class="function_chung">
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    <%-- <button type="button" title="Tìm kiếm" onclick="ShowPopUp('','/Kiennghi/Ajax_export_chuaxuly/')" class="btn_f blue"><i class="icon-print"></i></button>
                    --%>
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_chuaxuly/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-tags"></i>Tập hợp chưa giải quyết
    ...
    <script type="text/javascript">
        function ChangeDonVi_KyHop() {
            ...
            location.href = "/Kiennghi/Chuaxuly/?" + pramt;
        ...
        function TimKiem() {
            ...
            //}
            var pramt = $("#form_header").serialize();
            //location.href = "/Kiennghi/Chuaxuly/?q=" + $("#q").val() + "&" + pramt + "&iCanhBao=" + $("#iCanhBao").val();
            $("#ip_data").empty().html("");
            $('#loadData').show();
            $.ajax({
                type: "post",
