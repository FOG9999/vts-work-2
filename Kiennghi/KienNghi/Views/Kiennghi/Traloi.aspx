...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <span>Tập hợp đã giải quyết</span>
                    </li>
                </ul>
            ...
            <div class="function_chung">
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                     <%--<button type="button" title="Tìm kiếm" onclick="ShowPopUp('','/Kiennghi/Ajax_export_traloi/')" class="btn_f blue"><i class="icon-print"></i></button>
                    --%>
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_traloi/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-tags"></i>Tập hợp đã giải quyết
                            </h3>
                            ...
                            <table class="table table-bordered table-condensed ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="" width="30%">Ghi chú</th>
                                        <th class="tcenter" nowrap width="10%">Tình trạng</th>
    ...
    <script type="text/javascript">
        function ChangeDonVi_KyHop() {
            ...
            location.href = "/Kiennghi/Traloi/?" + pramt;
        ...
        function TimKiem() {
            ...
            //window.location = "/Kiennghi/Moicapnhat/?" + $("#form_").serialize();
            //alert(window.location);
            //location.href = "/Kiennghi/Traloi/?q=" + $("#q").val() + "&" + pramt + "&iCanhBao=" + $("#iCanhBao").val();
            $("#ip_data").empty().html("");
            $('#loadData').show();
            $.ajax({
                type: "post",
                url: "<%=Url.Action("Traloi", "Kiennghi")%>",
                ...
                success: function (res) {
                    if (res) {
                        ...
                        $('#loadData').hide();
                        alert("Lỗi tìm kiếm tập hợp đã giải quyết!");
                    }
                }
            });
            return false;
