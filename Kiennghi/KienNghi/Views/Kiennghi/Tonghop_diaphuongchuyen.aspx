...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tập hợp kiến nghị các đoàn chuyển đến 
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tập hợp kiến nghị các đoàn chuyển đến  </span>
			    </li>
		    </ul>
            
	    </div>  
                  <div class="function_chung">
                      <a  data-original-title="Xuất Excel" onclick="ExportExcel()" rel="tooltip" href="javascript:void(0)" class="add btn_f blue" ><i class="icon-download-alt"></i></a>
                <%--<a <%=ViewData["bt-add"] %> data-original-title="Thêm Tập hợp kiến nghị" rel="tooltip" href="/Kiennghi/Chontonghop/" class="add btn_f blue" ><i class="icon-plus-sign"></i></a>--%>
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_tonghop_diaphuongchuyen/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i> Tập hợp kiến nghị các đoàn chuyển đến 
                            ...
                            <table class="table table-bordered table-condensed <%--table-striped--%>">
                                <thead>
                                    <tr >
                                        ...
                                        <th class="" >Ghi chú</th>
                                        <th width="40%" class="tcenter" nowrap>Đoàn Tập hợp/</br>Thẩm quyền - Trả lời kiến nghị</th>
   ...
   <script type="text/javascript">
       function ExportExcel() {
           ...
           window.location = "/Kiennghi/Download_Baocaokiennghi/?" + pramt;
       }
       function ChangeDonVi_KyHop() {
           var pramt = $("#form_header").serialize();
           //window.location = "/Kiennghi/Moicapnhat/?" + $("#form_").serialize();
           //alert(window.location);
           location.href = "/Kiennghi/Tonghop_diaphuongchuyen/?" + pramt;
           //location.href = "/Kiennghi/Moicapnhat/?iDoan=" + $("#iDonVi").val() + "&iKyHop=" + $("#iKyHop").val() + "";
       }
       function TimKiem() {
           var pramt = $("#form_header").serialize();
           location.href = "/Kiennghi/Tonghop_diaphuongchuyen/?q=" + $("#q").val() + "&" + pramt;
            //if ($("#q").val() == "") {
            ...
            //$.post("/Kiennghi/Ajax_search_tonghop_diaphuongchuyen_result", "q=" + $("#q").val() + "&iKyHop=" + $("#iKyHop").val(), function (ok) {
            //    $("#q_data").html(ok);
            //});
            return false;
        }
