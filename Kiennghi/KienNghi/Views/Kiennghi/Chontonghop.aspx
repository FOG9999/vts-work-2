...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  Thêm mới Tập hợp kiến nghị cử tri
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Thêm mới Tập hợp kiến nghị cử tri</span>                    
			    </li>                
		    </ul>		    
	    </div>                     
           <div class="row-fluid">
                <div class="span12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-tags"></i>Thêm mới Tập hợp kiến nghị cử tri</h3>
                            ...
                            <form method="post" name="_form" id="_form"  onsubmit="return CapNhat();" enctype="multipart/form-data" class="form-horizontal form-column">
                                ...
                                <div class="row-fluid" style="margin-top: 1%">
                                    <div class="span12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-block-level">
                                                    <textarea  name="cNoiDung" id="cNoiDung" rows="10" class="input-block-level"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row-fluid" style="border-bottom: 1px solid #fff">
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" id="btn-submit">Lưu và thêm kiến nghị</button>
