...
<div class="control-group">
    ...
    <div class="controls nopadding">
        <table class="table table-bordered table-condensed" style="border-right:1px solid #ddd;border-top:1px solid #ddd;">
            ...
            <%=ViewData["lichtiep"] %>
            <tr>
                <td colspan="5" class="tright"><span title='' onclick="PlusCP(1)" id="bt-add" rel='tooltip' data-original-title='Thêm mới lịch' class="btn btn-primary"><i class="icon-plus-sign"></i></span></td>
            </tr>
        </table>
