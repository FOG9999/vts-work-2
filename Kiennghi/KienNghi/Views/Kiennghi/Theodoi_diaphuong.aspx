...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tổng hợp kiến nghị thuộc thẩm quyền địa phương
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tổng hợp kiến nghị thuộc thẩm quyền địa phương</span>
			    </li>
		    </ul>
                ...
                <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                    ...
                    <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_theodoi_diaphuong/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3><i class="icon-tags"></i> Tổng hợp kiến nghị thuộc thẩm quyền địa phương
                            ...
                            <table class="table table-bordered table-condensed table-striped">
                                <thead>
                                    <tr >
                                        ...
                                        <th width="35%">Tình trạng xử lý</th>
   ...
   <script type="text/javascript">
        function ChangeDonVi_KyHop() {
            location.href = "/Kiennghi/Theodoi_diaphuong/?iDonVi=" + $("#iDonVi").val() + "&iKyHop=" + $("#iKyHop").val() + "";
        }
        function TimKiem() {
            //if ($("#q").val() == "") {
            ...
            $.post("/Kiennghi/Ajax_search_theodoi_diaphuong_result", "q=" + $("#q").val() + "&iKyHop=" + $("#iKyHop").val(), function (ok) {
                $("#q_data").html(ok);
            });
            return false;
        }
