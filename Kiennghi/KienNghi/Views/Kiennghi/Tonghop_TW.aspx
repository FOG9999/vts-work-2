...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Tập hợp kiến nghị thuộc thẩm quyền TW
</asp:Content>
...
<div id="main">
        ...
        <div class="breadcrumbs">
		    <ul>
                ...
                <li>
				    <span>Tập hợp kiến nghị thuộc thẩm quyền TW</span>
			    </li>
		    </ul>
                ...
                --%>
                 <form class="search" id="form_search" method="get" onsubmit="return TimKiem();">
                     <button type="button" onclick="ShowPopUp('', '/Kiennghi/Ajax_xuat_tonghop_bandannguyen')" class="btn_f blue"><i class="icon-print"></i></button>
                     ...
                     <button type="button" title="Tìm kiếm" onclick="ShowTimKiem('/Kiennghi/Ajax_search_tonghop_bandannguyen/','search_place')" style="" id="showbut" class="btn_f blue"><i class="icon-zoom-in"></i></button>
        ...
        <div class="row-fluid">
            <div class="span12">
			    <div class="box box-color box-bordered">
				    <div class="box-title">
					    <h3>
                            <i class="icon-tags"></i>Tập hợp kiến nghị thuộc thẩm quyền TW                      
					    </h3>
